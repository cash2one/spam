function(e, t) {
   ...
   for (e = e.split(/\s+/), t = 0, n = e.length; n > t; t++) r[e[t]] = !0;
    ...
    function o(e, t, n) {
        ...
        i = t + "queue",
        o = t + "mark",
        a = H._data(e, r); ! a || "queue" !== n && H._data(e, i) || "mark" !== n && H._data(e, o) || setTimeout(function() {
    ...
    function v(e, t, n) {
        ...
        o = 4;
        if (r > 0) {
            if ("border" !== n) for (; o > i; i += 2) n || (r -= parseFloat(H.css(e, "padding" + Wt[i])) || 0),
            "margin" === n ? r += parseFloat(H.css(e, n + Wt[i])) || 0 : r -= parseFloat(H.css(e, "border" + Wt[i] + "Width")) || 0;
            return r + "px"
        }
        ...
        "padding" !== n && (r += parseFloat(H.css(e, "border" + Wt[i] + "Width")) || 0),
        "margin" === n && (r += parseFloat(H.css(e, n + Wt[i])) || 0);
        return r + "px"
    }
    function b(e) {
        return function(t, n) {
    ...
    function x(e, n, r, i, o, a) {
        ...
        a = a || {},
        a[o] = !0;
        for (var s, l = e[o], u = 0, c = l ? l.length: 0, f = e === an; c > u && (f || !s); u++) s = l[u](n, r, i),
    ...
    function L(e, t) {
        var n = {};
        return H.each(wn.concat.apply([], wn.slice(0, t)),
        function() {
            n[this] = e
        }),
        n
    ...
    function D(e) {
        if (!bn[e]) {
            ...
            r = n.css("display");
            n.remove(),
            ("none" === r || "" === r) && (mn || (mn = F.createElement("iframe"), mn.frameBorder = mn.width = mn.height = 0), t.appendChild(mn), gn && mn.createElement || (gn = (mn.contentWindow || mn.contentDocument).document, gn.write((H.support.boxModel ? "<!doctype html>": "") + "<html><body>"), gn.close()), n = gn.createElement(e), gn.body.appendChild(n), r = H.css(n, "display"), t.removeChild(mn)),
            bn[e] = r
        }
        return bn[e]
    }
    ...
    H = function() {
        ...
        return s.fn = s.prototype = {
            ...
            init: function(e, n, r) {
                ...
                this.length = 1,
                this;
                if ("body" === e && !n && F.body) return this.context = F,
                this[0] = F.body,
                this.selector = e,
                this.length = 1,
                this;
                if ("string" == typeof e) {
                    ...
                    a = h.exec(e),
                    a ? s.isPlainObject(n) ? (e = [F.createElement(a[1])], s.fn.attr.call(e, n, !0)) : e = [l.createElement(a[1])] : (a = s.buildFragment([i[1]], [l]), e = (a.cacheable ? s.clone(a.fragment) : a.fragment).childNodes),
                    s.merge(this, e);
            ...
            pushStack: function(e, t, n) {
                ...
                return s.isArray(e) ? L.apply(r, e) : s.merge(r, e),
                r.prevObject = this,
        ...
        s.extend({
            ...
            bindReady: function() {
                if (!o) {
                    ...
                    if (F.addEventListener) F.addEventListener("DOMContentLoaded", a, !1),
        ...
        F.addEventListener ? a = function() {
            F.removeEventListener("DOMContentLoaded", a, !1),
            s.ready()
    ...
    H.Callbacks = function(e) {
        ...
        f = function(t) {
            var n, r, i, o;
            for (n = 0, r = t.length; r > n; n++) i = t[n],
            o = H.type(i),
            "array" === o ? f(i) : "function" === o && (e.unique && p.has(i) || u.push(i))
        },
        d = function(t, n) {
            ...
            o = !1,
            u && (e.once ? r === !0 ? p.disable() : u = [] : c && c.length && (r = c.shift(), p.fireWith(r[0], r[1])))
        },
        p = {
            add: function() {
                if (u) {
            ...
            remove: function() {
                ...
                n = 0,
                r = t.length; r > n; n++) for (var i = 0; i < u.length && (t[n] !== u[i] || (o && s >= i && (s--, l >= i && l--), u.splice(i--, 1), !e.unique)); i++);
                return this
            },
            has: function(e) {
                if (u) for (var t = 0,
                n = u.length; n > t; t++) if (e === u[t]) return ! 0;
                return ! 1
            },
            empty: function() {
                return u = [],
            ...
            fireWith: function(t, n) {
                return c && (o ? e.once || c.push([t, n]) : e.once && r || d(t, n)),
                this
            },
            fire: function() {
                    ...
                    return H.Deferred(function(r) {
                        ...
                        function(e, t) {
                            ...
                            H.isFunction(i) ? l[e](function() {
                                ...
                                n && H.isFunction(n.promise) ? n.promise().then(r.resolve, r.reject, r.notify) : r[o + "With"](this === l ? r: this, [n])
                            }) : l[e](r[o])
                        })
                    }).promise()
                },
    ...
    H.support = function() {
        ...
        if (!d.addEventListener && d.attachEvent && d.fireEvent && (d.attachEvent("onclick",
        function() {
            t.noCloneEvent = !1
        ...
        f = u in d,
        f || (d.setAttribute(u, "return;"), f = "function" == typeof d[u]),
        t[c + "Bubbles"] = f;
    ...
    H.extend({
        ...
        data: function(e, n, r, i) {
            if (H.acceptData(e)) {
                ...
                d = c ? e[l] : e[l] && l,
                p = "events" === n;
                if (d && f[d] && (p || i || f[d].data) || !u || r !== t) return d || (c ? e[l] = d = ++H.uuid: d = l),
                f[d] || (f[d] = {},
                c || (f[d].toJSON = H.noop)),
                ("object" == typeof n || "function" == typeof n) && (i ? f[d] = H.extend(f[d], n) : f[d].data = H.extend(f[d].data, n)),
                o = a = f[d],
                i || (a.data || (a.data = {}), a = a.data),
                r !== t && (a[H.camelCase(n)] = r),
                p && !a[n] ? o.events: (u ? (s = a[n], null == s && (s = a[H.camelCase(n)])) : s = a, s)
            }
        },
        ...
        data: function(e, n) {
            ...
            if (e === t) {
                if (this.length && (f = H.data(u), 1 === u.nodeType && !H._data(u, "parsedAttrs"))) {
                    ...
                    0 === s.indexOf("data-") && (s = H.camelCase(s.substring(5)), r(u, s, f[s]));
            ...
            return "object" == typeof e ? this.each(function() {
                H.data(this, e)
            }) : (i = e.split(".", 2), i[1] = i[1] ? "." + i[1] : "", o = i[1] + "!", H.access(this,
            function(n) {
    ...
    H.extend({
        ...
        dequeue: function(e, t) {
            ...
            r && ("fx" === t && n.unshift("inprogress"), H._data(e, t + ".run", i), r.call(e,
            function() {
                H.dequeue(e, t)
            },
            i)),
            n.length || (H.removeData(e, t + "queue " + t + ".run", !0), o(e, t, "queue"))
        }
    }),
    H.fn.extend({
        queue: function(e, n) {
            ...
            arguments.length < r ? H.queue(this[0], e) : n === t ? this: this.each(function() {
    ...
    H.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return H.isFunction(e) ? this.each(function(n) {
                ...
                a = H(this), s = t, l = e.split(X); i = l[o++];) s = r ? s: !a.hasClass(i),
        ...
        hasClass: function(e) {
            for (var t = " " + e + " ",
            n = 0,
            r = this.length; r > n; n++) if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(R, " ").indexOf(t) > -1) return ! 0;
            return ! 1
        },
        val: function(e) {
            var n, r, i, o = this[0]; {
                if (arguments.length) return i = H.isFunction(e),
                this.each(function(r) {
                    var o, a = H(this);
                    1 === this.nodeType && (o = i ? e.call(this, r, a.val()) : e, null == o ? o = "": "number" == typeof o ? o += "": H.isArray(o) && (o = H.map(o,
                    function(e) {
                        return null == e ? "": e + ""
                    })), n = H.valHooks[this.type] || H.valHooks[this.nodeName.toLowerCase()], n && "set" in n && n.set(this, o, "value") !== t || (this.value = o))
                });
                if (o) return n = H.valHooks[o.type] || H.valHooks[o.nodeName.toLowerCase()],
                n && "get" in n && (r = n.get(o, "value")) !== t ? r: (r = o.value, "string" == typeof r ? r.replace(z, "") : null == r ? "": r)
            }
        }
    }),
    H.extend({
        ...
        removeAttr: function(e, t) {
            var n, r, i, o, a, s = 0;
            if (t && 1 === e.nodeType) for (r = t.toLowerCase().split(X), o = r.length; o > s; s++) i = r[s],
            i && (n = H.propFix[i] || i, a = Y.test(i), a || H.attr(e, i, ""), e.removeAttribute(J ? i: n), a && n in e && (e[n] = !1))
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        prop: function(e, n, r) {
            ...
            if (e && 3 !== s && 8 !== s && 2 !== s) return a = 1 !== s || !H.isXMLDoc(e),
    ...
    W = H.valHooks.button = {
        ...
        set: function(e, t, n) {
            ...
            return r || (r = F.createAttribute(n), e.setAttributeNode(r)),
            r.nodeValue = t + ""
        }
    },
    H.attrHooks.tabindex.set = W.set, H.each(["width", "height"],
    function(e, t) {
    ...
    H.event = {
        add: function(e, n, r, i, o) {
            ...
            if (3 !== e.nodeType && 8 !== e.nodeType && n && r && (a = H._data(e))) {
                ...
                s.elem = e), n = H.trim(at(n)).split(" "), u = 0; u < n.length; u++) c = K.exec(n[u]) || [],
                f = c[1],
                d = (c[2] || "").split(".").sort(),
                g = H.event.special[f] || {},
                ...
                h),
                m = l[f],
                m || (m = l[f] = [], m.delegateCount = 0, g.setup && g.setup.call(e, i, d, s) !== !1 || (e.addEventListener ? e.addEventListener(f, s, !1) : e.attachEvent && e.attachEvent("on" + f, s))),
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (y && (d = y.events)) {
                for (t = H.trim(at(t || "")).split(" "), o = 0; o < t.length; o++) if (a = K.exec(t[o]) || [], s = l = a[1], u = a[2], s) {
                    for (p = H.event.special[s] || {},
                    s = (r ? p.delegateType: p.bindType) || s, m = d[s] || [], c = m.length, u = u ? new RegExp("(^|\\.)" + u.split(".").sort().join("\\.(?:.*\\.)?") + "(\\.|$)") : null, f = 0; f < m.length; f++) g = m[f],
                    !i && l !== g.origType || n && n.guid !== g.guid || u && !u.test(g.namespace) || r && r !== g.selector && ("**" !== r || !g.selector) || (m.splice(f--, 1), g.selector && m.delegateCount--, p.remove && p.remove.call(e, g));
            ...
            if (!i || 3 !== i.nodeType && 8 !== i.nodeType) {
                ...
                if (!nt.test(g + H.event.triggered) && (g.indexOf("!") >= 0 && (g = g.slice(0, -1), s = !0), g.indexOf(".") >= 0 && (y = g.split("."), g = y.shift(), y.sort()), i && !H.event.customEvent[g] || H.event.global[g])) if (n = "object" == typeof n ? n[H.expando] ? n: new H.Event(g, n) : new H.Event(g), n.type = g, n.isTrigger = !0, n.exclusive = s, n.namespace = y.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + y.join("\\.(?:.*\\.)?") + "(\\.|$)") : null, f = g.indexOf(":") < 0 ? "on" + g: "", i) {
                    ...
                    !d.trigger || d.trigger.apply(i, r) !== !1) {
                        ...
                        n.type = h[l][1],
                        p = (H._data(u, "events") || {})[n.type] && H._data(u, "handle"),
                        p && p.apply(u, r),
                        p = f && u[f],
                        p && H.acceptData(u) && p.apply(u, r) === !1 && n.preventDefault();
                        return n.type = g,
                        o || n.isDefaultPrevented() || d._default && d._default.apply(i.ownerDocument, r) !== !1 || "click" === g && H.nodeName(i, "a") || !H.acceptData(i) || f && i[g] && ("focus" !== g && "blur" !== g || 0 !== n.target.offsetWidth) && !H.isWindow(i) && (c = i[f], c && (i[f] = null), H.event.triggered = g, i[g](), H.event.triggered = t, c && (i[f] = c)),
                        n.result
                    }
                } else {
                    a = H.cache;
        ...
        dispatch: function(n) {
            ...
            if (m[0] = n, n.delegateTarget = this, !y.preDispatch || y.preDispatch.call(this, n) !== !1) {
                if (h && (!n.button || "click" !== n.type)) for (a = H(this), a.context = this.ownerDocument || this, o = n.target; o != this; o = o.parentNode || this) if (o.disabled !== !0) {
                    ...
                    d = f.selector,
                    l[d] === t && (l[d] = f.quick ? ot(o, f.quick) : a.is(d)),
                    l[d] && c.push(f);
                    c.length && v.push({
                        elem: o,
                        matches: c
                ...
                for (p.length > h && v.push({
                    elem: this,
                    matches: p.slice(h)
                }), r = 0; r < v.length && !n.isPropagationStopped(); r++) for (u = v[r], n.currentTarget = u.elem, i = 0; i < u.matches.length && !n.isImmediatePropagationStopped(); i++) f = u.matches[i],
        ...
        mouseHooks: {
            ...
            filter: function(e, n) {
                ...
                s = n.fromElement;
                return null == e.pageX && null != n.clientX && (r = e.target.ownerDocument || F, i = r.documentElement, o = r.body, e.pageX = n.clientX + (i && i.scrollLeft || o && o.scrollLeft || 0) - (i && i.clientLeft || o && o.clientLeft || 0), e.pageY = n.clientY + (i && i.scrollTop || o && o.scrollTop || 0) - (i && i.clientTop || o && o.clientTop || 0)),
        ...
        fix: function(e) {
            ...
            for (e = H.Event(i), n = a.length; n;) r = a[--n],
            e[r] = i[r];
    ...
    function(e, t) {
        H.event.special[e] = {
            ...
            handle: function(e) {
                ...
                return (!i || i !== r && !H.contains(r, i)) && (e.type = o.origType, n = o.handler.apply(this, arguments), e.type = t),
                n
            }
        }
    }),
    H.support.submitBubbles || (H.event.special.submit = {
        setup: function() {
            return H.nodeName(this, "form") ? !1 : (H.event.add(this, "click._submit keypress._submit",
            function(e) {
                var n = e.target,
    ...
    H.support.changeBubbles || (H.event.special.change = {
        setup: function() {
            return Q.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (H.event.add(this, "propertychange._change",
            function(e) {
            ...
            })), !1) : (H.event.add(this, "beforeactivate._change",
            function(e) {
                var t = e.target;
                Q.test(t.nodeName) && !t._change_attached && (H.event.add(t, "change._change",
                function(e) { ! this.parentNode || e.isSimulated || e.isTrigger || H.event.simulate("change", this.parentNode, e, !0)
    ...
    H.fn.extend({
        ...
        live: function(e, t, n) {
            return H(this.context).on(e, this.selector, t, n),
            this
        },
        die: function(e, t) {
            return H(this.context).off(e, this.selector || "**", t),
            this
        },
        ...
        toggle: function(e) {
            ...
            i = function(n) {
                ...
                return H._data(this, "lastToggle" + e.guid, i + 1),
                n.preventDefault(),
    ...
    function(e, t) {
        ...
        et.test(t) && (H.event.fixHooks[t] = H.event.keyHooks),
    ...
    function() {
        ...
        var d = function(e, t, n, i) {
            ...
            l = w(e, l, i);
            else if (!i && T.length > 1 && 9 === t.nodeType && !x && h.match.ID.test(T[0]) && !h.match.ID.test(T[T.length - 1]) && (f = d.find(T.shift(), t, x), t = f.expr ? d.filter(f.expr, f.set)[0] : f.set[0]), t) for (f = i ? {
                expr: T.pop(),
                set: v(i)
            }: d.find(T.pop(), 1 !== T.length || "~" !== T[0] && "+" !== T[0] || !t.parentNode ? t: t.parentNode, x), l = f.expr ? d.filter(f.expr, f.set) : f.set, T.length > 0 ? u = v(l) : b = !1; T.length;) p = T.pop(),
            g = p,
            ...
            return c && (d(c, o, n, i), d.uniqueSort(n)),
            n
        };
        ...
        h = d.selectors = {
            ...
            relative: {
                ...
                "": function(t, r, i) {
                    var a, s = o++,
                    l = n;
                    "string" != typeof r || f.test(r) || (r = r.toLowerCase(), a = r, l = e),
        ...
        function() {
            ...
            F.getElementById(n) && (h.find.ID = function(e, n, r) {
        ...
        d.contains = F.documentElement.contains ?
        function(e, t) {
    ...
    function(e, t) {
        H.fn[e] = function(n, r) {
            ...
            return st.test(e) || (r = n),
            r && "string" == typeof r && (i = H.filter(r, i)),
            i = this.length > 1 && !pt[e] ? H.unique(i) : i,
            (this.length > 1 || ut.test(r)) && lt.test(e) && (i = i.reverse()),
            this.pushStack(i, e, ft.call(arguments).join(","))
        }
    }),
    H.extend({
    ...
    St.th = St.td,
    H.support.htmlSerialize || (St._default = [1, "div<div>", "</div>"]),
    H.fn.extend({
        text: function(e) {
        ...
        after: function() {
            ...
            if (arguments.length) {
                ...
                return e.push.apply(e, H.clean(arguments)),
                e
            }
        },
        remove: function(e, t) {
        ...
        html: function(e) {
            ...
            function(e) {
                ...
                if (! ("string" != typeof e || Tt.test(e) || !H.support.leadingWhitespace && gt.test(e) || St[(vt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    ...
                    try {
                        for (; i > r; r++) n = this[r] || {},
                        1 === n.nodeType && (H.cleanData(n.getElementsByTagName("*")), n.innerHTML = e);
                        n = 0
                    } catch(o) {}
                }
        ...
        domManip: function(e, n, r) {
            ...
            if (this[0]) {
                if (s = l && l.parentNode, i = H.support.parentNode && s && 11 === s.nodeType && s.childNodes.length === this.length ? {
                    ...
                    for (var c = 0,
                    d = this.length,
                    p = d - 1; d > c; c++) r.call(n ? f(this[c], o) : this[c], i.cacheable || d > 1 && p > c ? H.clone(a, !0, !0) : a)
                }
                u.length && H.each(u,
                function(e, t) {
                    t.src ? H.ajax({
                        ...
                        async: !1,
                        dataType: "script"
                    }) : H.globalEval((t.text || t.textContent || t.innerHTML || "").replace(kt, "/*$0*/")),
    ...
    H.buildFragment = function(e, t, n) {
        ...
        !(1 === e.length && "string" == typeof s && s.length < 512 && a === F && "<" === s.charAt(0)) || wt.test(s) || !H.support.checkClone && Ct.test(s) || !H.support.html5Clone && Nt.test(s) || (i = !0, o = H.fragments[s], o && 1 !== o && (r = o)),
    ...
    H.extend({
        ...
        clean: function(e, t, n, r) {
            var i, o, a, s = [];
            t = t || F,
            "undefined" == typeof t.createElement && (t = t.ownerDocument || t[0] && t[0].ownerDocument || F);
            for (var l, u = 0; null != (l = e[u]); u++) if ("number" == typeof l && (l += ""), l) {
                if ("string" == typeof l) if (xt.test(l)) {
                    ...
                    l = m.childNodes,
                    m && (m.parentNode.removeChild(m), y.length > 0 && (f = y[y.length - 1], f && f.parentNode && f.parentNode.removeChild(f)))
                } else l = t.createTextNode(l);
                var x;
                if (!H.support.appendChecked) if (l[0] && "number" == typeof(x = l.length)) for (a = 0; x > a; a++) g(l[a]);
                else g(l);
            ...
            u = 0; s[u]; u++) if (o = s[u], r && H.nodeName(o, "script") && (!o.type || Et.test(o.type))) r.push(o.parentNode ? o.parentNode.removeChild(o) : o);
            else {
                if (1 === o.nodeType) {
        ...
        cleanData: function(e) {
            ...
            s = 0; null != (r = e[s]); s++) if ((!r.nodeName || !H.noData[r.nodeName.toLowerCase()]) && (n = r[H.expando])) {
                if (t = i[n], t && t.events) {
                    for (var l in t.events) o[l] ? H.event.remove(r, l) : H.removeEvent(r, l, t.handle);
                    t.handle && (t.handle.elem = null)
                }
                a ? delete r[H.expando] : r.removeAttribute && r.removeAttribute(H.expando),
                delete i[n]
            }
        }
    });
    ...
    H.curCSS = H.css,
    F.defaultView && F.defaultView.getComputedStyle && (Dt = function(e, t) {
        var n, r, i, o, a = e.style;
        return t = t.replace(_t, "-$1").toLowerCase(),
        (r = e.ownerDocument.defaultView) && (i = r.getComputedStyle(e, null)) && (n = i.getPropertyValue(t), "" !== n || H.contains(e.ownerDocument.documentElement, e) || (n = H.style(e, t))),
        !H.support.pixelMargin && i && Pt.test(t) && Ot.test(n) && (o = a.width, a.width = n, n = i.width, a.width = o),
        n
    }),
    F.documentElement.currentStyle && (jt = function(e, t) {
        ...
        Ot.test(o) && (n = a.left, r = e.runtimeStyle && e.runtimeStyle.left, r && (e.runtimeStyle.left = e.currentStyle.left), a.left = "fontSize" === t ? "1em": o, o = a.pixelLeft + "px", a.left = n, r && (e.runtimeStyle.left = r)),
        "" === o ? "auto": o
    }),
    Lt = Dt || jt,
    H.each(["height", "width"],
    function(e, t) {
        H.cssHooks[t] = {
            get: function(e, n, r) {
                return n ? 0 !== e.offsetWidth ? v(e, t, r) : H.swap(e, qt,
                function() {
                    return v(e, t, r)
                }) : void 0
            },
    ...
    H.support.opacity || (H.cssHooks.opacity = {
        ...
        set: function(e, t) {
            ...
            n.zoom = 1,
            t >= 1 && "" === H.trim(o.replace(Ft, "")) && (n.removeAttribute("filter"), r && !r.filter) || (n.filter = Ft.test(o) ? o.replace(Ft, i) : o + " " + i)
        }
    }),
    H(function() {
    ...
    try {
        ...
        It = F.createElement("a"),
        It.href = "",
        It = It.href
    }
    $t = rn.exec(It.toLowerCase()) || [],
    H.fn.extend({
        load: function(e, n, r) {
            ...
            return H.ajax({
                ...
                complete: function(e, t, n) {
                    ...
                    e.isResolved() && (e.done(function(e) {
                        n = e
                    }), s.html(o ? H("<div>").append(n.replace(Zt, "")).find(o) : n)),
                    r && s.each(r, [n, t, e])
                }
            }),
            this
    ...
    H.extend({
        ...
        ajaxSetup: function(e, t) {
            return t ? T(e, H.ajaxSettings) : (t = e, e = H.ajaxSettings),
            T(e, t),
            e
        },
        ajaxSettings: {
        ...
        ajax: function(e, n) {
            function r(e, n, r, a) {
                if (2 !== T) {
                    ...
                    var u, f, v, b, x, E = n,
                    k = r ? N(d, w, r) : t;
                    if (e >= 200 && 300 > e || 304 === e) if (d.ifModified && ((b = w.getResponseHeader("Last-Modified")) && (H.lastModified[i] = b), (x = w.getResponseHeader("Etag")) && (H.etag[i] = x)), 304 === e) E = "notmodified",
                    u = !0;
                    else try {
                        f = C(d, k),
                        E = "success",
            ...
            w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + ln + "; q=0.01": "") : d.accepts["*"]);
            for (f in d.headers) w.setRequestHeader(f, d.headers[f]);
            if (d.beforeSend && (d.beforeSend.call(p, w, d) === !1 || 2 === T)) return w.abort(),
            !1;
            for (f in {
                success: 1,
                error: 1,
    ...
    H.support.ajax && H.ajaxTransport(function(n) {  // alexmark
            ...
            return {
                send: function(i, o) {
                    ...
                    r = function(e, i) {
                        var s, u, c, f, d;
                        try {
                            if (r && (i || 4 === l.readyState)) if (r = t, a && (l.onreadystatechange = H.noop, pn && delete dn[a]), i) 4 !== l.readyState && l.abort();
                            else {
                                s = l.status,
                    ...
                    n.async && 4 !== l.readyState ? (a = ++hn, pn && (dn || (dn = {},
                    H(e).unload(pn)), dn[a] = r), l.onreadystatechange = r) : r()
                },
                abort: function() {
                    r && r(0, 1)
                }
    ...
    xn = /^(?:toggle|show|hide)$/,
    Tn = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,
    wn = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]];
    H.fn.extend({
        show: function(e, t, n) {
            var r, i;
            ...
            r.style && (i = r.style.display, H._data(r, "olddisplay") || "none" !== i || (i = r.style.display = ""), ("" === i && "none" === H.css(r, "display") || !H.contains(r.ownerDocument.documentElement, r)) && H._data(r, "olddisplay", D(r.nodeName)));
        ...
        hide: function(e, t, n) {
            ...
            for (var r, i, o = 0,
            a = this.length; a > o; o++) r = this[o],
            r.style && (i = H.css(r, "display"), "none" === i || H._data(r, "olddisplay") || H._data(r, "olddisplay", i));
        ...
        animate: function(e, t, n, r) {
            function i() {
                ...
                var t, n, r, i, a, s, l, u, c, f, d, p = H.extend({},
                o),
                h = 1 === this.nodeType,
                ...
                for (t in e) {
                    if (n = e[t], H.isArray(n) ? (p.animatedProperties[t] = n[1], n = e[t] = n[0]) : p.animatedProperties[t] = p.specialEasing && p.specialEasing[t] || p.easing || "swing", "hide" === n && m || "show" === n && !m) return p.complete.call(this); ! h || "height" !== t && "width" !== t || (p.overflow = [this.style.overflow, this.style.overflowX, this.style.overflowY], "inline" === H.css(this, "display") && "none" === H.css(this, "float") && (H.support.inlineBlockNeedsLayout && "inline" !== D(this.nodeName) ? this.style.zoom = 1 : this.style.display = "inline-block"))
                }
                null != p.overflow && (this.style.overflow = "hidden");
                for (r in e) i = new H.fx(this, p, r),
                n = e[r],
                xn.test(n) ? (d = H._data(this, "toggle" + r) || ("toggle" === n ? m ? "show": "hide": 0), d ? (H._data(this, "toggle" + r, "show" === d ? "hide": "show"), i[d]()) : i[n]()) : (l = Tn.exec(n), u = i.cur(), l ? (c = parseFloat(l[2]), f = l[3] || (H.cssNumber[r] ? "": "px"), "px" !== f && (H.style(this, r, (c || 1) + f), u = (c || 1) / i.cur() * u, H.style(this, r, u + f)), l[1] && (c = ("-=" === l[1] ? -1 : 1) * c + u), i.custom(u, c, f)) : i.custom(u, n, ""));
                return ! 0
            }
            var o = H.speed(t, n, r);
            return H.isEmptyObject(e) ? this.each(o.complete, [!1]) : (e = H.extend({},
            e), o.queue === !1 ? this.each(i) : this.queue(o.queue, i))
        },
        stop: function(e, n, r) {
    ...
    H.fx.prototype = {
        ...
        step: function(e) {
            ...
            if (e || i >= s.duration + this.startTime) {
                ...
                if (o) {
                    if (null == s.overflow || H.support.shrinkWrapBlocks || H.each(["", "X", "Y"],
                    function(e, t) {
                    ...
                    r = s.complete,
                    r && (s.complete = !1, r.call(a))
                }
                return ! 1
            }
            return 1 / 0 == s.duration ? this.now = i: (n = i - this.startTime, this.state = n / s.duration, this.pos = H.easing[s.animatedProperties[this.prop]](this.state, n, 0, 1, s.duration), this.now = this.start + (this.end - this.start) * this.pos),
            this.update(),
            !0
        }
    },
    ...
    En = /^(?:body|html)$/i;
    Nn = "getBoundingClientRect" in F.documentElement ?
    function(e, t, n, r) {
        try {
        ...
        for (var r, i = e.offsetParent,
        o = e,
        a = t.body,
        s = t.defaultView,
        l = s ? s.getComputedStyle(e, null) : e.currentStyle, u = e.offsetTop, c = e.offsetLeft; (e = e.parentNode) && e !== a && e !== n && (!H.support.fixedPosition || "fixed" !== l.position);) r = s ? s.getComputedStyle(e, null) : e.currentStyle,
        u -= e.scrollTop,
        c -= e.scrollLeft,
        e === i && (u += e.offsetTop, c += e.offsetLeft, !H.support.doesNotAddBorder || H.support.doesAddBorderForTableAndCells && Cn.test(e.nodeName) || (u += parseFloat(r.borderTopWidth) || 0, c += parseFloat(r.borderLeftWidth) || 0), o = i, i = e.offsetParent),
        H.support.subtractsBorderForOverflowNotVisible && "visible" !== r.overflow && (u += parseFloat(r.borderTopWidth) || 0, c += parseFloat(r.borderLeftWidth) || 0),
        l = r;
        return ("relative" === l.position || "static" === l.position) && (u += a.offsetTop, c += a.offsetLeft),
        H.support.fixedPosition && "fixed" === l.position && (u += Math.max(n.scrollTop, a.scrollTop), c += Math.max(n.scrollLeft, a.scrollLeft)),
        {
            top: u,
            left: c
        }
    ...
    t.extend(t.ui, {
        plugin: {
            add: function(e, i, s) {
                ...
                for (o in s) n.plugins[o] = n.plugins[o] || [],
...
function(t, e) {
    ...
    t.widget.extend = function(i) {
        for (var o, n, r = s.call(arguments, 1), a = 0, h = r.length; h > a; a++) for (o in r[a]) n = r[a][o],
        r[a].hasOwnProperty(o) && n !== e && (i[o] = t.isPlainObject(n) ? t.isPlainObject(i[o]) ? t.widget.extend({},
        i[o], n) : t.widget.extend({},
        n) : n);
        return i
    },
    t.widget.bridge = function(i, o) {
        ...
        t.fn[i] = function(r) {
            ...
            l = this;
            return r = !a && h.length ? t.widget.extend.apply(null, [r].concat(h)) : r,
    ...
    t.Widget.prototype = {
        ...
        option: function(i, s) {
            ...
            o = i.split("."), i = o.shift(), o.length) {
                for (n = a[i] = t.widget.extend({},
                this.options[i]), r = 0; r < o.length - 1; r++) n[o[r]] = n[o[r]] || {},
                n = n[o[r]];
        ...
        _on: function(e, i, s) {
            ...
            s ? (i = o = t(i), this.bindings = this.bindings.add(i)) : (s = i, i = this.element, o = this.widget()),
            t.each(s,
            function(s, r) {
                function a() {
        ...
        _trigger: function(e, i, s) {
            ...
            if (s = s || {},
            i = t.Event(i), i.type = (e === this.widgetEventPrefix ? e: this.widgetEventPrefix + e).toLowerCase(), i.target = this.element[0], n = i.originalEvent) for (o in n) o in i || (i[o] = n[o]);
...
function(t, e) {
    ...
    t.fn.position = function(e) {
        ...
        function() {
            ...
            t = p.exec(s[0]),
            i = p.exec(s[1]),
            I[this] = [t ? t[0] : 0, i ? i[0] : 0],
            e[this] = [f.exec(s[0])[0], f.exec(s[1])[0]]
        }),
        1 === y.length && (y[1] = y[0]),
        "right" === e.at[0] ? v.left += u: "center" === e.at[0] && (v.left += u / 2),
        ...
        this.each(function() {
            ...
            d = s(this, "marginLeft"),
            _ = s(this, "marginTop"),
            x = p + d + s(this, "marginRight") + w.width,
            C = f + _ + s(this, "marginBottom") + w.height,
            T = t.extend({},
            v),
            S = i(I.my, c.outerWidth(), c.outerHeight());
            "right" === e.my[0] ? T.left -= p: "center" === e.my[0] && (T.left -= p / 2),
            "bottom" === e.my[1] ? T.top -= f: "center" === e.my[1] && (T.top -= f / 2),
            T.left += S[0],
            T.top += S[1],
            t.support.offsetFractions || (T.left = h(T.left), T.top = h(T.top)),
            o = {
                marginLeft: d,
                marginTop: _
            },
            t.each(["left", "top"],
            function(i, s) {
                t.ui.position[y[i]] && t.ui.position[y[i]][s](T, {
                    targetWidth: u,
                    targetHeight: g,
                    elemWidth: p,
                    elemHeight: f,
            ...
            e.using && (l = function(t) {
                ...
                p > u && a(i + s) < u && (h.horizontal = "center"),
                f > g && a(o + n) < g && (h.vertical = "middle"),
                h.important = r(a(i), a(s)) > r(a(o), a(n)) ? "horizontal": "vertical",
...
function(t) {
    ...
    t.ui.plugin.add("draggable", "connectToSortable", {
        ...
        drag: function(e, i) {
            ...
            function() {
                ...
                this.instance._intersectsWith(this.instance.containerCache) && (n = !0, t.each(s.sortables,
                function() {
                    return this.instance.positionAbs = s.positionAbs,
                    this.instance.helperProportions = s.helperProportions,
                    this.instance.offset.click = s.offset.click,
                    this !== r && this.instance._intersectsWith(this.instance.containerCache) && t.contains(r.instance.element[0], this.instance.element[0]) && (n = !1),
                    n
                })),
    ...
    t.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(e, i) {
            ...
            _ = i.offset.top,
            b = _ + u.helperProportions.height;
            for (p = u.snapElements.length - 1; p >= 0; p--) a = u.snapElements[p].left,
            h = a + u.snapElements[p].width,
            l = u.snapElements[p].top,
            c = l + u.snapElements[p].height,
            a - g > v || m > h + g || l - g > b || _ > c + g || !t.contains(u.snapElements[p].item.ownerDocument, u.snapElements[p].item) ? (u.snapElements[p].snapping && u.options.snap.release && u.options.snap.release.call(u.element, e, t.extend(u._uiHash(), {
                snapItem: u.snapElements[p].item
            })), u.snapElements[p].snapping = !1) : ("inner" !== d.snapMode && (s = Math.abs(l - b) <= g, o = Math.abs(c - _) <= g, n = Math.abs(a - v) <= g, r = Math.abs(h - m) <= g, s && (i.position.top = u._convertPositionTo("relative", {
                ...
                top: 0,
                left: h
            }).left - u.margins.left)), f = s || o || n || r, "outer" !== d.snapMode && (s = Math.abs(l - _) <= g, o = Math.abs(c - b) <= g, n = Math.abs(a - m) <= g, r = Math.abs(h - v) <= g, s && (i.position.top = u._convertPositionTo("relative", {
                top: l,
                left: 0
            }).top - u.margins.top), o && (i.position.top = u._convertPositionTo("relative", {
...
function(t) {
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _mouseStop: function(e, i) {
            if (e) {
                if (t.ui.ddmanager && !this.options.dropBehaviour && t.ui.ddmanager.drop(this, e), this.options.revert) {
                    ...
                    n = this.options.axis,
                    r = {};
                    n && "x" !== n || (r.left = o.left - this.offset.parent.left - this.margins.left + (this.offsetParent[0] === document.body ? 0 : this.offsetParent[0].scrollLeft)),
                    n && "y" !== n || (r.top = o.top - this.offset.parent.top - this.margins.top + (this.offsetParent[0] === document.body ? 0 : this.offsetParent[0].scrollTop)),
                    this.reverting = !0,
        ...
        _getItemsAsjQuery: function(e) {
            ...
            a = [],
            h = this._connectWith();
            if (h && e) for (i = h.length - 1; i >= 0; i--) for (o = t(h[i]), s = o.length - 1; s >= 0; s--) n = t.data(o[s], this.widgetFullName),
            n && n !== this && !n.options.disabled && a.push([t.isFunction(n.options.items) ? n.options.items.call(n.element) : t(n.options.items, n.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), n]);
        ...
        _refreshItems: function(e) {
            ...
            f = this._connectWith();
            if (f && this.ready) for (i = f.length - 1; i >= 0; i--) for (o = t(f[i]), s = o.length - 1; s >= 0; s--) n = t.data(o[s], this.widgetFullName),
            n && n !== this && !n.options.disabled && (p.push([t.isFunction(n.options.items) ? n.options.items.call(n.element[0], e, {
                item: this.currentItem
            }) : t(n.options.items, n.element), n]), this.containers.push(n));
            for (i = p.length - 1; i >= 0; i--) for (r = p[i][1], a = p[i][0], s = 0, l = a.length; l > s; s++) h = t(a[s]),
        ...
        refreshPositions: function(e) {
            ...
            s.instance !== this.currentContainer && this.currentContainer && s.item[0] !== this.currentItem[0] || (o = this.options.toleranceElement ? t(this.options.toleranceElement, s.item) : s.item, e || (s.width = o.outerWidth(), s.height = o.outerHeight()), n = o.offset(), s.left = n.left, s.top = n.top);
        ...
        _createPlaceholder: function(e) {
            ...
            s.placeholder && s.placeholder.constructor !== String || (i = s.placeholder, s.placeholder = {
                ...
                update: function(t, o) { (!i || s.forcePlaceholderSize) && (o.height() || o.height(e.currentItem.innerHeight() - parseInt(e.currentItem.css("paddingTop") || 0, 10) - parseInt(e.currentItem.css("paddingBottom") || 0, 10)), o.width() || o.width(e.currentItem.innerWidth() - parseInt(e.currentItem.css("paddingLeft") || 0, 10) - parseInt(e.currentItem.css("paddingRight") || 0, 10)))
                }
            }),
        ...
        _contactContainers: function(s) {
            ...
            if (d) if (1 === this.containers.length) this.containers[g].containerCache.over || (this.containers[g]._trigger("over", s, this._uiHash(this)), this.containers[g].containerCache.over = 1);
            else {
                ...
                a ? this._rearrange(s, a, null, !0) : this._rearrange(s, null, this.containers[g].element, !0),
        ...
        _setContainment: function() {
            ...
            /^(document|window|parent)$/.test(o.containment) || (e = t(o.containment)[0], i = t(o.containment).offset(), s = "hidden" !== t(e).css("overflow"), this.containment = [i.left + (parseInt(t(e).css("borderLeftWidth"), 10) || 0) + (parseInt(t(e).css("paddingLeft"), 10) || 0) - this.margins.left, i.top + (parseInt(t(e).css("borderTopWidth"), 10) || 0) + (parseInt(t(e).css("paddingTop"), 10) || 0) - this.margins.top, i.left + (s ? Math.max(e.scrollWidth, e.offsetWidth) : e.offsetWidth) - (parseInt(t(e).css("borderLeftWidth"), 10) || 0) - (parseInt(t(e).css("paddingRight"), 10) || 0) - this.helperProportions.width - this.margins.left, i.top + (s ? Math.max(e.scrollHeight, e.offsetHeight) : e.offsetHeight) - (parseInt(t(e).css("borderTopWidth"), 10) || 0) - (parseInt(t(e).css("paddingBottom"), 10) || 0) - this.helperProportions.height - this.margins.top])
        },
        _convertPositionTo: function(e, i) {
            i || (i = this.position);
            var s = "absolute" === e ? 1 : -1,
...
function() {
    ...
    _undef = "undefined",
    getType = function() {
        for (var e = Object.prototype.toString,
        t = {},
        r = {
            1 : "element",
            3 : "textnode",
    ...
    weaveOne = function(source, method, advice) {
        ...
        return advice.type == _after || advice.type == _afterThrow || advice.type == _afterFinally ? aspect = function() {
            ...
            return advice.value.apply(this, [arguments, method]),
...
function(e) {
    ...
    e.tb.ajax = function(t) {
        ...
        t),
        i = t && t.context || n;
        if ("jsonp" === n.dataType || "json" === n.dataType) return e.ajax(t),
        void 0;
        var r = /^(\w+:)?\/\/([^\/?#]+)/.exec(n.url),
        o = r && (r[1] && r[1] !== location.protocol || r[2] !== location.host);
        if (o) return e.log("Sorry, but cross domain request is not allowed, maybe you need to check you url replacment! ^-^<br/>the remote url is: " + r[1] + "//" + r[2]),
        void 0;
    ...
    e.tb.get = function(t, n, i, r) {
        return jQuery.isFunction(n) && (r = r || i, i = n, n = null),
        e.tb.ajax({
            type: "GET",
            url: t,
            data: n,
...
function(e) {
    function t(t) {
        ...
        a = r,
        void 0 !== n.axis && n.axis === n.HORIZONTAL_AXIS && (a = 0, o = -1 * r),
...
function(e) {
    var t = function(t) {
        ...
        t),
        this.element = e('<div class="' + this.cfg.className + '"/>').appendTo(document.body).css({
            display: "none",
            zIndex: e.getzIndex(),
            width: this.width(),
            height: this.height()
    ...
    t.prototype = {
        ...
        remove: function() {
            ...
            e(window).unbind("resize", this.resizeFunc);
            for (var t in this) delete this[t]
        },
        _processTages: function(t) {
            var n = this;
            if (e.browser.msie) if (n.special = n.special || [], t) {
            ...
            o = n.special.length; o > r; r++) e(n.special[r].dom).css("visibility", n.special[r].css || ""),
            n.special[r].dom = null
        }
    },
    e.modal = t,
    e.getzIndex = function() {
        return e.zIndex = e.zIndex || 5e4,
        e.zIndex++
    }
} (jQuery),
function(e) {
    e.getcurzIndex = function() {
        return e.curzIndex = e.curzIndex || 10005,
        e.curzIndex++
    }
} (jQuery),
function(e) {
    ...
    n = function(r) {
        ...
        this.cfg = e.extend({},
        n.setting, r),
        this.cfg.showTitle || (this.cfg.draggable = !1),
        (null != this.cfg.top || null != this.cfg.left) && (this.cfg.autoCenter = !1);
        var a = "dialogJ";
        this.cfg.holderClassName && (a += " " + this.cfg.holderClassName),
        !t && this.cfg.fixed && (a += " dialogJfix"),
        this.cfg.showShadow && (a += " dialogJshadow");
        var s = this;
        if (this.cfg.modal) {
            var l = {};
            this.cfg.modalClassName && (l.className = this.cfg.modalClassName),
            this.modal = new e.modal(l)
        }
        this.element = e('<div class="' + a + '"></div>').css({
            zIndex: e.getzIndex(),
            display: "none"
        }).appendTo(document.body),
        this.elementWrapper = e('<div class="uiDialogWrapper"></div>').appendTo(this.element),
        this._setupTitleBar(),
        this.setTitle(this.cfg.title),
        this._setupNoTitle(),
        "iframe" === this.cfg.contentType && (this.cfg.html = e("<iframe></iframe>").css({
            width: "100%",
            height: "100%",
            border: "none"
        }).attr({
        ...
        this.cfg.show && this.show(),
        this.cfg.autoCenter && e(window).bind("resize", o),
        this._setScroll(),
        e.each(i,
        function(e, t) {
        ...
        this.close = function() {
            ...
            s.element.remove();
            for (var t = 0,
            i = n.INST.length; i > t; t++) if (n.INST[t] == s) {
                n.INST.splice(t, 1);
                break
            }
        }
    ...
    e.extend(n, {
        ...
        ask: function(t, i, r, o) {
            ...
            if (e.isArray(i) && i.length > 0) {
                var s = e('<div class="dialogJanswers"></div>').appendTo(a.elementWrapper).html(e.map(i,
                function(e) {
        ...
        alert: function(t, r) {
            var o = e.extend({},
            r || {});
            return n.ask(t, [o.acceptValue || "\u786E\u5B9A"],
            function(e, t) {
        ...
        confirm: function(t, r) {
            var o = e.extend({},
            r || {});
            return n.ask(t, [o.acceptValue || "\u786E\u5B9A", o.cancelValue || "\u53D6\u6D88"],
            function(e, t) {
                return t.element.triggerHandler(i[e], this)
            },
            o)
        ...
        assert: function(t, r, o) {
            ...
            var s = n.ask(t, a.button ? [a.acceptValue || "\u786E\u5B9A"] : [],
            function(e, t) {
                return t.element.triggerHandler(i[e], this)
            },
            a);
    ...
    n.prototype = {
        ...
        setPosition: function(n, i) {
            if (0 !== n & !n && 0 !== i && !i) {
                ...
                n = a[0] + (o.width() - this.element.outerWidth()) / 2,
                i = a[1] + (o.height() - this.element.outerHeight()) / 2,
                i = i >= 0 ? i: 0
            }
            this.element.css({
                left: n,
        ...
        show: function() {
            this.element.show.apply(this.element, arguments),
            this.modal && (this.modal.cfg.safety = this.element, this.modal.show.apply(this.modal, arguments))
        },
        hide: function() {
        ...
        bind: function() {
            return this.element.bind.apply(this.element, arguments),
            this
        },
        triggerHandler: function() {
            this.element.triggerHandler.apply(this.element, arguments)
        ...
        _setupTitleBar: function() {
            if (this.cfg.showTitle) {
                ...
                if (this.cfg.closeable && e('<a href="#" class="dialogJclose" title="' + (this.cfg.closeTips || "\u5173\u95ED\u672C\u7A97\u53E3") + '">&nbsp;</a>').appendTo(n).bind("mousedown",
                function(e) {
                    e.stopPropagation()
                }).click(function() {
                    return t.cfg.hideOnclose ? t.hide() : t.close(),
                    !1
                }), this.cfg.draggable) {
        ...
        _setupEscKey: function() {
            ...
            e(document).bind("keydown", n),
            e(t.element).bind("onclose",
            function() {
...
function(e, t, n) {
    ...
    e.json.encode = function() {
        ...
        return function(i) {
            ...
            default:
                ...
                var o, a, s = ["{"],
                l = e.json.encode;
                for (key in i) if (i.hasOwnProperty(key)) switch (a = i[key], typeof a) {
                case "undefined":
                case "unknown":
                case "function":
                    break;
    ...
    e.json.parseJSON = function() {
        ...
        s = function(n) {
            return n && n !== t && a("Expected '" + n + "' instead of '" + t + "'"),
            t = i.charAt(e),
            e += 1,
            t
        },
        l = function() {
            var e, n = "";
            for ("-" === t && (n = "-", s("-")); t >= "0" && "9" >= t;) n += t,
            s();
            if ("." === t) for (n += "."; s() && t >= "0" && "9" >= t;) n += t;
            if ("e" === t || "E" === t) for (n += t, s(), ("-" === t || "+" === t) && (n += t, s()); t >= "0" && "9" >= t;) n += t,
            s();
            return e = +n,
            isFinite(e) ? e: (a("Bad number"), void 0)
        },
        c = function() {
            var e, n, i, r, l = "";
            if ('"' === t || "'" === t) for (r = t; s();) {
        ...
        g = function() {
            ...
            if ("{" === t) {
                ...
                n;
                for (; t;) {
                    if (e = d(), u(), s(":"), Object.hasOwnProperty.call(n, e) && a('Duplicate key "' + e + '"'), n[e] = r(), u(), "}" === t) return s("}"),
                    n;
                    s(","),
                    u()
                }
        ...
        function(o, s) {
            ...
            function c(e, t) {
                var i, r, o = e[t];
                if (o && "object" == typeof o) for (i in o) Object.prototype.hasOwnProperty.call(o, i) && (r = c(o, i), r !== n ? o[i] = r: delete o[i]);
                return s.call(e, t, o)
            } ({
                "": l
            },
...
$.getBrowser = function() {
    ...
    t = "",
    n = "";
    return e.indexOf("AppleWebKit") >= 0 ? t = "webkit": e.indexOf("Gecko") >= 0 ? t = "gecko": e.indexOf("MSIE") >= 0 && (t = "ie"),
    e.indexOf("Firefox") >= 0 ? n = "firefox": e.indexOf("360SE") >= 0 ? n = "360se": e.indexOf("SE") >= 0 ? n = "sougou": e.indexOf("Maxthon") >= 0 ? n = "maxthon": e.indexOf("MSIE") >= 0 ? n = "ie": e.indexOf("Chrome") >= 0 ? n = "chrome": e.indexOf("Safari") >= 0 && (n = "safari"),
    {
        core: t,
        name: n
    }
...
$.resizePic = function(e, t, n, i) {
    ...
    return e.css("width", f[0]),
    e.css("height", f[1]),
    e.css("visibility", "visible"),
    1 == i && e.css("margin-top", (n - parseInt(f[1])) / 2),
    s
},
$.dateFormat = function(e, t) {
    ...
    l = e.getMinutes(),
    c = e.getSeconds();
    return n(/yyyy/g, String(r)),
    n(/yy/g, i(r.toString().slice(2), 2)),
    n(/MM/g, i(o, 2)),
    n(/M/g, o),
    n(/dd/g, i(a, 2)),
    n(/d/g, a),
...
function(e) {
    e.extend(String.prototype, {
        ...
        escapeUTF8: function() {
            return escape(this).replace(/%u(\w{4})/g,
            function(e, t) {
...
function(e) {
    ...
    t.prototype = {
        ...
        init: function() {
            var e = this.$el,
            t = this;
            e.bind("mouseenter.delayhover",
            function(e) {
                var n = this;
                t.hoverMouseenter(e, n)
            }),
            e.bind("mouseleave.delayhover",
            function(e) {
                var n = this;
        ...
        hoverMouseenter: function(e, t) {
            ...
            this.timer = setTimeout(function() {
                "function" == typeof i.mouseenter && i.mouseenter.call(t, e),
                n.entered = !0
            },
            i.enterDelay)
        },
        hoverMouseleave: function(e, t) {
            ...
            i = this.config;
            clearTimeout(this.timer),
            this.entered && (this.timer = setTimeout(function() {
                "function" == typeof i.mouseleave && i.mouseleave.call(t, e),
                n.entered = !1
            },
            i.leaveDelay))
        },
        ...
        destroy: function() {
            ...
            clearTimeout(this.timer),
            this.entered && "function" == typeof this.config.mouseleave && this.config.mouseleave.call(this)
        }
    },
    e.fn.delayhover = function(e) {
        if (this.data("tb-delayhover")) throw new Error("$.delayhover: \u4E0D\u80FD\u7ED1\u5B9A\u4E24\u6B21");
        return this.data("tb-delayhover", new t(this, e)),
        this
    },
    e.fn.removeDelayhover = function() {
        return this.data("tb-delayhover") && (this.data("tb-delayhover").destroy(), this.removeData("tb-delayhover")),
        this
    },
    e.fn.clearDelayHoverTimer = function() {
        return this.data("tb-delayhover") && this.data("tb-delayhover").clearHoverTimer(),
        this
    },
    e.tb.Delayhover = t
} (jQuery),
function($, undefined) {
    ...
    $.tb.format = function(e, t) {
        ...
        if ("object" == typeof t) return e.replace(o,
        function(e, n) {
            var i = t[n];
    ...
    $.tb.escapeUTF8 = function(e) {
        return escape(e).replace(/%u(\w{4})/g,
        function(e, t) {
            return encodeURIComponent(String.fromCharCode("0x" + t)).replace(/%/g, "%25")
        })
    },
    ...
    $.tb.Storage = function() {
        ...
        function i() {
            var e;
            return window.localStorage ? e = o() : window.ActiveXObject && (e = r()),
            e
        }
        function r() {
            ...
            t().addBehavior("#default#userData"),
            {
                set: function(i, r, o) {
                    ...
                    n(u) && (u = u.getTime()),
                    l.expires = new Date(u).toUTCString();
                    try {
                        l.setAttribute(c, r),
                        l.save(c)
                    } catch(h) {
                ...
                del: function(n) {
                    ...
                    try {
                        return r.load(o),
                        i = r.getAttribute(o),
                        i ? (r.removeAttribute(o), r.expires = new Date(315532799e3).toUTCString(), r.save(o), !0) : !1
                    } catch(a) {
                        return ! 1
                    }
                }
        ...
        return {
            set: function() {
                var e = this;
                return ! e._storage && (e._storage = i()),
                e._storage.set.apply(e._storage, arguments)
            },
            get: function() {
                var e = this;
                return ! e._storage && (e._storage = i()),
                e._storage.get.apply(e._storage, arguments)
            },
            remove: function() {
                var e = this;
                return ! e._storage && (e._storage = i()),
                e._storage.del.apply(e._storage, arguments)
            },
            isSupport: function() {
    ...
    var $$ = function(e, t) {
        ...
        a[u] = "$.swf.CallBacks." + this.instance + "." + u;
        o.flashVars = $.param(a),
        $.browser.msie ? (l.classid = "clsid:d27cdb6e-ae6d-11cf-96b8-444553540000", l.codebase = "http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0", o.movie = e) : (l.type = "application/x-shockwave-flash", l.data = e);
        var h = ['<object id="', i, '"'];
        for (var f in l) h.push(" ", f, '="', l[f], '"');
        h.push(">");
        for (var d in o) o[d] !== undefined && h.push('<param name="', d, '" value="', o[d], '" />');
        h.push("</object>"),
        $.each(r,
        function(e, t) {
            t.innerHTML = h.join("")
    ...
    $$.getVersion = function() {
        ...
        } else if (window.ActiveXObject && !window.opera) for (var n = 10; n >= 2; n--) try {
    ...
    $.JsLoadManager = $.JLM = {
        use: function(e, t, n, i) {
            if ("string" == typeof e) return "function" != typeof t ? (i = t, t = undefined) : i = n,
            this.loadUrl(e, t, i),
            void 0;
        ...
        loadParallel: function(e, t, n) {
            ...
            r = !1,
            o = 0,
            a = e.length; a > o && (this.loadUrl(e[o],
            function() {
        ...
        checkLoaded: function(e) {
            ...
            for (var t = 0,
            n = e.length; n > t; t++) if (!this.loaded[e[t]]) return ! 1;
            return ! 0
        },
        isArray: function(e) {
        ...
        loadUrl: function(e, t, n) {
            var i = this;
            this.loaded[e] !== undefined ? "function" == typeof t && t(e, this.loaded[e]) : this.loading[e] !== undefined ? "function" == typeof t && this.loading[e].push(t) : (this.loading[e] = [], "function" == typeof t && this.loading[e].push(t), this.createScriptTag(e,
            function(e, t) {
                i.loaded[e] = t;
                for (var n = 0,
                r = i.loading[e].length; r > n; n++) i.loading[e][n](e, t);
                delete i.loading[e]
            },
            n))
        },
    ...
    $.fn.tb_html = function(e) {
        if ("string" == typeof e) {
            for (var t = 0,
            n = this.length; n > t; t++) 1 === this[t].nodeType && (jQuery.cleanData(this[t].getElementsByTagName("*")), this[t].innerHTML = e);
            return this
        }
        return this.html(e)
    },
    $.tb.location = {
        ...
        _getSearchValue: function(e) {
            ...
            t = t.split("&");
            for (var i, r = 0,
            o = t.length; o > r; r++) i = t[r].indexOf("="),
            i > 0 ? n[t[r].substring(0, i)] = t[r].substring(i + 1) : n[t[r]] = "";
    ...
    $.tb.alert = function(e) {
        ...
        n = '<a href="#" class="ui_btn ui_btn_m j_btn #{class}" data-value="#{text}"><span><em>#{text}</em></span></a>';
        $root = $($.tb.format(t, e)),
        e.html = $root;
        var i = new $.dialog(e);
        return e.buttons = e.buttons ? $.isArray(e.buttons) ? e.buttons: [e.buttons] : [],
        ...
        function(e, t) {
            ...
            function(n) {
                n.preventDefault(),
                (!t.callback || t.callback && t.callback.call(this, e, i) !== !1) && i.close()
            }),
            $btn_group.append(r)
        }),
        i.setPosition(),
        e && e.show || i.show(),
        i.buttons = $.find(".j_btn"),
        i
    }
} (jQuery),
function(e) {
    ...
    e.tb.dataField = function(t, n) {
        null == n && (n = "data-field");
        var i = e.json.encode(t);
        return i = e.tb.escapeHTML(i),
        " " + n + '="' + i + '" '
    }
} (jQuery),
window.tbFormat = function(e, t) {
...
function(e) {
    ...
    function(i) {
        ...
        n[i] = function() {
            ...
            return "string" == typeof t && (t = e.tb.escapeHTML(t)),
            t
        }
    } (i);
    e.fn.extend(n)
...
$.stats = {
    ...
    track: function(e, a, t, n, o) {
        if (t && "object" == typeof t && (o = t, t = ""), n && "object" == typeof n && (o = n, n = ""), document.images) {
            ...
            var u = "http://static.tieba.baidu.com/tb/img/track.gif?",
            s = ["client_type=pc_web", "task=" + (a && encodeURIComponent(a) || ""), "locate=" + (e && encodeURIComponent(e) || ""), "type=" + (n && encodeURIComponent(n) || "click"), "url=" + encodeURIComponent(document.location.href), "refer=" + encodeURIComponent(document.referrer)];
            PageData && (s.push("page=" + (t || PageData.product || "")), PageData.forum && (s.push("fid=" + (PageData.forum.forum_id || "")), s.push("fname=" + encodeURIComponent(PageData.forum.forum_name || ""))), PageData.user && (s.push("uid=" + (PageData.user.user_id || PageData.user.user_id || "")), s.push("uname=" + encodeURIComponent(PageData.user.user_name || "")), s.push("is_new_user=" + (PageData.user.is_new_user || ""))), PageData.thread && s.push("tid=" + (PageData.thread && PageData.thread.thread_id || "")));
            for (var c in o) o.hasOwnProperty(c) && s.push(c + "=" + encodeURIComponent(o[c]));
            u += s.join("&"),
            r.src = u + "&t=" + (new Date).getTime(),
            r = null
        }
    },
    redirect: function(e) {
        ...
        PageData && (t.push("page=" + (e.page || PageData.product || "")), PageData.forum && (t.push("fid=" + (PageData.forum.forum_id || "")), t.push("fname=" + encodeURIComponent(PageData.forum.forum_name || ""))), PageData.user && (t.push("uid=" + (PageData.user.user_id || PageData.user.user_id || "")), t.push("uname=" + encodeURIComponent(PageData.user.user_name || "")), t.push("is_new_user=" + (PageData.user.is_new_user || ""))), PageData.thread && t.push("tid=" + (PageData.thread && PageData.thread.thread_id || "")));
...
function(e, n) {
    e.getPageData = function(e, t, r) {
        if ("undefined" == typeof t && (t = null), r = r || n || {},
        e) {
...
function() {
    ...
    var t = {
        ...
        htmlLenLimit: function(e, t) {
            return e += "",
            $.tb.getByteLength(e) <= t ? e: ['<span title="' + e + '">', $.tb.subByte(e, t), "</span>"].join("")
        },
        date: function(e, t) {
            ...
            for (var o in i) new RegExp("(" + o + ")").test(r) && (r = r.replace(RegExp.$1, 1 == RegExp.$1.length ? i[o] : ("00" + i[o]).substr(("" + i[o]).length)));
            return r
        }
    };
    ...
    function n(t, r, e) {
        ...
        c = !0;
        if ("[object Array]" == u) {
            if (a = t.length, c = a == r.length) for (; a--&&(c = a in t == a in r && n(t[a], r[a], e)););
        } else {
            if ("constructor" in t != "constructor" in r || t.constructor != r.constructor) return ! 1;
            for (var o in t) if (A.has(t, o) && (a++, !(c = A.has(r, o) && n(t[o], r[o], e)))) break;
            if (c) {
                for (o in r) if (A.has(r, o) && !a--) break;
                c = !a
            }
        }
        return e.pop(),
    ...
    "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = A), exports._ = A) : t._ = A,
    A.VERSION = "1.3.3";
    var w = A.each = A.forEach = function(n, t, r) {
        if (null != n) if (s && n.forEach === s) n.forEach(t, r);
        else if (n.length === +n.length) {
            for (var u = 0,
            i = n.length; i > u; u++) if (u in n && t.call(r, n[u], u, n) === e) return
        } else for (var a in n) if (A.has(n, a) && t.call(r, n[a], a, n) === e) return
    };
    A.map = A.collect = function(n, t, r) {
        var e = [];
        return null == n ? e: p && n.map === p ? n.map(t, r) : (w(n,
        function(n, u, i) {
    ...
    A.reduceRight = A.foldr = function(n, t, r, e) {
        var u = arguments.length > 2;
        if (null == n && (n = []), v && n.reduceRight === v) return e && (t = A.bind(t, e)),
        u ? n.reduceRight(t, r) : n.reduceRight(t);
        var i = A.toArray(n).reverse();
        return e && !u && (t = A.bind(t, e)),
        u ? A.reduce(i, t, r, e) : A.reduce(i, t)
    },
    ...
    A.filter = A.select = function(n, t, r) {
        var e = [];
        return null == n ? e: g && n.filter === g ? n.filter(t, r) : (w(n,
        function(n, u, i) {
    ...
    A.every = A.all = function(n, t, r) {
        var u = !0;
        return null == n ? u: d && n.every === d ? n.every(t, r) : (w(n,
        function(n, i, a) {
    ...
    var E = A.some = A.any = function(n, t, r) {
        t || (t = A.identity);
        var u = !1;
        return null == n ? u: m && n.some === m ? n.some(t, r) : (w(n,
        function(n, i, a) {
    ...
    A.uniq = A.unique = function(n, t, r) {
        var e = r ? A.map(n, r) : n,
        u = [];
        return n.length < 3 && (t = !0),
        A.reduce(e,
        function(r, e, i) {
            return (t ? A.last(r) === e && r.length: A.include(r, e)) || (r.push(e), u.push(n[i])),
            r
        },
        []),
        u
    ...
    A.indexOf = function(n, t, r) {
        if (null == n) return - 1;
        var e, u;
        if (r) return e = A.sortedIndex(n, t),
        n[e] === t ? e: -1;
        if (y && n.indexOf === y) return n.indexOf(t);
        for (e = 0, u = n.length; u > e; e++) if (e in n && n[e] === t) return e;
        return - 1
    },
    A.lastIndexOf = function(n, t) {
        if (null == n) return - 1;
        if (b && n.lastIndexOf === b) return n.lastIndexOf(t);
        for (var r = n.length; r--;) if (r in n && n[r] === t) return r;
        return - 1
    },
    ...
    A.bindAll = function(n) {
        var t = c.call(arguments, 1);
        return 0 == t.length && (t = A.functions(n)),
        w(t,
        function(t) {
            n[t] = A.bind(n[t], n)
        }),
    ...
    A.pick = function(n) {
        var t = {};
        return w(A.flatten(c.call(arguments, 1)),
        function(r) {
            r in n && (t[r] = n[r])
        }),
        t
    ...
    A.clone = function(n) {
        return A.isObject(n) ? A.isArray(n) ? n.slice() : A.extend({},
        n) : n
    },
    A.tap = function(n, t) {
        return t(n),
    ...
    A.template = function(n, t, r) {
        r = A.defaults(r || {},
        A.templateSettings);
        var e = "__p+='" + n.replace(R,
        function(n) {
            return "\\" + k[n]
        }).replace(r.escape || q,
        function(n, t) {
            return "'+\n_.escape(" + M(t) + ")+\n'"
        }).replace(r.interpolate || q,
        function(n, t) {
            return "'+\n(" + M(t) + ")+\n'"
        }).replace(r.evaluate || q,
        function(n, t) {
            return "';\n" + M(t) + "\n;__p+='"
        }) + "';\n";
    ...
    B = function(n, t) {
        N.prototype[n] = function() {
            ...
            return o.call(n, this._wrapped),
            T(t.apply(A, n), this._chain)
        }
    };
    A.mixin(A),
    ...
    function(n) {
        ...
        N.prototype[n] = function() {
            ...
            t.apply(r, arguments);
            var e = r.length;
            return "shift" != n && "splice" != n || 0 !== e || delete r[0],
            T(r, this._chain)
        }
    }),
    w(["concat", "join", "slice"],
...
function() {
    function t(t, e) {
        if (t instanceof Array) {
            for (var n = 0,
            i = t.length; i > n; n++) if (e.call(t[n], t[n], n) === !1) return
        } else for (var n in t) if (t.hasOwnProperty(n) && e.call(t[n], t[n], n) === !1) return
    }
    function e(t, e) {
    ...
    r.prototype = {
        ...
        triggerStack: function() {
            this._readyStack.length > 0 && (this.init(), t(this._readyStack,
            function(t) {
                t.doing || (t.doing = !0, t())
            }), this._readyStack = []),
            this._requiredStack.length > 0 && (t(this._requiredStack,
            function(t) {
                t.doing || (t.doing = !0, t())
            }), this._requiredStack = [])
        },
        define: function() {
            var e = this,
            n = this.deps,
            a = []; ! n && c.debug && (this.deps = getDependents(e.fn)),
            n = i(e.path, this.deps),
            n.length ? (r.loadingPaths[this.path] = !0, t(n,
            function(t) {
                var e = d(t);
                a.push(e.path)
            }), t(n,
...
function() {
    ...
    e = {
        ...
        addAdvice: function(t, e, n, r) {
            void 0 === this.pointCuts[t] && (this.pointCuts[t] = {}),
            void 0 === this.pointCuts[t][e] && (this.pointCuts[t][e] = []),
            this.pointCuts[t][e].push({
                type: n,
                advice: r
            })
        },
        inject: function(t, e) {
            ...
            if (n) {
                for (var r in n) for (var i, o = n[r]; i = o.shift();) $.aop[i.type]({
                    target: e,
                    method: r
                },
                i.advice);
    ...
    n = function(t) {
        ...
        var e = function(t) {
            ...
            for (var n in t)"prototype" != n && ($.isFunction(t[n]) ? e.method[n] = t[n] : e.noMethod[n] = $.isArray(t[n]) ? Array.prototype.slice.call(t[n], 0) : $.isPlainObject(t[n]) ? $.extend({},
            t[n]) : t[n]);
            return e
        },
        r = function() {
        ...
        return r.extend = function(t) {
            ...
            return $.extend(o.prototype, {
                __parent__: function(t) {
                    var n = this;
                    if (e.hasOwnProperty(t)) return $.isFunction(e[t]) ?
                    function() {
    ...
    i = n({
        ...
        unbind: function(t, e) {
            if (this._eventStack.hasOwnProperty(t)) {
                if (!e || !$.isFunction(e)) return delete this._eventStack[t],
                void 0;
                for (var n = this._eventStack[t], r = 0, i = n.length; i > r; r++) if (n[r].handler == e) {
                    n.splice(r, 1);
                    break
                }
            }
    ...
    l = {
        define: function(t) {
            if (t && t.hasOwnProperty("path") && t.hasOwnProperty("sub")) {
                ...
                i = null,
                o = p.getModuleAttr(e);
                if (p.checkAndInitAlias(t), t.requires = p.convertPaths(t.requires, o), t.extend = p.convertAlias(t.extend, o), i = t.extend, r = t.requires, l._checkDeps(e, t), r && $.isArray(r) && r.length > 0) for (var a = 0,
                s = r.length; s > a; a++) n.push(p.getJsPath(r[a], o));
        ...
        use: function(t, n, r, i) {
            ...
            function(a) {
                var s, u, l, h;
                if (e.inject(t, a.cls), u = a.cls && c(a.cls) || null, l = $.isArray(n) ? n: [n], !u) throw new Error("class is undefined! - " + o.path);
                l[0] && l[0].loadCss === !0 && (h = p.getCssPath(t), F.loadCss(h)),
                s = u.apply(null, l),
                "widget" != o.type || "undefined" != typeof i && i === !1 || (window[o.scope] = window[o.scope] || {},
                window[o.scope][o.module] = s),
                r && $.isFunction(r) && r.call(null, s)
            })
        },
        getInstance: function(t, e) {
            var n = p.getModuleAttr(t),
            r = (n.modulePath, l._checkGlobalInstance(t));
            r && "object" == typeof r ? e && $.isFunction(e) && e.call(null, r) : l.use(t, null,
            function(n) {
        ...
        _checkDeps: function(t, e) {
            ...
            if (void 0 !== n.type) {
                ...
                if ($.isArray(a[n.type]) && e.hasOwnProperty("requires") && $.isArray(e.requires)) for (var r = 0,
                i = e.requires.length; i > r; r++) {
    ...
    p.convertAlias = function(t, e) {
        var n, r;
        return e && t ? (n = e.module, r = s[n] || {},
        r[t] && (t = r[t]), t) : t
    },
    p.getModuleAttr = function(t, e) {
        var n, r, i, o, a, s, u, c, l = "",
        h = "/";
        if (n = t.replace(/\/$/, "").split("/"), u = n.length, 1 == u && e) o = t,
        a = e.module,
        r = e.type,
        i = e.scope;
        else if (3 === u || 4 === u) r = n[1].toLowerCase(),
        a = n[2],
        i = n[0],
        o = u > 3 ? n[3] : n[2];
        else {
            ...
            a = n[2],
            i = n[0];
            for (var d = 3; u - 1 > d; d++) l += n[d] + h;
            o = n[u - 1]
        }
        return o = p.nameToFile(o),
        s = (i + h + r + h + p.nameToFile(a) + h + l + o + ".js?class").toString(),
        c = (i + h + r + h + a + h + l + o).toString(),
        {
            scope: i,
            module: a,
            file: o,
    ...
    p.getCssPath = function(t) {
        return "/tb/static-" + t.replace(/^(\w+\/\w+\/)(\w+).*/g,
        function() {
...
function(t) {
    ...
    t.pathRule(function(t) {
        ...
        var s;
        return "object" == typeof c && (s = c[t.src]) ? (t.src = s, t.src = "http://tb1.bdstatic.com" + t.src, void 0) : (t.src = "http://tb1.bdstatic.com/tb/static-" + t.src, void 0)
    }),
...
function(e) {
    ...
    n._analysisStr = function(e) {
        ...
        e = e.replace(new RegExp("(" + r + "[\\s]*?var[\\s]*?.*?[\\s]*?[^;])[\\s]*?" + p, "g"), "$1;" + a).replace(new RegExp("(" + r + ":?[hvu]?[\\s]*?=[\\s]*?[^;|" + p + "]*?);[\\s]*?" + p, "g"), "$1" + a).split(t).join("	"),
        e = n.ESCAPE ? e.replace(new RegExp("\\t=(.*?)" + p, "g"), "',typeof($1) === 'undefined'?'':baidu.template._encodeHTML($1),'") : e.replace(new RegExp("\\t=(.*?)" + p, "g"), "',typeof($1) === 'undefined'?'':$1,'"),
...
function() {
    ...
    $(window).bind("touchend touchcanel",
    function(o) {
        ...
        if (e && c.changedTouches.length > 0) {
            ...
            n.direction.x = d.x > 0 ? "left": d.x < 0 ? "right": "none",
            n.distance.x = Math.abs(d.x),
            n.direction.y = d.y > 0 ? "down": d.y < 0 ? "up": "none",
            n.distance.y = Math.abs(d.y),
            $(t.instance.target).trigger(n),
            e = !1
        }
    }),
    innerTools = {
...
var PageLink = {
    ...
    init: function(e, t, n, a, o) {
        ...
        if ($(d).mousedown(function(n) {
            ...
            "A" !== n.target.nodeName && i._onclick(n, e, t, o)
        }), n && n.length) for (var m = 0; m < n.length; m++) i.bindCustomElem(n[m]);
    ...
    _onclick: function(e, t, n, a) {
        ...
        if (!i || "BODY" != i.nodeName) {
            ...
            if ((!a || !i || (d = a(i), "exit" != d)) && o._is_need_send_msg(i)) {
                for (var m = "fr=" + t + "&st_type=page_link&st_mod=" + n,
                _ = $.trim(i.className), r = i.id, c = i.nodeName, l = $.trim(i.className), s = 0; i && i.parentNode && i != document.body && i.parentNode != document.body;) i = i.parentNode,
                c = i.nodeName + c,
                i.className && 4 > s && (s++, l = l ? $.trim(i.className) + "-" + l: $.trim(i.className));
                m += "&st_value=" + c;
                var g = $(e.target).prevAll().length;
                m += g > 0 ? "&dom_i=" + g: "&dom_i=0",
                _ && (m += "&class_name=" + _),
                r && (m += "&id_name=" + r),
                l && (m += "&class_path=" + l),
                m = m.replace(/\ /g, "-"),
                "" != d && (m += "&" + d),
                o._debug > -1 && (o._debug++, $(document.body).append("<div>[" + o._debug + "] " + m + "<div>"), $(e.target).attr("title", "[" + o._debug + "] " + m), console && console.log("[" + o._debug + "] " + m));
                var u = new Image;
                window["bd_pv_" + (new Date).getTime()] = u,
                u.src = "http://tb1.bdstatic.com/tb/img/pv.gif?" + m + "&t=" + (new Date).getTime(),
                u = null
            }
        }
    },
...
};;F.module("datalazyload",
function() {
    function t(t) {
        t.style.display = g,
        t.className = "",
        $(t.value).appendTo(t.parentNode)
    }
    function e(t) {
    ...
    function n(t, e) {
        var n, i;
        return (n = t.id) || (n = t.id = v.guid("tb-lazyload")),
        (i = e.tbLazyloadId) || (i = e.tbLazyloadId = v.guid("tb-lazyload")),
        n + i
    }
    function i(t) {
    ...
    function r(t, e) {
        var n = this;
        if (! (n instanceof r)) return new r(t, e);
        "undefined" == typeof t && (t = L.container);
        var i = t;
        $.isPlainObject(i) || (i = e || {},
        t && (i.container = t)),
        $.isArray(i.container) ? 0 == i.container.length && (i.container = L.container) : i.container = $(i.container),
        i = $.extend(L, i),
        n.userConfig = i,
        l = n.userConfig.imgFlag || l,
        n._callbacks = i.callbacks || {},
        n._containerIsNotDocument = $.isArray(n.userConfig.container) ? 9 != n.userConfig.container[0].get(0).nodeType: 9 != n.userConfig.container.get(0).nodeType,
        n._filterItems(),
        n._initLoadEvent()
    }
    function s(t, e) {
    ...
    v = {
        ...
        later: function(t, e, n, i, a) {
            ...
            var o, r, s = t,
            c = $.makeArray(a);
            return "string" == typeof t && (s = i[t]),
            s || S.error("method undefined"),
            o = function() {
                s.apply(i, c)
            },
            r = n ? setInterval(o, e) : setTimeout(o, e),
            {
                id: r,
                interval: n,
                cancel: function() {
        ...
        buffer: function(t, e, n) {
            function i() {
                i.stop(),
                a = v.later(t, e, 0, n || this, arguments)
            }
            if (e = e || 150, -1 === e) return function() {
        ...
        _getHtmlById: function(t) {
            ...
            if (e.firstChild && 8 === e.firstChild.nodeType) {
                if (n = e.firstChild.nodeValue, "" == $.trim(n)) return n;
                $(n).insertBefore($(e)),
    ...
    L = {
        ...
        imgOnloadCallback: {},
        subListLoadCallback: {},
        placeholder: "http://tb1.bdstatic.com/tb/static-frs/img/v2/video_background.jpg?v=1",
        execScript: !0,
    ...
    return $.extend(r.prototype, {
        _filterItems: function() {
            var t = this,
            e = t.userConfig,
            n = t.userConfig.container,
            i = [],
            a = [],
            o = [],
            r = [],
            s = [n];
            $.isArray(e.container) && (t._backCompact = 1, s = e.container),
            $.each(s,
            function(e, n) {
                n = n.get(0),
                i = i.concat(v.filter($(n).find("img"), t._filterImg, t)),
                a = a.concat(v.filter($(n).find(".hideLzl"), t._filterSubList, t)),
                o = $.merge(o, $(n).find("textarea[data-type=" + f + "]")),
                r = $.merge(r, $(n).find("code[data-type=" + f + "]"))
            }),
            t._images = i,
            t._subList = a,
            t._textareas = o,
        ...
        _initLoadEvent: function() {
            ...
            var e = this,
            n = new Image,
            i = e.userConfig.placeholder,
            a = e.userConfig.autoDestroy,
            o = function() {
                e._loadItems(),
                a && e._isLoadAllLazyElements() && e.destroy()
            };
            e._loadFn = v.buffer(o, p, e),
            e.resume(),
            n.src = i,
            n.complete ? t() : n.onload = t
        },
        refresh: function() {
            this._loadFn()
        },
        _loadItems: function() {
            var t, e, n = this,
            i = n.userConfig.container; (n._backCompact || !n._containerIsNotDocument || i.get(0).offsetWidth) && (e = n._getBoundingRect(), !n._backCompact && n._containerIsNotDocument && (t = n._getBoundingRect(n.userConfig.container)), n._loadImgs(e, t, n.userConfig.imgOnloadCallback), n._loadCodeAreas(e, t), n._loadSublist(e, t, n.userConfig.subListOnloadCallback), n._loadTextAreas(e, t), n._fireCallbacks(e, t))
        },
        _loadImgs: function(t, e, n) {
            var i = this;
            i._images = v.filter(i._images,
            function(a) {
        ...
        _loadSublist: function(t, e, n) {
            var i = this;
            i._subList = v.filter(i._subList,
            function(i) {
                return o(i, t, e) ? (C(i, n), void 0) : !0
            },
            i)
        },
        _loadCodeAreas: function(t, n) {
            var i = this,
            a = i.userConfig.execScript;
            i._codes = v.filter(i._codes,
            function(r) {
                return o(r, t, n) ? (e(r, a), i._subList = i._subList.concat(v.filter($(i.userConfig.container).find(".hideLzl"), i._filterSubList, i)), void 0) : !0
            },
            i)
        },
        _loadTextAreas: function(e, n) {
            var i = this,
            a = i.userConfig.execScript;
            i._textareas = v.filter(i._textareas,
            function(i) {
        ...
        loadAllTextArea: function() {
            var e = this,
            n = e.userConfig.execScript;
            e._codes = v.filter(e._textareas,
            function(e) {
                return t(e, n)
            },
            e)
        ...
        loadAllCodeArea: function() {
            var t = this,
            n = t.userConfig.execScript;
            t._codes = v.filter(t._codes,
            function(t) {
                return e(t, n)
            },
            t)
        ...
        _getBoundingRect: function(t) {
            ...
            m = i + n,
            b = a + e;
            return $.isPlainObject(c) && (l = c.left || 0, f = c.right || 0, g = c.top || 0, h = c.bottom || 0),
            i -= l,
            m += f,
            a -= g,
            b += h,
    ...
    r.loadCustomLazyData = c,
    r
},
[]);;window.PageUnit = window.PageUnit || {
    load: function(t, a) {
        var n = "";
        return "object" == typeof PageUnitData && null != PageUnitData[t] && (n = PageUnitData[t], null != a && 0 == n.indexOf("<") && (n = $(n).attr(a).get(0).outerHTML)),
        n
    }
};; !
function(e) {
    ...
    e.fn.jCarouselLite = function(t) {
        ...
        this.each(function() {
            function i() {
                o(x - t.scroll),
                x - t.scroll >= 0 && (z = setTimeout(arguments.callee, t.hoverScroll + t.speed))
            }
            function n() {
                o(x + t.scroll),
                x + t.scroll <= g - b && (C = setTimeout(arguments.callee, t.hoverScroll + t.speed))
            }
            function s() {
            ...
            function o(l) {
                ...
                t.speed, t.easing,
                function() {
                    t.afterEnd && t.afterEnd.call(this, s()),
                    a = !1
                }), t.circular || (e(t.btnPrev).removeClass("prev_disabled"), e(t.btnNext).removeClass("next_disabled"), e(x - t.scroll < 0 && t.btnPrev || []).addClass("prev_disabled"), e(x + t.scroll > g - b && t.btnNext || []).addClass("next_disabled"))),
                !1
            }
            var a = !1,
            ...
            if (p.css({
                ...
                if (t.hoverScroll) {
                    ...
                    function() {
                        ...
                        z = setTimeout(i, t.hoverScroll + t.speed),
                        o(x - t.scroll)
                    })
            ...
            if (t.btnNext) {
                ...
                if (t.hoverScroll) {
                    ...
                    function() {
                        ...
                        C = setTimeout(n, t.hoverScroll + t.speed),
                        o(x + t.scroll)
                    })
...
} (jQuery);;$.tb.discardinglog = {
    _modDiscardJs: {},
    _hasLogAll: !1,
    discarding: function(i) {
        this._modDiscardJs[i] = 1,
        this._hasLogAll && this._sendLog(i)
    },
    _addLog: function(i, o, d) {
        d[o] instanceof Array && d[o].length > 0 ? i.push(o + ":" + d[o].join()) : i.push(o)
    },
    _sendLog: function(i) {
        var o = 1; ! window.PageData || "frs" != PageData.product && "pb" != PageData.product || (o = Math.floor(100 * Math.random())),
        1 === o && $.stats.track(i, "component_discard")
    },
    logAll: function() {
        var i, o = this,
        d = window.modDiscardTemplate || {},
        n = [];
        for (i in this._modDiscardJs) this._addLog(n, i, d);
        for (i in d) this._modDiscardJs[i] || this._addLog(n, i, d);
        this._hasLogAll = !0;
        for (var t = 0,
        s = n.length; s > t; t++) !
        function(i) {
...
function(e) {
    ...
    e.ui.intersect = function(e, i, s) {
        ...
        case "pointer":
            ...
            t(n, c, i.proportions().height) && t(o, h, i.proportions().width);
        case "touch":
    ...
    e.ui.ddmanager = {
        ...
        prepareOffsets: function(t, i) {
            ...
            e: for (s = 0; s < n.length; s++) if (! (n[s].options.disabled || t && !n[s].accept.call(n[s].element[0], t.currentItem || t.element))) {
                for (o = 0; o < a.length; o++) if (a[o] === n[s].element[0]) {
...
function(t) {
    ...
    var i = function(t, i, r) {
        t && "object" == typeof t && (i = t.high, r = t.unsigned, t = t.low),
        this.low = 0 | t,
        this.high = 0 | i,
        this.unsigned = !!r
    },
    ...
    i.fromNumber = function(t, r) {
        return r = !!r,
        isNaN(t) || !isFinite(t) ? i.ZERO: !r && -h >= t ? i.MIN_SIGNED_VALUE: r && 0 >= t ? i.MIN_UNSIGNED_VALUE: !r && t + 1 >= h ? i.MAX_SIGNED_VALUE: r && t >= s ? i.MAX_UNSIGNED_VALUE: 0 > t ? i.fromNumber( - t, !1).negate() : new i(t % o | 0, t / o | 0, r)
    },
    ...
    u = i.fromInt(1 << 24);
    i.ZERO = i.fromInt(0),
    i.UZERO = i.fromInt(0, !0),
    i.ONE = i.fromInt(1),
    i.UONE = i.fromInt(1, !0),
    i.NEG_ONE = i.fromInt( - 1),
    i.MAX_SIGNED_VALUE = i.fromBits( - 1, 2147483647, !1),
    i.MAX_UNSIGNED_VALUE = i.fromBits( - 1, -1, !0),
    i.MAX_VALUE = i.MAX_SIGNED_VALUE,
    i.MIN_SIGNED_VALUE = i.fromBits(0, -2147483648, !1),
    i.MIN_UNSIGNED_VALUE = i.fromBits(0, 0, !0),
    i.MIN_VALUE = i.MIN_SIGNED_VALUE,
    i.prototype.toInt = function() {
    ...
    i.prototype.toString = function(t) {
        ...
        if (this.isNegative()) {
            if (this.equals(i.MIN_SIGNED_VALUE)) {
                ...
                n = this.div(e);
                return r = n.multiply(e).subtract(this),
                n.toString(t) + r.toInt().toString(t)
            }
    ...
    i.prototype.add = function(t) {
        ...
        g += r + s,
        g &= 65535,
        i.fromBits(p << 16 | l, g << 16 | a, this.unsigned)
    },
    ...
    i.prototype.multiply = function(t) {
        ...
        a += r * g + e * f + n * h + o * s,
        a &= 65535,
        i.fromBits(l << 16 | N, a << 16 | p, this.unsigned)
    },
    i.prototype.div = function(t) {
        ...
        if (this.equals(i.MIN_SIGNED_VALUE)) {
            ...
            return r = o.div(t).shiftLeft(1),
            r.equals(i.ZERO) ? t.isNegative() ? i.ONE: i.NEG_ONE: (e = this.subtract(t.multiply(r)), n = r.add(e.div(t)))
        }
        ...
        for (n = i.ZERO, e = this; e.greaterThanOrEqual(t);) {
            ...
            for (var s = Math.ceil(Math.log(r) / Math.LN2), h = 48 >= s ? 1 : Math.pow(2, s - 48), u = i.fromNumber(r, this.unsigned), f = u.multiply(t); f.isNegative() || f.greaterThan(e);) r -= h,
            u = i.fromNumber(r, this.unsigned),
            f = u.multiply(t);
            u.isZero() && (u = i.ONE),
            n = n.add(u),
            e = e.subtract(f)
    ...
    "undefined" != typeof module && module.exports ? module.exports = i: "undefined" != typeof define && define.amd ? define("Math/Long", [],
    function() {
        return i
    }) : (t.dcodeIO || (t.dcodeIO = {}), t.dcodeIO.Long = i)
} (this);;$.lcsFlash = function(e) {
    var n = function() {
        return {
            log: function() {
                if ($.cookie("lcs_debug") && "console" in window) {
                    ...
                    else for (var n = 0; n < arguments.length; ++n) console.log($.json.encode(arguments[n]))
                }
            },
            error: function() {
                if ($.cookie("lcs_debug") && "console" in window) {
    ...
    o = function() {
        function o() {
            ...
            c = window.setInterval(function() {
                $.isEmptyObject(d) && r(),
                n.log("[\u8F6E\u8BE2]\u6B63\u5728\u68C0\u67E5\u5DF2\u53D1\u9001\u961F\u5217\uFF0C\u5F53\u524D\u957F\u5EA6\u4E3A", Object.keys(d).length),
                $.each(d,
                function(e, o) {
        ...
        function i(e) {
            ...
            u, e);
            r.data64 = t.encode(r),
            r.sendTime = (new Date).getTime(),
            r.cid = r.sendTime,
            r.beforeSend(r),
            n.log("call LCSAS.send", r),
            t.send(r),
            d[r.cid] = r,
            o()
        }
        ...
        p.send = function(e, n, o, t, r, c) {
            ...
            return "object" == typeof n && "function" != typeof o ? (r = t, t = o, o = void 0) : "function" == typeof n && (r = t, t = o, o = n, n = void 0),
            i({
                command: e,
                data: n,
                success: o,
        ...
        p.on = function(e, o) {
            if (!$.isFunction(o)) return n.error("on\u65B9\u6CD5\u5FC5\u987B\u63D0\u4F9B\u56DE\u8C03\u65B9\u6CD5"),
            this;
            if ("number" == typeof e) e = [e];
            else if ("string" == typeof e) e = e.split(s);
            else if (!$.isArray(e)) return n.error("\u4E0D\u80FD\u8BC6\u522B\u7684\u547D\u4EE4\u53F7"),
            this;
            return $.each(e,
            function(e, n) {
        ...
        p.off = function(e, n) {
            ...
            return "undefined" == typeof n ? $.each(e,
            function(e, n) {
                f[ + n] = []
            }) : $.isFunction(n) && $.each(e,
            function(e, o) {
        ...
        p.onmessage = function(e) {
            ...
            var o = d[e.cid],
            r = f[e.command];
            return o || r ? (o && (n.log("\u5DF2\u627E\u5230\u6D88\u606F\u53D1\u9001\u8005"), o.response = e.data, o.success(e.data, o), o.complete(e.data, o), delete d[e.cid]), r && (n.log("\u5DF2\u627E\u5230\u6D88\u606F\u76D1\u542C\u8005\uFF0C\u5C06\u4F9D\u6B21\u6267\u884C\u56DE\u8C03"), $.each(r,
            function(n, o) {
                o(e.data, e)
        ...
        p.openCallback = function() {
            $.each(l,
            function(e, o) {
                n.log("[lcs] call open callback: ", o),
                o()
            })
        },
        p
    ...
    t = function() {
        function e(e, n, o, t) {
            var i = {};
            return i = "object" == typeof e ? $.extend({},
            r, e) : $.extend({},
            r, {
                host: e,
                Appid: n,
        ...
        window.STQ = {
            ...
            onopen: function() {
                n.log("[onopen]", arguments),
                o.openCallback()
            },
            login: function(e) {
                n.log("[JS\u6CE8\u518C]", e),
                $.post("/connectmanager/user/updateFlashInfo", e)
            },
            getLongId: function() {
                var e = $.cookie("LONGID");
                return null == e ? "": e
        ...
        return {
            ...
            connect: function() {
                ...
                $("body").append(o);
                var t = "http://tb2.bdstatic.com/tb/static-common/lcs/LCSAS_b80db27.swf",
                r = {
                    id: "LCSAS",
...
window.CommonUiDecorator.prototype = {
    processEffect: function(e, t, c, f) {
    ...
    forceEffect: function(e, t, c) {
        ...
        e.className = e.className.replace(f, "") + " " + t + c,
        e.setAttribute("effect_pri", this._priorityConfig[c])
    },
...
function() {
    ...
    e.CheckBox = function() {
        ...
        this.checkMsg = function(e) {
            var r = !0;
            if (! (e && e.hasOwnProperty("head") && e.hasOwnProperty("body") && e.head.type)) return alert("\u6D88\u606F\u4E0D\u5B8C\u6574"),
            !1;
            var n = t.getType(e.head.type);
            if (!n) return alert("\u6D88\u606F\u7C7B\u578B\u4E0D\u5B58\u5728\uFF01"),
            !1;
            for (var s in n.body) if (!e.body.hasOwnProperty(s)) {
                alert("\u6D88\u606F\u4F53\u7ED3\u6784\u4E0D\u5B8C\u6574\uFF01"),
                r = !1;
                break
            }
    ...
    e.Server = function(t) {
        ...
        this.sendToQueue = function(t) {
            var n = t.getTo();
            r.hasOwnProperty(n) && r[n] || (r[n] = new e.MsgQue(n)),
            r[n].add(t)
        },
    ...
    function() {
        ...
        this.distribute = function(e) {
            if (!r.checkBox().checkMsg(e)) return ! 1;
            var n = t.getServer(e.getTo()),
            s = t.getServer(e.getFrom());
    ...
    function() {
        ...
        u = function() {
            for (var e in o) i.addMsgType(e, o[e])
        },
        a = function(e, t, r, s) {
        ...
        this.registerServer = function(e) {
            n.addServer(e),
            this.setProcessor(e, "system", a)
        },
        this.initedServer = function(e) {
            this.sendMsgToAll("system", e, {
                state: "init",
                msg: !0
            })
        },
...
var TbCom, TbComMsName = "ComManager",
MsgSystem = MsgSystem || {
    need_start: !0
},
Events = {
    ...
    off: function(o, e, t) {
        var s, n, r;
        if (o) {
            if (n = this._callbacks) for (o = o.split(/\s+/); s = o.shift();) if (r = n[s], delete n[s], e && r) for (; (r = r.next) && r.next;)(r.callback !== e || t && r.context !== t) && this.on(s, r.callback, r.context)
    ...
    trigger: function(o) {
        ...
        for (i = s.all, (o = o.split(/\s+/)).push(null); e = o.shift();) i && o.push({
            next: i.next,
            tail: i.tail,
            event: e
        }),
        ...
        for (c = Array.prototype.slice.call(arguments, 1); t = o.pop();) for (n = t.tail, r = t.event ? [t.event].concat(c) : c; (t = t.next) !== n;) t.callback.apply(t.context || this, r);
        return this
    }
}; !
function() {
    var o = "undefined" == typeof _VERSION ? {}: _VERSION,
    e = {
        staticVersion: 18.58,
        comlist: {
            PassportFillName: {
                inited: !1,
                loaded: !1,
                url: "/tb/static-common/" + (o["component/commonLogic/common/passport/PassportFillName.js"] || "component/commonLogic/common/passport/PassportFillName.js")
            },
            PassportSign: {
                inited: !1,
                loaded: !1,
                url: "/tb/static-common/" + (o["component/commonLogic/common/passport/PassportLogin.js"] || "component/commonLogic/common/passport/PassportLogin.js")
            },
            PassportRegister: {
                inited: !1,
                loaded: !1,
                url: "/tb/static-common/" + (o["component/commonLogic/common/passport/PassportRegister.js"] || "component/commonLogic/common/passport/PassportRegister.js")
            },
            User: {
                inited: !1,
                loaded: !1,
                url: "/tb/static-common/" + (o["component/commonLogic/common/user/User.js"] || "component/commonLogic/common/user/User.js")
            },
            UserBar: {
                inited: !1,
                loaded: !1,
                url: "/tb/static-common/" + (o["component/commonLogic/common/user/UserBar.js"] || "component/commonLogic/common/user/UserBar.js")
            },
            Suggestion: {
                inited: !1,
                loaded: !1,
                url: "/tb/static-common/" + (o["component/commonLogic/common/suggestion/Suggestion.js"] || "component/commonLogic/common/suggestion/Suggestion.js")
            },
            Poptip: {
                inited: !1,
                loaded: !1,
                url: "/tb/static-common/" + (o["component/commonLogic/common/poptip/Poptip.js"] || "component/commonLogic/common/poptip/Poptip.js")
            },
            WealthSystem: {
                inited: !1,
                loaded: !1,
                url: "/tb/static-common/" + (o["component/commonLogic/common/wealth/WealthSystem.js"] || "component/commonLogic/common/wealth/WealthSystem.js")
            },
            Search: {
                inited: !1,
                loaded: !0,
                url: "/tb/static-common/" + (o["component/commonLogic/common/search/Search.js"] || "component/commonLogic/common/search/Search.js")
            },
            MsgSystem: {
                inited: !1,
                loaded: !1,
                url: "/tb/static-common/" + (o["component/commonLogic/common/crosspage_msg_system/MsgSystem.js"] || "component/commonLogic/common/crosspage_msg_system/MsgSystem.js")
            },
            UserMessage: {
                inited: !1,
                loaded: !1,
                url: "/tb/static-common/" + (o["component/commonLogic/common/user_message/UserMessage.js"] || "component/commonLogic/common/user_message/UserMessage.js")
            }
        },
        defualtMerger: ["User", "UserBar", "Suggestion", "Poptip", "WealthSystem"],
        defaultMergerURL: "/tb/static-common/" + (o["component/commonLogic/common/common_default_merger.js"] || "component/commonLogic/common/common_default_merger.js"),
        error: {
            SUCCESS: 0,
            COM_NOT_FOUND: 1,
            METHOD_NOT_FOUND: 2,
    ...
    s = function() {
        ...
        this.createPars = function(e) {
            for (var t = [], s = e; s < o.length; s++) t.push(o[s]);
            return t
        }
    },
    n = new
    function() {
        this.process = function() {
            if (arguments.length < 2) return new t(e.error.PROCESS_ERROR);
            var o = arguments[0],
            n = arguments[1];
            if (!o || !e.comlist[o].inited) return new t(e.error.COM_NOT_FOUND);
            if (!o.hasOwnProperty(n) || "function" != typeof o[n]) return new t(e.error.METHOD_NOT_FOUND);
            var r = new s(arguments).createPars(2),
            i = TbMsgSys.sendMsg("process", TbComMsName, o, {
                method: arguments[1],
                params: r
            });
    ...
    function() {
        ...
        i = function() {
            ...
            for (var e in o) TbMsgSys.addMsgType(e, o[e]);
            TbMsgSys.setProcessor(TbComMsName, "loadCom", g),
            TbMsgSys.setProcessor(TbComMsName, "needCom", m),
            TbMsgSys.initedServer(TbComMsName),
            $.console.debug("\u6A21\u5757\uFF1A" + TbComMsName + " \u6FC0\u6D3B\uFF01"),
            $.console.debug("\u6A21\u5757\uFF1A" + TbComMsName + " \u6FC0\u6D3B\uFF01\u51C6\u5907\u5F00\u59CB\u52A0\u8F7D\u9ED8\u8BA4\u5408\u5E76\u9759\u6001\u6587\u4EF6!"),
            $(c)
        },
        c = function() {
            var t = o.comlist,
            s = o.defualtMerger,
            n = o.defaultMergerURL;
            $.JsLoadManager.use(n + "?v=" + e.staticVersion);
            for (var r = 0; r < s.length; r++) t[s[r]].loaded = !0
        },
        m = function(o, e, s, n) {
            var r = n.coms;
            if (r && (r.length > 0 || !p(r))) {
        ...
        a = function(e) {
            o.comlist[e].inited = !0,
            TbMsgSys.initedServer(e),
            $.console.debug("\u6A21\u5757\uFF1A" + e + " \u6FC0\u6D3B\uFF01"),
            n.process(e, "init"),
            delete t[e]
        },
        ...
        u = function(o) {
            for (var e in t) $.inArray(o, t[e]) >= 0 && p(t[e]) && (a(e), arguments.callee(e))
        },
        p = function(e) {
            for (var t = !0,
            s = 0; s < e.length; s++) {
                if (!o.comlist.hasOwnProperty(e[s])) return ! 1;
        ...
        d = function(t) {
            return o.comlist.hasOwnProperty(t) && o.comlist[t].url ? $.inArray(t, o.defualtMerger) >= 0 ? ($.console.log("\u8BE5\u6A21\u5757\u5728\u9ED8\u8BA4\u5408\u5E76\u6587\u4EF6\u4E2D\uFF0C\u4E0D\u505A\u5355\u72EC\u52A0\u8F7D : " + t), void 0) : (o.comlist[t].loaded || ($.JsLoadManager.use(o.comlist[t].url + "?v=" + e.staticVersion,
            function() {
                l(t)
        ...
        this.process = function(o, e) {
            ...
            return TbMsgSys.sendMsg("process", TbComMsName, o, {
                method: e,
                params: t
            })
        },
        ...
        this.defaultLogicInit = function(o, t, s, n, i) {
            var c = n || null;
            "undefined" != typeof i && (e.staticVersion = i),
            this.setNeedStartConfig(s),
            r.User && (this.process("User", "init", o, t), r.UserBar && this.process("UserBar", "init", c)),
            r.Suggestion && this.process("Suggestion", "createMainSearchSuggestion"),
            !o.is_login || o.no_un || !r.MsgSystem || MsgSystem && MsgSystem.hasOwnProperty("need_start") && MsgSystem.need_start !== !0 || (this.process("MsgSystem", "init"), r.UserMessage && this.process("UserMessage", "init", t, c))
        },
        i()
    };
    TbCom = r,
...
var TbICom = function() {
    ...
    this.initSys = function(s, r, i) {
        t || (o = s, $.extend(e, i), n = r, TbMsgSys.registerServer(o), TbMsgSys.setProcessor(o, "process", this.processMsgHandler), TbMsgSys.sendMsg("needCom", o, "ComManager", {
            coms: n
        }), t = !0, $.console.debug("\u6A21\u5757: " + s + " initSys\uFF01\u4F9D\u8D56\uFF1A" + r))
    },
    this.init = function() {},
...
var TbUtil = {
    ...
    selectAll: function(e, t, n) {
        ...
        if (r) {
            for (var i = r.getElementsByTagName("input"), o = 0, a = i.length; a > o; o++) i[o].getAttribute("name") == t && (i[o].checked = n.checked);
            i = null
        }
    },
    getCheckedValue: function(e, t, n) {
        ...
        if (o) {
            for (var a = o.getElementsByTagName("input"), u = 0, s = a.length; s > u; u++) i = a[u],
            i.checked && r.push(i.value);
            a = null
        }
        return r.join(n)
    },
...
TbUtil.DBC2SBC = function(e) {
    var t, n = "";
    for (t = 0; t < e.length; t++) str1 = e.charCodeAt(t),
    n += 65296 > str1 ? String.fromCharCode(e.charCodeAt(t)) : 125 > str1 && !flag ? String.fromCharCode(e.charCodeAt(t)) : String.fromCharCode(e.charCodeAt(t) - 65248);
    return n
},
...
TbUtil.escapeUTF8 = function(e) {
    return escape(String(e)).replace(/%u(\w{4})/g,
    function(e, t) {
        return encodeURIComponent(String.fromCharCode("0x" + t)).replace(/%/g, "%25")
    })
},
TbUtil.resizePic = function(e, t, n, r) {
    ...
    return e.style.width = c[0] + "px",
    e.style.height = c[1] + "px",
    e.style.visibility = "visible",
    1 == r && (e.style.marginTop = (n - parseInt(c[1])) / 2 + "px"),
    u
},
TbUtil.json = {},
TbUtil.json.encode = function() {
    ...
    function t(e) {
        var t, n, r, i = ["["],
        o = e.length;
        for (n = 0; o > n; n++) switch (r = e[n], typeof r) {
        case "undefined":
        case "function":
        case "unknown":
            break;
    ...
    return function(n) {
        ...
        default:
            ...
            var i, o, a = ["{"],
            u = TbUtil.json.encode;
            for (key in n) if (n.hasOwnProperty(key)) switch (o = n[key], typeof o) {
            case "undefined":
            case "unknown":
            case "function":
                break;
    ...
    if ("string" != typeof string || !string.length) return null;
...
TbUtil.handleError = function(e, t, n, r, i) {
    if (e.no = e.no || e.error_no, _autoHide = i || !1, 4 == e.no) Fe.showLoginLayer(!0);
    else {
        var o = t || "\u64CD\u4F5C\u5931\u8D25",
        n = n || "left",
        r = r || e.error || FORUM_ERROR_INFO[e.no] || "\u64CD\u4F5C\u5931\u8D25";
        TbUtil.showErrorTip(o, r, n, _autoHide)
    }
};
var PageData = PageData || {};PageData.tbs_loaded = !0, TbUtil.requestTbs = function(asyn) {
...
String.prototype.clear = function() {
    var e = this,
    t = e.replace(/\<br[^\>^\<]*\/?\>/gi, "");
    return t = t.replace(/\<p[^\>^\<]*\>(\&nbsp\;)?\<\/p\>|\<p\/?\>/gi, ""),
    t.trim()
},
...
String.prototype.wordCut = function(e, t) {
    if (! ("number" != typeof e || 0 > e)) {
        ...
        i = this,
        o = new Array,
        a = i.replace(/[^\x00-\xff]/g,
        function(e) {
            return o.push(e),
            "*)"
        });
        if (a[n - 1] && "*" == a[n - 1] && ")" == a[n] && n++, n >= a.length) return i;
        a = a.substr(0, n);
        var u = 0;
...
String.prototype.subByte = function(e) {
    if (this.wordLen() <= e) return this;
    for (var t = Math.floor((e -= 2) / 2), n = this.length; n > t; t++) if (this.substr(0, t).wordLen() >= e) return this.substr(0, t) + "\u2026";
    return this
},
...
String.prototype.subByteFix = function(e, t) {
    if (this.wordLen() <= e) return this;
    for (var n = Math.floor((e - 2) / 2), r = this.length; r > n; n++) if (this.substr(0, n).wordLen() >= e) return this.substr(0, n) + (t ? t: "");
    return this
};; ! new
function() {
    TbICom.call(this);
    var e = this,
    t = {
        _keyValues: [["\u8D34\u5427\u6295\u8BC9", "http://tieba.baidu.com/tousu/new"], ["\u5E16\u5427\u6295\u8BC9", "http://tieba.baidu.com/tousu/new"], ["tiebatousu", "http://tieba.baidu.com/tousu/new"], ["\u8D34\u5427\u6295\u8BC9\u5427", "http://tieba.baidu.com/tousu/new"], ["\u8D34\u5427\u6295\u8BC9\u4E2D\u5FC3", "http://tieba.baidu.com/tousu/new"], ["\u6295\u8BC9\u4E2D\u5FC3", "http://tieba.baidu.com/tousu/new"], ["\u6295\u8BC9", "http://tieba.baidu.com/tousu/new"], ["\u8D34\u5427\u4E3E\u62A5", "http://tieba.baidu.com/tousu/new"], ["\u77E5\u9053\u6295\u8BC9", "http://tousu.baidu.com/zhidao"], ["\u7A7A\u95F4\u6295\u8BC9", "http://tousu.baidu.com/hi"], ["\u767E\u79D1\u6295\u8BC9", "http://tousu.baidu.com/baike"], ["zhidaotousu", "http://tousu.baidu.com/zhidao"], ["kongjiantousu", "http://tousu.baidu.com/hi"], ["baiketousu", "http://tousu.baidu.com/baike"]],
        go: function(e) {
            for (var t = this._keyValues,
            a = e.toLowerCase(), o = 0; o < t.length; o++) if (a == t[o][0]) return window.location.href = t[o][1],
            !0;
    ...
    i = {
        ...
        countPV: function(e) {
            var t = new Image;
            window["bd_pv_" + (new Date).getTime()] = t,
            t.src = "http://tb1.bdstatic.com/tb/img/pv.gif?t=" + (new Date).getTime() + "&" + e
        },
        ...
        search: function(t, n) {
            if (e.dispatchEvent("search", t), n || (n = ""), "" == o(t.kw.value)) return window.location.href = "http://tieba.baidu.com",
            !1;
            var r = "/f";
            if (a("jointb" + n)) {
        ...
        searchItieba: function(e) {
            return window.location.href = "/i/sys/enter?ie=utf-8&kw=" + encodeURIComponent(e),
            !1
        },
        ...
        searchWord: function(e) {
            return $.tb.post("/data/searchhistory?method=add_word&ie=UTF-8", {
                word: e
            },
            function() {}),
            setTimeout(function() {
    ...
    this.initSys("Search", [], {
        headSetWord: i.setWord,
        headSetVal: i.setVal,
        headSearch: i.search,
        headSearchTieba: i.searchTieba,
        headSearchITieba: i.searchItieba,
        headSearchWord: i.searchWord
    })
};;
var NsLogLinker = {
    _pid: 0,
    stat: function(e, n) {
        var t = "nslog__" + (new Date).getTime(),
        o = window[t] = new Image,
        i = n || this._pid;
        o.onload = o.onerror = function() {
            window[t] = null
        },
        o.src = "http://nsclick.baidu.com/v.gif?pid=" + i + "&url=" + encodeURIComponent(e) + "&t=" + (new Date).getTime() + "&type=0",
        o = null
    },
    _checkEvent: function(e) {
        e = e || event;
        var n = e.srcElement || e.target;
        for (1 != n.nodeType && (n = n.parentNode); n && n.tagName && "A" != n.tagName.toUpperCase();) n = n.parentNode;
    ...
    bind: function(e) {
        this._pid = e,
        document.attachEvent ? (document.attachEvent("onmousedown", this._checkEvent), window.attachEvent("onunload",
        function() {
            document.detachEvent("onmousedown", NsLogLinker._checkEvent)
        })) : (document.addEventListener("mousedown", this._checkEvent, !1), window.addEventListener("unload",
        function() {
...
baidu.swf.getVersion = function() {
    ...
    } else if (window.ActiveXObject && !window.opera) for (var i = 10; i >= 2; i--) try {
...
baidu.swf.createHTML = function(e) {
    e = e || {};
    var a, i, s = baidu.swf.getVersion(),
    n = 1,
    r = e.ver || "6.0.0";
    if (s) {
        s = s.split("."),
        r = r.split(".");
        for (var t = 0; 3 > t && (a = parseInt(s[t], 10), i = parseInt(r[t], 10), !(a > i)); t++) if (i > a) {
            n = 0;
            break
        }
    } else n = 0;
    if (!n) return "";
    var t, o, l, c, d = e.vars,
    u = ["classid", "codebase", "id", "width", "height", "align"];
    if (e.align = e.align || "middle", e.classid = "clsid:d27cdb6e-ae6d-11cf-96b8-444553540000", e.codebase = "http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0", e.movie = e.url || "", delete e.vars, delete e.url, baidu.isString(d)) e.flashvars = d;
    else {
        var f = [];
        for (o in d) c = d[o],
        c && f.push(o + "=" + encodeURIComponent(c));
        e.flashvars = f.join("&")
    }
    var p = ["<object "];
    for (t = 0, l = u.length; l > t; t++) c = u[t],
    p.push(" ", c, '="', e[c], '"');
    p.push(">");
    var w = {
        wmode: 1,
    ...
    for (o in e) c = e[o],
    w[o] && c && p.push('<param name="' + o + '" value="' + c + '" />');
    e.src = e.movie,
    e.name = e.id,
    delete e.id,
    delete e.movie,
    ...
    return v && p.push(' salign="', v, '"'),
    p.push("></embed></object>"),
    p.join("")
},
baidu.swf.create = function(e, a) {
    e = e || {};
    var i = baidu.swf.createHTML(e),
    s = !0;
    return a && baidu.isString(a) && (a = document.getElementById(a)),
    i.length <= 0 && (i = e.errorMessage || "", s = !1),
    a && (a.innerHTML = i),
    s
},
...
var CaptchaCom = function(t, i) {
    this.init(t, i)
};CaptchaCom.DEFAULT_OPTIONS = {
    imgUrl: "/cgi-bin/genimg?",
    audioUrl: "/cgi-bin/genaudio?",
    inputFocusClass: "c_captcha_focus",
    onInputFocus: null,
    onInputBlur: null,
    beforeImgInit: null,
    afterImgInit: null,
    template: '<div class="clearfix"><div class="c_captcha_input_con j_input_con"><input style="ime-mode:disabled " autocomplete="off" size="10" maxlength="10" class="c_captcha_input_normal j_captcha_input" ></div><div class="c_captcha_sub_wrap j_captcha_content clearfix" style="display:none;"><div class="c_captcha_img j_captcha_img_wrapper"></div><div class="c_captcha_a"><a class="j_captcha_img_change"  >\u770B\u4E0D\u6E05?</a>&nbsp;<a class="c_captcha_a_audio j_captcha_audio_switch" >\u6536\u542C\u9A8C\u8BC1\u7801</a></div><div class="c_captcha_audio"><img class="j_captcha_audio_icon c_captcha_audio_img" src="http://tieba.baidu.com/tb/img/audio.gif" /><span class="j_captcha_audio_wrapper"></span></div></div></div><div class="c_captcha_tip j_captcha_tip">\u8BF7\u70B9\u51FB\u540E\u8F93\u5165\u9A8C\u8BC1\u7801</div><div class="c_captcha_error j_captcha_err"></div>'
},
CaptchaCom.prototype = {
    init: function(t, i) {
        this.captchaReq = t,
        this.options = $.extend({},
        CaptchaCom.DEFAULT_OPTIONS, i),
        this.initialized = !1,
        this.needUpdate = !0,
        this.j_container = $(i.container);
        var a = $(this.options.template);
        this.j_container.html(a),
    ...
    _initEvents: function() {
        ...
        this.j_input.blur(function(i) {
            $(this).removeClass(t.options.inputFocusClass),
            t.options.onInputBlur && t.options.onInputBlur.call(this, i, t),
            t.reset()
        }),
        this.j_input.focus(function(i) {
            $(this).addClass(t.options.inputFocusClass),
            t.options.onInputFocus && t.options.onInputFocus.call(this, i, t),
            t.initialized === !1 && (t.options.beforeImgInit && t.options.beforeImgInit.call(t), t.updateCaptchaImg(), t.initialized = !0, t.options.afterImgInit && t.options.afterImgInit.call(t))
        })
    },
    ...
    validCaptcha: function() {
        ...
        return this.captchaReq.antiProcess(),
        !this.captchaReq.needCaptcha || null != t && 0 != t.length ? !0 : (this.j_error.text("\u9A8C\u8BC1\u7801\u4E0D\u80FD\u4E3A\u7A7A\uFF0C\u8BF7\u8F93\u5165\u9A8C\u8BC1\u7801").show(), this.j_input.focus(), !1)
    },
    ...
    updateCaptchaImg: function() {
        if (this.needUpdate) {
            ...
            this._getData();
            var i = this.j_img,
            a = this.options.imgUrl + this.signStr + "&t=" + Math.random();
    ...
    show: function() {
        1 == this.captchaReq.answer.showShenshou && (1 == this.captchaReq.answer.open_by_spam ? this.j_tip.text("\u8BF7\u70B9\u51FB\u540E\u8F93\u5165\u9A8C\u8BC1\u7801") : this.j_tip.text("\u4E3A\u62B5\u5FA1\u7206\u5427\u6316\u575F\uFF0C\u5427\u4E3B\u8BBE\u7F6E\u672C\u5427" + this.captchaReq.answer.shenshou_lv + "\u7EA7\u4EE5\u4E0B\u7528\u6237\u6682\u65F6\u9700\u8981\u8F93\u5165\u4E2D\u6587\u9A8C\u8BC1\u7801"), this.j_input.css("imeMode", "active"), this.j_switchAudioBtn.hide()),
...
var CaptchaReqCom = function(s, e) {
    ...
    this.answer = {
        antiNeedVerify: null,
        antiNeedVerifyAnonymous: null
    },
    this.postType = "thread",
    this.url = e || "/f/user/json_needvcode",
    this.forumName = s.forumName,
    this.forumId = s.forumId,
    "reply" == s.postType && (this.postType = "reply", s.tid && (this.tid = s.tid)),
    this.async = !0,
    s.async === !1 && (this.async = !1),
    delete s.forumName,
    delete s.forumId,
    delete s.postType,
    delete s.tid,
    delete s.async,
    this.params = s
};CaptchaReqCom.prototype = {
    _ifHasKnowAnti: function() {
    ...
    _getAntiAnswer: function(s) {
        var e = this,
        n = {
            rs1: this.isAnonymous ? "1": "0",
            rs10: "thread" == this.postType ? "1": "0",
            lm: this.forumId,
            word: this.forumName,
            t: Math.random()
        };
        this.tid && (n.tid = this.tid),
        this.isPosting = !0,
        $.ajax({
            url: e.url,
            data: n,
    ...
    handleAnswer: function(s) {
        this.isAnonymous ? this.answer.antiNeedVerifyAnonymous = s.need: this.answer.antiNeedVerify = s.need,
        this.answer.showShenshou = s.open_shenshou,
        1 == s.open_shenshou && (this.answer.shenshou_lv = s.shenshou_lv, this.answer.open_by_spam = s.open_by_spam),
        this.tid && (s.vcodeUrl += "&tid=" + this.tid),
        this.setVcodeUrl(s.vcodeUrl)
    },
    ...
    antiProcess: function(s) {
        if (!this.isPosting) {
            ...
            n = "",
            t = function() {
                n = e.isAnonymous ? e.answer.antiNeedVerifyAnonymous: e.answer.antiNeedVerify,
                e.needCaptcha = "1" == n,
                s && s(e.needCaptcha)
            };
...
var UiBubbleTipBase = function(e) {
    ...
    this._option = $.extend(!0, i, e),
    this._event = {},
    this.init()
};UiBubbleTipBase.bubbles = {},
UiBubbleTipBase.count = 0, UiBubbleTipBase.prototype = {
    constructor: UiBubbleTipBase,
    init: function() {
        this.buildBubble()
    },
    buildBubble: function() {
        var e = this._option;
        _html = this.genericTpl(),
        wrap = e.wrap,
        this.j_bubble = $(_html),
        wrap.append(this.j_bubble),
        this.j_bubble.css(e.bubble_css),
        this.j_bubble.find(".j_ui_triangle").css(e.arrow_pos),
        this.setContent(e.content),
        "up" == e.arrow_dir || "down" == e.arrow_dir ? this.j_bubble.find(".j_content").css({
            width: e.bubble_css.width
        }) : this.j_bubble.find(".j_content").css({
            width: e.bubble_css.width - 7
        }),
        e.closeBtn && this.j_bubble.find(".j_close").show(),
        e.arrowReq || this.hideArrow(),
        this._bindEvent(),
        this.cid = "bubble_" + UiBubbleTipBase.count,
        UiBubbleTipBase.count++
    },
    _bindEvent: function() {
        var e = this._option,
        i = this;
    ...
    triggerEvent: function(e) {
        var i = !0;
        if (this._event[e]) for (var b = this._event[e], t = 0; t < b.length; t++) b[t].fun && b[t].fun(),
        b[t].stat || (i = !1);
        return i
    },
    genericTpl: function() {
        var e = this._option.attr,
    ...
    closeBubble: function() {
        this.j_bubble.remove(),
        delete UiBubbleTipBase.bubbles[this.cid]
    },
    hideArrow: function() {
    ...
    showBubble: function(e) {
        if (e) if (e.zIndex) this._getBubbleInfo(e.zIndex),
        this.j_bubble.css({
            "z-index": e.zIndex
        }),
        this.showByTime(e.type, e.time);
        else {
            this._getBubbleInfo();
    ...
    _getBubbleInfo: function(e) {
        ...
        i.minT = n,
        i.maxT = n + l,
        e && (i.bubbleType = "inter"),
        UiBubbleTipBase.bubbles[i.cid] = i
    },
    _isCover: function() {
        var e = this,
        i = e.cid,
        b = UiBubbleTipBase.bubbles,
        t = e;
        for (var s in b) if (s == i || "inter" == e.bubbleType || "none" == b[s].j_bubble.get(0).style.display);
        else {
            var n = b[s];
            if (t.minL < n.maxL && t.maxL > n.minL && t.minT < n.maxT && t.maxT > n.minT) return n
        }
        return ! 1
    },
    ...
    setFixedForMessage: function() {
        ...
        function() {
            e && clearTimeout(e),
            null == b && (b = {
                top: parseInt(i.j_bubble.css("top")) || i.j_bubble.position().top
            }),
    ...
    _bubleFixedSet: function(e) {
        ...
        b > e.top ? (i.setBubbleFixed(), $.browser.msie && "6.0" == $.browser.version || i.j_bubble.css({
            top: -5
        }), i.j_bubble.find(".ui_triangle").hide()) : (i.setBubbleNormal(), i.j_bubble.css({
            top: e.top
        }), i.j_bubble.find(".ui_triangle").show())
    }
};;
var PopWindow = function(t) {
    ...
    trigger: function(t) {
        if (this._event[t]) for (var e = this._event[t], n = 0; n < e.length; n++) if (e[n].fun && e[n].fun(), !e[n].stat) return ! 1;
        return ! 0
    },
    _buildHtml: function() {
        var t = this;
        if ($("#pop_frame").length > 0) return ! 1;
        var e = this._option,
        n = $("#j_popWindow_tpl_" + e.styleId).html(),
        i = e.templateObj.title;
        e.templateObj.title = i + t._sayHi();
        var o = $.tb.format(n, e.templateObj);
        this.PopupContainer = document.createElement("div"),
        this.PopupContainer.id = "pop_frame",
        this.PopupContainer.innerHTML = o,
    ...
    _sayHi: function() {
        var t = "",
        e = (new Date).getHours();
        return e >= 0 && 5 > e ? t = "\uFF1A": e >= 5 && 9 > e ? t = "\uFF0C\u65E9\u4E0A\u597D\uFF1A": e >= 9 && 12 > e ? t = "\uFF0C\u4E0A\u5348\u597D\uFF1A": e >= 12 && 14 > e ? t = "\uFF0C\u4E2D\u5348\u597D\uFF1A": e >= 14 && 18 > e ? t = "\uFF0C\u4E0B\u5348\u597D\uFF1A": e >= 18 && 24 > e && (t = "\uFF0C\u665A\u4E0A\u597D\uFF1A"),
        t
    },
    _eventInit: function() {
        var t = this,
...
Compressor = function() {
    ...
    this.compress = function(t) {
        var o = t.quality ? t.quality: 1,
        a = t.imageType ? t.imageType: "image/jpeg",
        s = 1,
        u = t.image.width,
        i = t.image.height;
        ...
        e.clearRect(0, 0, u, i),
        e.scale(s, s / c),
        e.drawImage(t.image, 0, 0);
        var h = n.toDataURL(a, o),
        d = (h.length - 814) / 1.37;
        return t.maxSize && t.maxSize < d && (o = t.maxSize / d, h = n.toDataURL(a, o)),
        h
    };
...
MImage = {};MImage._createImage = function(n) {
    var e = new Image;
    return e.size = n.file.size || 0,
    e.name = n.file.name || "",
    e.type = n.file.type || "",
    e.percent = 0,
    e.status = Enum.FileStatus.NONE,
    e.response = "",
    e.errorCode = 0,
    e.errorMessage = "",
    e.onLoaded = n.onLoaded,
    e.id = "img_" + (new Date).getTime() + "_" + e.type,
    e.getData = function() {
...
MImage._compressImage = function(n, e, t, r, o) {
    ...
    return n.width > t || n.height > r ? a.compress({
        image: n,
        maxWidth: t,
        maxHeight: r,
        maxSize: o
...
MImage.create = function(n) {
    var e = (new Compressor, !1),
    t = null;
    return t = MImage._createImage(n),
    t.onload = function() { ! e && n.maxWidth && n.maxHeight && (t.width > n.maxWidth || t.height > n.maxHeight) ? (t.src = MImage._compressImage(t, t.type, n.maxWidth, n.maxHeight, n.maxSize), t.size = MImage._calImageSize(t.src), e = !0) : (t.onLoaded && (t.onLoaded(t), t.onLoaded = null), e = !1)
    },
    MImage._readImage(n.file,
    function(n) {
        t.src = n
    }),
    t
...
ImageQueue = function(n) {
    ...
    s = this,
    u = n.onLoaded || null,
    i = n.onItemLoaded || null,
    l = function(n) {
        n.status = Enum.FileStatus.NONE,
        s.push(n),
        i && i(n),
        e == s.length() && u && u(s.toArray())
    },
    m = function(n) {
        return s.length() < t ? (MImage.create({
            file: n,
            maxWidth: r,
            maxHeight: a,
            maxSize: o,
            onLoaded: l
        }), !0) : (alert("The queue is exceeded!"), !1)
    };
    this.pop = function() {
        for (var n = null; this._index < this._queue.length;) if (n = this._queue[this._index++], n.status == Enum.FileStatus.NONE) return n;
        return null
    },
    ...
    this.isComplete = function() {
        for (var n = 0,
        e = 0; e < this.length(); e++) this.get(e).status != Enum.FileStatus.NONE && this.get(e).status != Enum.FileStatus.RUNNING && n++;
        return n == this.length()
    },
    this.getCompleteItems = function() {
        for (var n = [], e = 0; e < this.length(); e++) this.get(e).status != Enum.FileStatus.NONE && this.get(e).status != Enum.FileStatus.RUNNING && n.push(this.get(e));
        return n
    },
    this.remove = function(n) {
        this._queue.splice(n, 1),
...
FilePoster = function(n, e) {
    ...
    a = function() {
        t.sendAsBinary || (t.sendAsBinary = function(n) {
            var e = Array.prototype.map.call(n,
            function(n) {
    ...
    u = function(n) {
        var e = "----WebKitFormBoundary" + Math.random(),
        t = "--" + e,
        r = [];
        for (var o in n) r.push(t),
        "object" == typeof n[o] ? (r.push('Content-Disposition: form-data; name="' + o + '"; filename="' + n[o].filename + '"'), r.push("Content-Type: " + n[o].type), r.push(""), r.push(atob(n[o].content))) : (r.push('Content-Disposition: form-data; name="' + o + '"'), r.push(""), r.push(n[o]));
        return r.push(t + "--"),
        {
            boundary: e,
            payload: r.join("\r\n")
    ...
    i = function(n) {
        if (n) for (var e in n) r.bind(e, n[e])
    };
    this.bind = function(n, e) {
        t[n] = e,
        "onprogress" == n && (t.upload[n] = e)
    },
    this.sendAsBinary = function(n, e, r) {
        var o = u(e);
        i(r),
        t.open("POST", n, !0),
        t.setRequestHeader("Content-Type", "multipart/form-data; boundary=" + o.boundary),
        t.sendAsBinary(o.payload)
    },
...
Processor = function() {
    ...
    this._command = Enum.ProcessorCommand.NONE,
    this._status = Enum.ProcessorStatus.NOTSTART,
    this.bind = function(n, e) {
        this.handler[n] = e
    },
    ...
    this.process = function() {
        this._status = Enum.ProcessorStatus.RUNNING,
        this._command = Enum.ProcessorCommand.NONE
    },
    this.pause = function() {
...
Uploador = function(n, e) {
    ...
    u = function(n) {
        ...
        t.percent = e,
        s(r.handler.onProcessing, t)
    },
    i = function(n) {
        t.response = null;
        try {
            t.response = JSON.parse(n.target.responseText),
            t.status = Enum.FileStatus.COMPLETE,
            r._status = Enum.ProcessorStatus.COMPLETE,
            r.handler.onComplete && s(r.handler.onComplete, t)
        } catch(n) {
            r._status = Enum.ProcessorStatus.ERROR,
            t.status = Enum.FileStatus.ERROR,
            t.errorCode = Enum.Error.JSON_PARSE_ERROR.no,
            t.errorMessage = Enum.Error.JSON_PARSE_ERROR.msg,
    ...
    l = function() {
        r._status = Enum.ProcessorStatus.ERROR,
        t.status = Enum.FileStatus.ERROR,
        t.errorCode = Enum.Error.NETWORK_ERROR.no,
        t.errorMessage = Enum.Error.NETWORK_ERROR.msg,
        r.runHandler(r.handler.onError, t)
    },
    m = function() {
        r._status = Enum.ProcessorStatus.ERROR,
    ...
    this.process = function(e) {
        ...
        e.file.getData();
        t = e.file,
        t.status = Enum.FileStatus.RUNNING,
        this._status = Enum.ProcessorStatus.RUNNING,
        o.sendAsBinary(r, t.getPostData())
    },
    a()
},
UploadorPool = function(n, e) {
    ...
    e && o.extend(o.handler, e);
    var s = function(n) {
        o.runHandler(o.handler.onItemComplete, n),
        g(),
        d(),
        f()
    },
    u = function(n) {
        o.runHandler(o.handler.onItemError, n),
        o.runHandler(o.handler.onError, n),
        g(),
        d(),
        f()
    },
    i = function(n) {
        o.runHandler(o.handler.onItemProcessing, n),
        a = l(),
        o.runHandler(o.handler.onProcessing, {
            percent: a,
            imageList: t.toArray()
        })
    },
    l = function() {
        for (var n = t.toArray(), e = 0, r = 0; r < n.length; r++) e += n[r].percent;
    ...
    c = function() {
        for (var n = null,
        e = 0; e < r.length; e++) if (r[e]._status != Enum.ProcessorStatus.RUNNING) {
            n = r[e];
            break
        }
        return null == n && r.length < o.conf.maxLength && (n = m(), r.push(n)),
        n
    },
    h = function() {
        for (var n = 0,
        e = 0; e < r.length; e++) r._status != Enum.ProcessorStatus.RUNNING && n++;
        return n == r.length
    },
    d = function() {
        o._status != Enum.ProcessorStatus.COMPLETE && o._command == Enum.ProcessorCommand.NONE && o.process({
            queue: t
        })
    },
    f = function() {
        o._command == Enum.ProcessorCommand.PAUSE && o._status == Enum.ProcessorStatus.RUNNING && h() && (o._status = Enum.ProcessorStatus.PAUSE, o.runHandler(o.handler.onPause, {
            percent: a,
            imageList: t.toArray()
        }))
    },
    g = function() {
        return t.isComplete() && o._status != Enum.ProcessorStatus.COMPLETE ? (o._status = Enum.ProcessorStatus.COMPLETE, o.runHandler(o.handler.onComplete, {
            percent: 100,
            imageList: t.toArray()
        }), !0) : !1
    },
    E = function() {
        if (t && (o._command = Enum.ProcessorCommand.NONE, o._status = Enum.ProcessorStatus.RUNNING, !g())) for (; t.remainLength() > 0;) {
            var n = c();
            if (null == n) break;
            var e = t.pop();
            e && (o.runHandler(o.handler.onItemStart, e), n.process({
                file: e
            }))
        }
    };
    this.process = function(n) {
        o.conf.url = n.url || o.conf.url,
        t = n.queue,
        o.runHandler(o.handler.onStart, t.toArray()),
        E()
    },
    this.pause = function() {
        this._command = Enum.ProcessorCommand.PAUSE
...
MultiUploador = function(n, e) {
    ...
    e && t.extend(t.handler, e);
    var s = function() {
        a = $("<input type='file' accept='image/*' />").css({
            opacity: "0",
            width: t.conf.container.width() + "px",
            height: t.conf.container.height() + "px"
        }).attr("multiple", "multiple"),
        a.appendTo(t.conf.container),
        a.bind("change", i),
        o = new UploadorPool({
            maxLength: t.conf.maxParallel,
            url: t.conf.postUrl
        }),
        u()
    },
    u = function() {
        o.bind("onComplete",
        function(n) {
            t.runHandler(t.handler.onComplete, n),
            r.reset()
        }),
        o.bind("onProcessing",
        function(n) {
    ...
    i = function(n) {
        r || (r = new ImageQueue({
            maxLength: t.conf.queueLen,
            onLoaded: c,
            onItemLoaded: m,
            maxWidth: t.conf.maxWidth,
            maxHeight: t.conf.maxHeight,
            maxSize: t.conf.maxSize
        })),
        r.concat(n.target.files),
        l()
    },
    l = function() {
        a.val("")
    ...
    m = function(n) {
        n.size > t.conf.maxSize && (n.status = Enum.FileStatus.ERROR, n.errorCode = Enum.Error.FILE_SIZE_OVERFLOW.no, n.errorMessage = Enum.Error.FILE_SIZE_OVERFLOW.msg, t.runHandler(t.handler.onError, n)),
        t.runHandler(t.handler.onImageLoaded, n)
    },
    c = function(n) {
        t.runHandler(t.handler.onFileSelected, {
            percent: 0,
            imageList: n
        }),
        t._command == Enum.ProcessorCommand.NONE && t.conf.isAutoUp && t.startUpload()
    };
    this.start = function() {
        this.runHandler(t.handler.onStartUpload, {
            percent: 0,
            imageList: r.toArray()
        }),
        o.process({
    ...
    this.deleteFile = function(n) {
        for (var e = r.toArray(), t = 0; t < e.length; t++) e[t].id && e[t].id == n && r.remove(t)
    },
    s()
},
Html5Uploader = {
    ...
    Processor: Processor,
    Uploador: Uploador,
    UploadorPool: UploadorPool,
    MultiUploador: MultiUploador
};;_.Module.define({
    path: "common/component/Select",
    sub: {
        _attrs: {},
        _defaultAttrs: {
            cid: 0,
        ...
        selectTpl: ['<div id="<%=classPrefix%>-cid-<%=cid%>" class="<%=classPrefix%>">', '<ul class="<%=classPrefix%>-content">', "<% for (var i = 0, len = select.length; i < len; i++ ) {%>", '<li class="<%=classPrefix%>-item <%=select[i]["selected"] ? classPrefix + "-selected" : "" %>" data-index="<%=i%>" data-value="<%=select[i]["value"]%>"><%=select[i]["text"]%></li>', "<% } %>", "</ul>", "</div>"].join(""),
        initial: function(e) {
            if (0 === e.trigger.length) throw "trigger is not found";
            this._mergeAttr(e)
        },
        render: function() {
            var e = this,
            ...
            if ("select" === i[0].tagName.toLowerCase()) {
                ...
                var s = i.tbattr("name");
                s && this.set("name", s),
                this.set("disabled", i.tbattr("disabled")),
                r = e._getClassName(t.classPrefix, "trigger"),
                i.addClass(r),
                this.set("selectSource", i);
                var n = $(e.get("triggerTpl")).addClass(r);
                this.set("trigger", n),
                i.after(n).hide(),
                e.set("model", e.convertSelect(i[0], e.get("classPrefix"))),
                e._bindEvents()
            }
        },
        ...
        convertSelect: function(e, t) {
            ...
            for (i = 0; n > i; i++) {
                var c, o = {},
                u = s[i],
                d = ["text", "value", "defaultSelected", "selected", "disabled"];
                for (c in d) {
                    var g = d[c];
                    o[g] = u[g]
                }
            ...
            return ! l && r.length && (r[0].selected = "true"),
            {
                cid: a,
                select: r,
                classPrefix: t
        ...
        set: function(e, t) {
            var i = this.get(e);
            this._isEqual(i, t) || (this.fire("change-cid-" + this.get("cid") + ":" + e, {
                prev: i,
                value: t
            }), this._attrs[e] = t)
        },
        ...
        asyncSelect: function(e) {
            for (var t = this.get("selectSource"), i = "", r = 0, s = e.select.length; s > r; r++) i += "<option " + (e.select[r].selected ? "selected": "") + ' value="' + e.select[r].value + '">' + e.select[r].text + "</option>";
            t.html(i).trigger("change")
        },
        _bindObserve: function() {
            var e = this;
            this.observe("change-cid-" + this.get("cid") + ":model",
            function(t, i) {
                var r = i.value,
                s = baidu.template,
                n = e.get("trigger");
                ...
                for (var a = null,
                c = 0,
                o = r.select.length; o > c; c++) r.select[c].selected && (a = r.select[c]);
                n.html(a.text),
                e.asyncSelect(r)
            }),
            this.observe("change-cid-" + this.get("cid") + ":visiable",
            function(t, i) {
                var r = i.value,
                s = (e.get("classPrefix"), e.get("cid"), e.get("trigger")),
                n = s.offset(),
                l = e.get("options");
                l.css({
                    width: s.outerWidth(),
        ...
        _bindEvents: function() {
            ...
            this.get("options").on("click", ".ui-select-item",
            function() {
                for (var t = e.get("model"), i = $(this).data("index"), r = $.extend(!0, {},
                t), s = 0, n = r.select.length; n > s; s++) r.select[s].selected = !1;
                r.select[i].selected = !0,
                e.set("model", r),
                e.set("visiable", !1)
            }),
            $("body").on("click",
        ...
        _getClassName: function(e, t) {
            if (!e) return this.get("className");
            var i = this.get("className") + " " + e + "-" + t;
            return this.get("disabled") && (i += " " + e + "-" + t + "-disabled"),
            i
        },
        _isType: function(e) {
            return function(t) {
        ...
        _isEmptyAttrValue: function(e) {
            var t = this._isType("String"),
            i = this._isType("Array"),
            r = Object.prototype.toString,
            s = function(e) {
                return null != e && e == e.window
            },
            n = function(e) {
                if (!e || "[object Object]" !== r.call(e) || e.nodeType || s(e) || !e.hasOwnProperty) return ! 1;
        ...
        _isPlainObject: function(e) {
            ...
            if (!e || "[object Object]" !== t.call(e) || e.nodeType || r(e)) return ! 1;
            try {
        ...
        _isEqual: function(e, t) {
            ...
            if (this._isPlainObject(e) && this._isPlainObject(t)) {
                if (!this._isEqual(this._keys(e), this._keys(t))) return ! 1;
                for (var l in e) if (e[l] !== t[l]) return ! 1;
                return ! 0
            }
            return ! 1
        },
        _mergeAttr: function(e) {
            this._attrs = $.extend(!0, {},
            this._defaultAttrs);
            for (var t in this._defaultAttrs) e.hasOwnProperty(t) && (this._attrs[t] = e[t])
        },
        _keys: function(e) {
            var t = Object.keys;
            if (t) return t(e);
    ...
    sub: {
        initial: function(e) {
            var t = this;
            t.requireInstanceAsync("common/widget/Tdou", [],
            function(c) {
                e && e.chargeType && "platform" == e.chargeType ? c.factory("payment", e) : (e && (t.consumption_path = e.consumption_path, t.desc = e.desc, t.current_need_tdou = e.current_need_tdou, t.is_direct_cashier = e.is_direct_cashier), e && t.is_direct_cashier ? c.factory("auto_direct", e) : c.factory("get_icon", t.consumption_path || ""))
            })
        }
    }
});;_.Module.define({
    path: "common/widget/wallet_dialog",
    requires: ["common/component/Card", "common/component/JsPager", "common/widget/umoneyQuery"],
    sub: {
        _dialog: null,
        _html: null,
        _pushPager: null,
            ...
            $.ajax({
                ...
                success: function(l) {
                    if (0 === l.no) {
                        ...
                        a._dialog = new $.dialog(t),
                        a._buildPager(1, $("#wallet_dialog_msg_tbmall_pop_pager"), a._popPager, a._popChange, l),
                        a._buildPager(1, $("#wallet_dialog_msg_other_pop_pager"), a._otherPopPager, a._otherPopChange),
                        a._buildPager(1, $("#wallet_dialog_msg_push_pager"), a._pushPager, a._pushChange),
                        $("#wallet_dialog_tab").on("click", ".j_wallet_dialog_tab_item",
                        function(a) {
                            var l = $(a.currentTarget);
                            $(".j_wallet_dialog_tab_item").removeClass("wallet_dialog_tab_current"),
                            l.addClass("wallet_dialog_tab_current");
                            var t = l.tbattr("attr-show");
                            $(".j_wallet_dialog_msg_list").hide(),
                            $(t).show()
                        }),
                        $("#wallet_dialog_return").on("click",
                        function() {}),
                        $("#wallet_dialog_medal").on("click", ".j_wallet_dialog_medal_btn",
                        function(l) {
                            l.preventDefault(),
                            a.requireInstanceAsync("common/widget/JoinVipDialog", [],
                            function(a) {
                                a.getMemberDialog("\u83B7\u53D6T\u8C46\u6D6E\u5C42", 1004001e3)
                            }),
                            a.hide(),
                        ...
                        $("#j_wallet_tcharge_dialog").on("click",
                        function() {
                            $.stats.track("T\u8C46\u94B1\u5305\u6D6E\u5C42\u83B7\u53D6T\u8C46", "\u4F1A\u5458\u5B98\u7F51\u7EDF\u8BA1"),
                            a.hide(),
                            a.requireInstanceAsync("common/widget/tcharge_dialog")
                        }),
                        a.addUmoney()
                    }
                }
        ...
        addUmoney: function() {
            var a = this;
            a.umoney = a.requireInstance("common/widget/umoneyQuery");
            var l = a.umoney.showUmoney("\u767E\u5EA6\u6709\u94B1\u53EF\u7528\u989D\u5EA6");
            a._dialog.element.find(".wallet_dialog_my_tbean").after(l)
        },
        _getOrderStatus: function(a) {
            var l = {
                ...
                2 : "\u5151\u6362\u6210\u529F",
                3 : "\u5151\u6362\u5931\u8D25\uFF0CT\u8C46\u5DF2\u9000\u8FD8",
                4 : '\u5151\u6362\u8D85\u65F6\uFF0C<a target="_blank" href="/f?ie=utf-8&kw=T%E8%B1%86%E5%95%86%E5%9F%8E%E5%90%A7">\u8054\u7CFB\u7BA1\u7406\u5458</a>'
            };
            return l[a]
        },
        _otherPopChange: function(a, l) {
            ...
            e = 5;
            $.ajax({
                url: "/tbmall/getThirdOrder?ie=utf8&c=" + e + "&pn=" + a + "&_t=" + (new Date).valueOf(),
                type: "get",
                dateType: "json",
                success: function(_) {
                    0 === _.no && (t._buildOtherPopPage.call(t, _, a), l(Math.ceil(_.data.total_count / e)))
                }
            })
        },
        _buildOtherPopPage: function(a, l) {
            for (var t = a.data.order_info || [], e = [], _ = 0; _ < t.length; _++) {
                var s = t[_],
                i = new Date(1e3 * s.create_time),
                o = this._formatDateTime(i),
                n = s.status;
                e.push('<li class="wallet_dialog_msg_list_item wallet_dialog_msg_list_item_pop">'),
                e.push('<div class="wallet_dialog_order">\u8BA2\u5355\u53F7\uFF1A' + s.order_id + "\uFF0C<span>" + this._getOrderStatus(n) + "</span></div>"),
                e.push('<div class="text_overflow">\u60A8\u83B7\u53D6\u3010<strong>' + $.tb.subByte(s.goods_name, 24, "") + "</strong>\u3011\u5546\u54C1\uFF0C"),
                e.push('\u6D88\u8D39\u4E86<span class="orange_text">' + s.tdou_num + "T\u8C46</span></div>"),
                e.push('<span class="wallet_dialog_msg_list_date">' + o + "</span>"),
                e.push("</li>")
            }
            0 == t.length && 1 == l && (e.push('<div class="wallet_dialog_msg_empty">'), e.push("\u60A8\u8FD8\u6CA1\u8D2D\u4E70\u8FC7\u4E1C\u897F\u54E6~\uFF0C<br>\u8D34\u5427\u65B0\u73A9\u6CD5\u4ECE\u9177\u70AB\u7279\u6743\u9053\u5177\u5F00\u59CB\u3002<br>"), e.push('<a target="_blank" href="/tbmall/home">\u8FDB\u5165\u5546\u57CE\u8D2D\u4E70&gt;&gt;</a>'), e.push("</div>")),
            e = e.join(""),
            $("#wallet_other_pop_list_main").html(e)
        },
        _popChange: function(a, l, t) {
            var e = this,
            _ = 10;
            return t ? (e._buildPopPage.call(e, t), l(Math.ceil(t.data.total_count / _)), void 0) : ($.ajax({
                url: "/tbmall/history?ie=utf8&c=" + _ + "&pn=" + a + "&_t=" + (new Date).valueOf(),
                type: "get",
                dateType: "json",
                success: function(t) {
                    0 === t.no && (e._buildPopPage.call(e, t, a), l(Math.ceil(t.data.total_count / _)))
                }
            }), void 0)
        },
        _formatDateTime: function(a) {
            var l = a || Date.now(),
            t = [];
            return t.push(l.getFullYear() + "\u5E74"),
            t.push(parseInt(l.getMonth() + 1) + "\u6708"),
            t.push(l.getDate() + "\u65E5&nbsp;"),
            t.push(l.getHours() + ":"),
            t.push(l.getMinutes()),
            t = t.join("")
        ...
        _buildPopPage: function(a, l) {
            for (var t = a.data.order_info || [], e = [], _ = 0; _ < t.length; _++) {
                ...
                o = this._formatDateTime(i);
                e.push('<li class="wallet_dialog_msg_list_item wallet_dialog_msg_list_item_pop">'),
                e.push('\u60A8\u6D88\u8D39\u4E86<span class="orange_text">' + s.scores + "T\u8C46</span>\uFF0C");
                var n = 0 == s.props_id.indexOf("105") ? "\u8D2D\u4E70": "\u5151\u6362";
                e.push(n + "\u4E86\u9053\u5177<strong>" + s.props_name + "</strong>"),
                e.push('<span class="wallet_dialog_msg_list_date">' + o + "</span>"),
                e.push("</li>")
            }
            0 == t.length && 1 == l && (e.push('<div class="wallet_dialog_msg_empty">'), e.push("\u60A8\u8FD8\u6CA1\u8D2D\u4E70\u8FC7\u4E1C\u897F\u54E6~\uFF0C<br>\u8D34\u5427\u65B0\u73A9\u6CD5\u4ECE\u9177\u70AB\u7279\u6743\u9053\u5177\u5F00\u59CB\u3002<br>"), e.push('<a target="_blank" href="/tbmall/home">\u8FDB\u5165\u5546\u57CE\u8D2D\u4E70&gt;&gt;</a>'), e.push("</div>")),
            e = e.join(""),
            $("#wallet_tbmall_pop_list_main").html(e)
        },
        _pushChange: function(a, l) {
            ...
            $.ajax({
                ...
                dateType: "json",
                success: function(_) {
                    0 === _.no && (t._buildPushPage.call(t, _, a), l(Math.ceil(_.data.total_num / e)))
                }
            })
        },
        _buildPushPage: function(a, l) {
            for (var t = a.data.order || [], e = [], _ = 0; _ < t.length; _++) {
                var s = t[_],
                i = new Date(1e3 * s.create_time),
                o = this._formatDateTime(i),
                n = parseInt(s.given_scores || 0, 10) + parseInt(s.scores || 0, 10);
                e.push('<li class="wallet_dialog_msg_list_item wallet_dialog_msg_list_item_pop">'),
                e.push('<div class="wallet_dialog_order">\u8BA2\u5355\u53F7\uFF1A' + s.order_id + "</div>"),
                e.push('\u6D88\u8D39<span class="orange_text">' + s.db_money / 100 + "</span>\u767E\u5EA6\u70B9\u5238"),
                e.push("\u8D2D\u4E70\u3010\u8D34\u5427\u5370\u8BB0\u3011</span>"),
                parseInt(s.given_scores) && e.push('\u83B7\u8D60<span class="orange_text">' + n + "T\u8C46</span>"),
                e.push('<span class="wallet_dialog_msg_list_date">' + o + "</span>"),
                e.push("</li>")
            }
            0 == t.length && 1 == l && (e.push('<div class="wallet_dialog_msg_empty">'), e.push("\u60A8\u8FD8\u6CA1\u6709T\u8C46\u5145\u503C\u8BB0\u5F55\uFF0C<br>T\u8C46\u53EF\u4EE5\u8D2D\u4E70\u8D34\u5427\u4F1A\u5458\u4EE5\u53CA\u4F17\u591A\u9177\u70AB\u7279\u6743\u9053\u5177\u3002<br>"), e.push('<a target="_blank" href="/tbmall/home">\u67E5\u770B\u7279\u6743\u9053\u5177&gt;&gt;</a>'), e.push("</div>")),
            e = e.join(""),
            $("#wallet_push_list_main").html(e)
        },
        _buildPager: function(a, l, t, e) {
            var _ = this;
            "function" == typeof e && e.call(_, a,
            function(s) {
                if (! (1 >= s)) {
                    t = _.use("common/component/JsPager", $.extend(_._pager_option, {
                        current: a,
                        total: s,
                        container: l
                    })),
                    ...
                    o = '<div class="wallet_js_pager_total">\u5171' + s + "\u9875</div>";
                    $(o).prependTo(l);
                    var n = $(i);
                    n.on("click", ".j_wallet_pager_skip_btn",
                    function(i) {
                        i.preventDefault();
                        var o = parseInt(n.find(".j_wallet_pager_skip_text").val());
                        return o > s || 0 >= o ? (n.find(".j_wallet_pager_skip_text").val(a), void 0) : (_._buildPager.call(_, o, l, t, e), void 0)
                    })
                }
            })
        },
        _buildInitHtml: function(a) {
            var l = this,
            t = a.Parr_scores || [],
            e = a.Parr_props ? a.Parr_props.level ? a.Parr_props.level: [] : [],
            _ = e.end_time ? parseInt((new Date).valueOf() / 1e3) > e.end_time ? 0 : e.props_id: 0,
            s = a.setpass,
            i = [];
            i.push('<div id="wallet_dialog_medal" style="position: relative" class="wallet_dialog_medal clearfix">'),
            _ ? 1 == e.props_id ? (i.push('<span class="wallet_dialog_medal_text"><span class="showicon showicon_low"></span>\u4F1A\u5458\u4E13\u5C5E\u7279\u6743</span>'), i.push('<a class="btn_default btn_small  j_wallet_dialog_medal_btn" href="#">\u7EED\u8D39</a>')) : (i.push('<span class="wallet_dialog_medal_text"><span class="showicon showicon_high"></span>\u4F1A\u5458\u4E13\u5C5E\u7279\u6743</span>'), i.push('<a class="btn_default btn_small  j_wallet_dialog_medal_btn" href="#">\u7EED\u8D39</a>')) : (i.push('<a href="#" class="btn_sub btn_small wallet_dialog_medal_btn j_wallet_dialog_medal_btn"><span class="showicon showicon_high"></span>\u5F00\u901A\u4F1A\u5458</a>'), i.push('<span class="wallet_dialog_medal_text">\u5C0A\u4EAB\u7279\u6743</span>')),
            i.push("</div>"),
            i = i.join("");
            var o = this._getInfoHtml(t, s),
            n = this._getIntroHtml(),
            r = this._getMsgHtml(),
            d = ['<div class="wallet_dialog_main clearfix" id="wallet_dialog_main">', '<div class="wallet_dialog_user pull_left">', o, '<div class="wallet_dialog_user_power">', i, n, "</div>", "</div>", r, "</div>"];
            l._html = d.join("")
        },
        _getIntroHtml: function() {
            var a = ['<div class="wallet_dialog_power_list clearfix">', '<a href="/tbmall/tshow?tab=detail&c=0"   target="_blank" class="wallet_dialog_power_item power_identity">\u5C0A\u8D35\u8EAB\u4EFD</a>', '<a href="/tbmall/tshow?tab=detail&c=112" target="_blank" class="wallet_dialog_power_item power_nameplate">\u4E2A\u6027\u94ED\u724C</a>', '<a href="/tbmall/tshow?tab=detail&c=110" target="_blank" class="wallet_dialog_power_item power_dress">\u70AB\u9177\u88C5\u626E</a>', '<a href="/tbmall/tshow?tab=detail&c=103" target="_blank" class="wallet_dialog_power_item power_post">\u8DA3\u5473\u53D1\u8D34</a>', '<a href="/tbmall/tshow?tab=detail&c=108" target="_blank" class="wallet_dialog_power_item power_magic">\u9B54\u6CD5\u9053\u5177</a>', '<a href="/f?ie=utf-8&kw=\u767E\u5EA6\u6709\u94B1\u6D88\u8D39\u91D1\u878D" locate="\u8D34\u5427\u94B1\u5305#\u767E\u5EA6\u6709\u94B1" target="_blank" class="wallet_dialog_power_item power_umoney">\u767E\u5EA6\u6709\u94B1</a>', "</div>"].join("");
            return a
        },
    ...
    sub: {
        ...
        getUserTdou: function() {
            var e = PageData.user,
            r = this._parrScores || e.Parr_scores;
            return r && !$.isEmptyObject(r) ? r.scores_money + r.scores_other: 0
        },
        getShowName: function() {
            return PageData.user.name_show || PageData.user.user_name
        },
        isMemeber: function() {
            var e = this._parrProps || PageData.user.mParr_props || PageData.user.Parr_props,
            r = this._getMaxLevel(e);
            return !! r
        },
        ...
        getMemberIcon: function() {
            var e = this._parrProps || PageData.user.mParr_props || PageData.user.Parr_props,
            r = this._getMaxLevelExpire(e),
            a = this.getMemberIconByLevel(r);
            return a
        },
        getMemberIconByLevel: function(e) {
            ...
            switch (e) {
            case 1:
                r = " ordinary_member_icon",
                a = "\u8D34\u5427\u4F1A\u5458",
                t = "\u7EED\u8D39\u8D34\u5427\u4F1A\u5458";
                break;
            case - 1 : r = " ordinary_member_icon_expire",
                a = "\u7EED\u8D39\u8D34\u5427\u4F1A\u5458",
                t = "\u5F00\u901A\u8D34\u5427\u4F1A\u5458";
                break;
            case - 2 : r = " super_member_icon_expire",
                a = "\u7EED\u8D39\u8D34\u5427\u8D85\u7EA7\u4F1A\u5458",
                t = "\u5F00\u901A\u8D34\u5427\u8D85\u7EA7\u4F1A\u5458";
                break;
            case 2:
        ...
        needUpdateTdou: function() {
            var e = PageData.user.mParr_props || PageData.user.Parr_props,
            r = PageData.user.Parr_scores;
            return ! (e && r)
        },
        _getMaxLevel: function(e) {
            var r = 0,
            a = (new Date).getTime(),
            t = e || PageData.user.Parr_props;
            if (!t || !t.level) return 0;
            var s = t.level;
            return 1e3 * s.end_time > a && parseInt(s.props_id, 10) > r && (r = parseInt(s.props_id, 10)),
            r
        },
        _getMaxLevelExpire: function(e) {
            ...
            if (!t || !t.level) return 0;
            var s = t.level;
            return parseInt(s.props_id, 10) > r && (r = parseInt(s.props_id, 10), 1e3 * s.end_time <= a && (r = 0 - r)),
            r
        },
        getTdou: function(e, r) {
            var a = this;
            a._get_tdou_ajax && a._get_tdou_ajax.abort(),
            a._get_tdou_ajax = $.ajax({
                type: "get",
                url: a.route.getTdou + "?" + new Date,
                data: {},
                cache: !1,
                dataType: "json"
            }).success(function(a) {
    ...
    path: "common/widget/cashierDialog",
    ...
    sub: {
        ...
        _iframe_dialog: null,
        initial: function() {
            this.dataProxy = this.requireInstance("common/widget/baseUserData"),
            this.member = this.dataProxy.getMemberIcon()
        },
        getTpl: function() {
        ...
        showDialog: function(e) {
            var a = this;
            a._iframe_dialog && $(".tdou_member_cashier_iframe_dialog").remove(),
            this.options = e || {},
            PageData.pay_fr = e.fr,
            PageData.pay_track = e.track;
            var i = e.cashier_url,
            ...
            a._iframe_dialog = new $.dialog(n),
            a._iframe_dialog.show(),
            ("ordinary_member_icon" == $.trim(this.member.icon) || "super_member_icon" == $.trim(this.member.icon)) && a._iframe_dialog.element.find(".j_member_red").addClass("member_red"),
            a.updateTdou(),
            a.wrap = a._iframe_dialog.element,
            PageData.tdou_dianquan_iframe_dialog = a._iframe_dialog,
            a.track("show"),
            a.bindEvent(),
            a.initMessager()
        },
        bindEvent: function() {
            var e = this;
            e.wrap.find(".j_header_close").on("click",
            function() {
                e.closeMain()
            })
        },
        closeMain: function() {
            var e = PageData.tdou_dianquan_iframe_dialog;
            e && e.close(),
            delete PageData.tdou_dianquan_iframe_dialog,
            this.track("\u5173\u95ED\u7A97\u53E3")
        },
        initMessager: function() {
            var e = this;
            if (!e.MessageInstance) {
                e.MessageInstance = e.requireInstance("common/widget/messenger", [e.windowId, "tdou_pay"]);
                ...
                e.MessageInstance.registerOrigin(i),
                e.MessageInstance.registerCommand({
        ...
        sendMessage: function(e) {
            ...
            if (a.MessageInstance) {
                ...
                a.MessageInstance.targets[a.sub_iframe_name].send(i)
            }
        },
        onReadyStateChange: function(e) {
            if (e) switch (e.status) {
            case 2e3:
                this.updateMember(e.data),
                this.track("\u652F\u4ED8\u6210\u529F");
                break;
            case 3e3:
                this.onClose();
        ...
        track: function(e) {
            $.stats.track(PageData.pay_track || "memberpay", "cashierDialog-" + PageData.pay_fr, PageData.product, e || "click")
        }
    }
});;_.Module.define({
    path: "common/widget/payMember",
    requires: ["common/widget/qianbaoPurchaseMember", "common/widget/Tdou/TdouOpenType"],
    sub: {
        ...
        initial: function() {
            var e = this;
            e.cashierDialog = e.requireInstance("common/widget/cashierDialog"),
            e.qianbaoPayMember = e.requireInstance("common/widget/qianbaoPurchaseMember"),
            e.openTypeList = e.requireInstance("common/widget/Tdou/TdouOpenType", {
                type: "member"
            })
        },
        showCashier: function(e) {
            ...
            this.opt = t;
            var i = a.isQianbaoHitSmallFlow();
            return ! i || "tshow_open_btn" !== e.fr && "tshow_detail_open_btn" !== e.fr ? "tshow_open_btn" == e.fr || "userbar" == e.fr ? (a._openCtrl("dialog"), a._getPayType(a.CASHIER), void 0) : (a._openCtrl(t.open_type), a._getPayType(), void 0) : (a._openCtrl("dialog"), a.payType = a.QIANBAO, a.payTypeCtrl(), void 0)
        },
        ...
        openDialog: function() {
            var e = this.opt;
            1 == this.payType ? this.cashierDialog.showDialog(e) : this.qianbaoPayMember.showDialog(e)
        },
        _getPayType: function(e) {
            ...
            e ? (a.payType = e, a.payTypeCtrl()) : (e = 1, $.ajax({
                ...
                success: function(t) {
                    0 == t.no && (e = Number(t.data.pay_type_id) || 1),
                    a.payType = e,
                    a.payTypeCtrl()
                }
            }))
        ...
        payTypeCtrl: function() {
            var e = this;
            $.get("/tbmall/getPayUrl?terminal=pc&pay_type=1&fr=" + this.opt.fr,
            function(a) {
                a.data && (e.win ? e.win.location.href = a.data: (a.data += "&embed=1", e.opt.cashier_url = a.data, e.openDialog()))
            })
        },
        isQianbaoHitSmallFlow: function() {
            var e = PageData && PageData.user && PageData.user.user_id;
            return e ? "1157380926" == e || "707573940" == e || "963463500" == e || "1093896819" == e || "1496" == e || "1134652730" == e || "982451133" == e ? !0 : (e = parseInt(e), e % 3 == 1) : !1
        }
    }
});;_.Module.define({
    ...
    sub: {
        ...
        getMemberDialog: function(i, e) {
            var o = this;
            return PageData.user.is_login ? (this._gotoCashier(i, e), !1) : (o.requireInstance("common/widget/LoginDialog"), !1)
        },
        _gotoCashier: function(i, e) {
    ...
    path: "common/widget/Tdou/TdouBuilder",
    requires: ["common/widget/Tdou/TdouTemplate", "common/widget/Tdou/TdouCounter"],
    sub: {
        order_status: {
            1 : "\u53D1\u8D27\u4E2D",
            2 : "\u652F\u4ED8\u6210\u529F\uFF0C\u53D1\u8D27\u6210\u529F",
        ...
        initial: function() {
            this.template = this.requireInstance("common/widget/Tdou/TdouTemplate")
        },
        builderGetTdouMain: function(t) {
            var o = this.template.getMainFrame(),
            e = this.builderGetTdouList(t);
            return $.tb.format(o, {
                list: e
            })
        },
        builderGetTdouList: function(t) {
            var o = "";
            if (t) {
                var e = this.template.getIconItem(),
                a = 0;
                for (var n in t) {
                    var i = t[n];
                    i.idx = a,
                    i.price_diff = i.member_price - i.non_member_price,
                    i.per_price = 100 * i.price_diff / i.non_member_price,
                    o += $.tb.format(e, i),
                    a++
                }
                return o
        ...
        builderError: function(t) {
            var o = this.template.getTipInfoMainFrame(),
            e = {
                tip_img: "tip_failed_img",
                tdou_tip_text: "<div class='tdou_tip_error'><span class='tdou_tip_icon_name'>" + t + "</span>\u83B7\u53D6\u5931\u8D25\uFF01\u8BF7\u5C1D\u8BD5\u91CD\u65B0\u83B7\u53D6\u6216\u5237\u65B0\u5F53\u524D\u9875\u9762\uFF01</div>"
            };
            return $.tb.format(o, e)
        },
        builderIconTip: function(t, o, e) {
            var a = this.template.getIconInfoTip(),
            n = {
                icon_name: t,
                icon_expired: o,
                icon_desc: e
        ...
        buildGetIconSuccessTip: function(t) {
            var o = this.template.getTipInfoMainFrame(),
            e = "<span class='tdou_tip_error' style='margin-right: 10px'>\u8D2D\u4E70\u5370\u8BB0\u6210\u529F\uFF0C\u83B7\u8D60T\u8C46\u6210\u529F</span><a href=\"/home/main?ie=utf-8&un=" + t + '&fr=new_icon" target="_blank">\u53BB\u6211\u7684\u4E2A\u4EBA\u4E2D\u5FC3\u67E5\u770B>></a>',
            a = {
                tip_img: "tip_successed_img",
                tdou_tip_text: e
            };
        ...
        builderPaymentFailed: function(t) {
            var o = this,
            e = this.template.getTipInfoMainFrame(),
            a = {
                tip_img: "tip_failed_img",
                tdou_tip_text: o.builderPaymentFailedText(t)
            };
        ...
        buildPaymentSuccess: function(t, o, e, a) {
            var n = this,
            i = this.template.getTipInfoMainFrame(),
            d = n.buildPaymentSuccessText(t, o, e, a),
            r = {
                tip_img: "tip_successed_img",
                tdou_tip_text: d
            };
            return $.tb.format(i, r)
        },
        buildPaymentSuccessText: function(t, o, e, a) {
            var n = "<div class='tdou_tip_error' style='margin-right: 10px'>\u60A8\u5728" + (t || "\u5546\u57CE") + "\u83B7\u53D6\u7684\u3010" + o + "\u3011</div><div class='tdou_tip_error' style='margin-right: 10px'>" + this.order_status[a] + "</div>";
            return 2 == parseInt(a) && (n += "<div>\u4F7F\u7528<span class='tdou_icon'></span>" + e + "\u5151\u6362\u8BE5\u5546\u54C1</div>"),
            n
        },
        build3rdOrderInfo: function(t) {
            ...
            e = "";
            if (t) {
                e += "<div class='tdou_tip_error' style='margin-right: 10px;margin-left:25px;margin-top:0'><ul style='list-style-type: disc;'>";
                for (var a in t) void 0 != a && (e += "<li><p class='tdou_tip_text_line'>" + t[a] + "</p></li>");
                e += "</ul></div>"
            } else e = "<div class='tdou_tip_error' style='margin-right: 10px;margin-left:15px'>\u8BA2\u5355\u5904\u7406\u5F02\u5E38</div>";
            var n = {
                tip_img: "tip_info_img_big",
                tdou_tip_text: e
            };
            return $.tb.format(o, n)
        },
        ...
        buildPayTdouMain_goodsInfo: function(t) {
            var o = this,
            e = parseFloat(t.goods_price) * t.goods_amount,
            a = o.buildPayTdouMain_goodsInfo_getGoodsName(t.goods_name),
            n = {
                goods_name: o.escapeHTML(a),
                goods_full_name: t.goods_name,
                goods_img: t.goods_image,
                goods_info_amount_val: o.escapeHTML(o._convertNum(t.goods_amount)),
                goods_info_amount_unit: o.escapeHTML(t.goods_unit),
                goods_info_duration_val: o.escapeHTML(t.goods_duration),
                goods_info_duration_unit: "\u5929",
                good_price_val: o.escapeHTML(e)
            };
            parseInt(t.goods_duration) || (n.goods_info_duration_val = "\u6C38\u4E45", n.goods_info_duration_unit = "");
            var i = o.template.getTdouPayInfoGoodsInfoBase();
            return $.tb.format(i, n)
        },
        buildPayTdouMain_nonMemberGetGoodsOwnedMember: function(t, o, e, a) {
            var n = this,
            i = n.buildPayTdouMain_goodsInfo_getGoodsName(o.goods_name),
            d = n.buildPayTdouMain_goodsInfo(o),
            r = n.template.getTdouPayInfoPaymentInfoBase(),
            u = "",
            _ = "",
            m = "";
            t ? (m = {
                tdou_pay_from: o.tdou_pay_from,
                tdou_pay_goods_name: i,
                goods_full_name: o.goods_name,
                tdou_pay_need_tdou: o.tdou_num
            },
            u = $.tb.format(n.template.getTdouPayInfoPaymentInfo_tdouEnough(), m), _ = n.template.getTdouPayInfoOpenMemberFreeGoodsTip() + $.tb.format(n.template.getTdouPayInfoPaymentInfoBtn_pay(), {
                tb_tdou_pay_btn: "\u7ACB\u5373\u5151\u6362"
            }), _ += n.builder30CountConfirm(e.cpath)) : (m = {
                tdou_pay_from: o.tdou_pay_from,
                tdou_pay_goods_name: i,
                goods_full_name: o.goods_name,
                tdou_need_pay: a
            },
            u = $.tb.format(n.template.getTdouPayInfoPaymentInfo_tdouNoEnough(), m), _ = n.template.getTdouPayInfoOpenMemberFreeGoodsTip() + n.template.getTdouPayInfoPaymentInfoBtn_get());
            var f = $.tb.format(r, {
                payment_desc: u,
                btn: _
            }),
            s = n.template.getTdouPayInfoMain();
            return $.tb.format(s, {
                sale_info: d,
                payment_info: f
            })
        },
        buildPayTdouMain_nonMemberGetTdouOwnedMember: function(t, o, e, a) {
            var n = this,
            i = n.buildPayTdouMain_goodsInfo_getGoodsName(o.goods_name),
            d = n.buildPayTdouMain_goodsInfo(o),
            r = n.template.getTdouPayInfoPaymentInfoBase(),
            ...
            u = $.tb.format(n.template.getTdouPayInfoPaymentInfo_tdouEnough(), m), _ = $.tb.format(n.template.getTdouPayInfoPaymentInfoTip(), {
                checkbox: ""
            }) + $.tb.format(n.template.getTdouPayInfoPaymentInfoBtn_pay(), {
                tb_tdou_pay_btn: "\u7ACB\u5373\u5151\u6362"
            }), _ += n.builder30CountConfirm(e.cpath)) : (m = {
                tdou_pay_from: o.tdou_pay_from,
                tdou_pay_goods_name: i,
            ...
            u = $.tb.format(n.template.getTdouPayInfoPaymentInfo_tdouNoEnough(), m), _ = $.tb.format(n.template.getTdouPayInfoPaymentInfoTip(), {
                checkbox: '<span class="tdou_enable_member "><input type="checkbox" class="j_tdou_enable_member" /></span>'
            }) + n.template.getTdouPayInfoPaymentInfoBtn_get());
            var f = $.tb.format(r, {
                payment_desc: u,
                btn: _
            }),
        ...
        buildPayTdouMain_memberGetTdou: function(t, o, e, a) {
            var n = this,
            i = n.buildPayTdouMain_goodsInfo_getGoodsName(o.goods_name),
            d = n.buildPayTdouMain_goodsInfo(o),
            r = n.template.getTdouPayInfoPaymentInfoBase(),
            ...
            if (t) {
                ...
                var f = "\u7ACB\u5373\u5151\u6362";
                f = 2 == o.free_vip_level ? "\u514D\u8D39\u9886\u53D6": "\u7ACB\u5373\u5151\u6362",
                u = $.tb.format(n.template.getTdouPayInfoPaymentInfo_tdouEnough(), m),
                _ = n.template.getTdouPayInfoPaymentInfoByMember() + $.tb.format(n.template.getTdouPayInfoPaymentInfoBtn_pay(), {
                    tb_tdou_pay_btn: f
                }),
                _ += n.builder30CountConfirm(e.cpath)
            } else m = {
                tdou_pay_from: o.tdou_pay_from,
                tdou_pay_goods_name: i,
                goods_full_name: o.goods_name,
            ...
            u = $.tb.format(n.template.getTdouPayInfoPaymentInfo_tdouNoEnough(), m),
            _ = n.template.getTdouPayInfoPaymentInfoByMember() + n.template.getTdouPayInfoPaymentInfoBtn_get();
            var s = $.tb.format(r, {
                payment_desc: u,
                btn: _
            }),
            p = n.template.getTdouPayInfoMain();
            return $.tb.format(p, {
                sale_info: d,
                payment_info: s
            })
        },
        buildPayTdouMain_memberGetTdou_freeGoods: function(t, o, e) {
            var a = this,
            n = a.buildPayTdouMain_goodsInfo(o),
            i = a.template.getTdouPayInfoPaymentInfoBase(),
            d = "",
            r = "",
            u = "\u514D\u8D39\u9886\u53D6";
            d = a.template.getTdouPayInfoPaymentInfo_forMember(),
            r = a.template.getTdouPayInfoPaymentInfoByMember() + $.tb.format(a.template.getTdouPayInfoPaymentInfoBtn_pay(), {
                tb_tdou_pay_btn: u
            }),
            t && (r += a.builder30CountConfirm(e.cpath));
            var _ = $.tb.format(i, {
                payment_desc: d,
                btn: r
            }),
            m = a.template.getTdouPayInfoMain();
            return $.tb.format(m, {
                sale_info: n,
                payment_info: _
            })
        },
        buildPayTdouMain_operation_panel: function(t) {
            var o = this,
            e = o.buildPayTdouMain_goodsInfo(t),
            a = o.template.getTdouPayInfoPaymentInfoPlaceHolder(),
            n = o.template.getTdouPayInfoMain();
            return $.tb.format(n, {
                sale_info: e,
                payment_info: a
            })
        ...
        builderTdouPaymentResult: function(t) {
            ...
            return $.tb.format(this.template.getTdouPaymentResultMain(), o)
        },
        builderTdouPaymentError: function(t) {
            var o = {
                error_text: t
            };
            return $.tb.format(this.template.getTdouPaymentErrorMain(), o)
        },
        ...
        buildCashierIframe: function(t) {
            return $.tb.format(this.template.getCashierIframe(), t)
        },
    ...
    path: "common/widget/Tdou/TdouCounter",
    requires: [],
    sub: {
        onValueChange: [],
        initial: function() {},
        builderUI: function(t) {
            var a = ['<div id="tdou_counter_#{id}" class="tdou_calc_count j_tdou_calc_count">', '    <button class="tdou_calc_op tdou_calc_minus j_tdou_calc_minus">-</button>', '    <input class="tdou_calc_input j_tdou_calc_input" type="text" value="1"/>', '    <button  class="tdou_calc_op tdou_calc_add j_tdou_calc_add">+</button>', "</div>"].join(""),
            n = $.tb.format(a, {
                id: t
            });
            return n
        ...
        bindEvents: function(t) {
            ...
            if (t) {
                var n = 999999,
                c = t.find(".j_tdou_calc_input"),
                e = t[0].id.replace("tdou_counter_", "");
                t.delegate(".j_tdou_calc_minus", "click",
                function() {
                    var t = parseInt(c.val()) || 1;
                    t = Math.max(1, t - 1),
                    t = Math.min(n, t),
                    c.val(t),
                    a.triggerValChange(t, e)
                }).delegate(".j_tdou_calc_add", "click",
                function() {
                    var t = parseInt(c.val()) || 1;
                    t++,
                    t = Math.min(n, t),
                    c.val(t),
                    a.triggerValChange(t, e)
                }).delegate(".j_tdou_calc_input", "input propertychange",
                function() {
                    var t = /^[1-9]\d*$/,
                    o = c.val(); (o && !t.test(o) || t.test(o) && o > 999) && (o = o.replace(/\D/g, "").replace(/^0(\d*)$/, "$1"), o = Math.min(n, o), c.val(o), a.triggerValChange(o, e))
                });
                var o = function() {
    ...
    path: "common/widget/Tdou/TdouData",
    requires: ["tbmall/widget/TbeanSafeAjax"],
    sub: {
        tipData: {
            tbxiaoniu: "\u767D\u5929\u5973\u5C4C\u4E1D\uFF0C\u665A\u4E0A\u591C\u5E97\u5973\u738B",
            tbzhangyu: "\u7231\u597D\u591A\u591A\uFF0C\u4E3A\u5174\u8DA3\u800C\u751F",
            tbxiaoxiong: "\u718A\u6F6E\u718A\u6D77\u4E2D\u6709\u4F60\u6709\u6211",
            tbxiaotietie: "\u8D34\u5427\u5C0F\u8D34\u8D34",
            ff14: "\u6700\u7EC8\u5E7B\u60F314\u4E13\u5C5E\u5370\u8BB0"
        },
        route: {
            getIconInfo: "/tbmall/gettdouiconinfo",
            buyIcon: "/tbmall/getPayUrl",
            getTdou: "/tbmall/getUserTd",
            getPayInfo: "/tbmall/open/getBuyForm",
            payGoods: "/tbmall/submit/open/pay",
            get3rdOrder: "/tbmall/open/getOrder",
            consumerInfo: "/tbmall/user/getConsumerInfo"
        },
        _item_raw_cache: null,
        _item_raw_cache_pay_info: null,
        _item_cache_last_total_tdou: 0,
        _parrScores: null,
        _parrProps: null,
        initial: function() {
        ...
        getUserTdou: function() {
            var e = PageData.user,
            a = this._parrScores || e.Parr_scores;
        ...
        getMemberIcon: function() {
            ...
            case 1:
                r = t + " low_member_icon";
                break;
            case - 1 : r = t + " low_member_icon_expire";
                break;
            case - 2 : r = t + " member_icon_expire";
                break;
            case 2:
                r = t;
                break;
        ...
        _getMaxLevel: function(e) {
            ...
            if (!t || !t.level) return 0;
            var o = t.level;
            return 1e3 * o.end_time > r && parseInt(o.props_id, 10) > a && (a = parseInt(o.props_id, 10)),
            a
        },
        _getMaxLevelExpire: function(e) {
            var a = 0,
            ...
            if (!t || !t.level) return 0;
            var o = t.level;
            return parseInt(o.props_id, 10) > a && (a = parseInt(o.props_id, 10), 1e3 * o.end_time <= r && (a = 0 - a)),
            a
        },
        ...
        getIconInfo: function(e, a) {
            ...
            t.tbs = PageData.tbs,
            r._get_icon_ajax && r._get_icon_ajax.abort(),
            r._get_icon_ajax = $.ajax({
                type: "get",
                url: r.route.getIconInfo,
                data: t,
                cache: !1,
                dataType: "json"
            }).success(function(t) {
                if (t && 0 === t.no) {
                    var o = t.data;
                    r._item_raw_cache = t.data,
                    t.data = r.dapterIconListData(o)
                }
                e.call(a, t)
            })
        },
        dapterIconListData: function(e) {
            ...
            if (e) for (var r in e) if (e.hasOwnProperty(r)) {
                var t = {
                    icon_id: e[r].iconId,
                    icon_name: e[r].name || "\u968F\u673A\u5370\u8BB0",
                    icon_picurl: e[r].picUrl,
                    member_price: "",
                    non_member_price: e[r].non_member_t,
                    price_diff: "",
                    tbmall_price: e[r].dubi / 100
                };
                t.member_price = this.calcIconMemberPrice(e[r].dubi, e[r].non_member_t, e[r].discount, 1),
                a[r] = t
            }
            return a
        },
        calcIconMemberPrice: function(e, a, r, t) {
            var o = 0,
            n = e * t,
            _ = 1;
            for (var i in r) {
                if (! (n >= i)) return o = 1 === _ ? a: a * t * r[_] / 100;
                _ = i
            }
            return o = a * t * r[_] / 100
        },
        getPriceInfo: function(e, a) {
            ...
            return o && (t = {
                icon_id: o.iconId,
                member_price: "",
                non_member_price: r._convertNum(o.non_member_t * e),
                tbmall_price: r._convertNum(o.dubi * e / 100)
            },
            t.member_price = r.calcIconMemberPrice(o.dubi, o.non_member_t, o.discount, e), t.member_price = r._convertNum(t.member_price)),
            t
        },
        ...
        payIconWithMargin: function(e, a, r, t, o, n, _, i, c, s, u) {
            var p = this;
            i = i || 6,
            c = c || PageData.tbs;
            var d = {
        ...
        _payIcon: function(e, a, r) {
            var t = this;
            t._buy_icon_ajax && t._buy_icon_ajax.abort(),
            t._buy_icon_ajax = $.ajax({
                type: "get",
                url: t.route.buyIcon,
                data: e,
                cache: !1,
        ...
        getTdou: function(e, a, r) {
            var t = this;
            t._get_tdou_ajax && t._get_tdou_ajax.abort(),
            t._get_tdou_ajax = $.ajax({
                type: "get",
        ...
        getThirdOrderInfo: function(e, a, r) {
            var t = this,
            o = {
                order_id: r
            };
            t._get_3rd_order_ajax && t._get_3rd_order_ajax.abort(),
            t._get_3rd_order_ajax = $.ajax({
                type: "get",
                url: t.route.get3rdOrder,
                data: o,
                cache: !1,
                dataType: "json"
            }).success(function(r) {
                if (0 == r.no) {
                    t._item_cache_last_total_tdou = t.getUserTdou();
                    var o = r.data.user_info;
                    t.setParrScores(o.Parr_scores),
                    t.setParrProps(o.Parr_props)
                }
                e.call(a, r)
            })
        },
        ...
        getTipData: function(e) {
            var a = this.getCache(e),
            r = {};
            return r.icon_name = a.name,
            r.icon_expired = 1,
            r.icon_desc = this.iconConfig[a.name + "_1"] || this.tipData[e],
            r
        },
        getPayInfo: function(e, a, r) {
            var t = this,
            o = {
                open_id: e.open_id,
                order_id: e.order_id,
                goods_name: e.goods_name,
                goods_image: e.goods_image,
                goods_price: e.goods_price,
                goods_amount: e.goods_amount,
                goods_unit: e.goods_unit,
                goods_duration: e.goods_duration,
                free_vip_level: e.free_vip_level,
            ...
            t._get_pay_info_ajax && t._get_pay_info_ajax.abort(),
            t._get_pay_info_ajax = $.ajax({
                type: "post",
                url: t.route.getPayInfo,
                data: o,
                cache: !1,
                dataType: "json"
            }).success(function(e) {
                if (t._item_raw_cache_pay_info = e.data, 0 == e.no) {
                    t._item_cache_last_total_tdou = t.getUserTdou();
        ...
        payGoods: function(e, a, r) {
            var t = this,
            o = t._item_raw_cache_pay_info.order_info,
            n = t._item_raw_cache_pay_info.tbs;
            if (o) {
                var _ = {
                    order_id: o.order_id,
                    open_id: o.open_id,
                ...
                t._get_pay_goods_ajax && t._get_pay_goods_ajax.abort(),
                t.requireInstanceAsync("tbmall/widget/TbeanSafeAjax", [],
                function(o) {
                    o.ajax({
                        type: "post",
                        url: t.route.payGoods,
                        data: _,
                        cache: !1,
                        dataType: "json",
                        success: function(t) {
        ...
        getConsumerInfo: function(e, a, r) {
            var t = this;
            e = e || {
                scene_id: ""
            },
            t._getConsumerInfo && t._getConsumerInfo.abort(),
            t._getConsumerInfo = $.ajax({
                type: "GET",
                url: t.route.consumerInfo,
                data: e,
                cache: !1,
                dataType: "json"
            }).success(function(e) {
                0 == e.no && a.call(r, e.data),
                t._getConsumerInfo = null
            })
        }
    }
});;_.Module.define({
    path: "common/widget/Tdou/TdouTemplate",
    sub: {
        get_icon_main_tpl: "",
        get_icon_item_tpl: "",
        initial: function() {},
        ...
        getCashierIframe: function() {
            var _ = '<div class="tdou_base tdou_dianquan_base tdou_buy_dianquan_card"><div class="tdou_dianquan_header"><div class="header_title"><span class="header_icon"></span>\u8D2D\u4E70T\u8C46</div><div class="user_info"><span class="title_acc">\u8D26\u53F7\uFF1A<span class="#{member}"></span><a class="title_acc_name">#{user_name}</a></span><span class="title_remain">T\u8C46\u4F59\u989D\uFF1A<span class="title_remain_num"><span class="tdou_icon"></span><span  class="j_tdou">#{tdou_num}<span></span></span></span></div><a class="header_close j_header_close"></a></div><div class="tdou_cashier_wrap" id="tdou_cashier_wrap"><iframe id="tdou_cashier_iframe" src="#{cashier_url}" frameborder="0" style="border: 0"></iframe></div></div>';
            return _
        }
    }
});;_.Module.define({
    path: "common/widget/Tdou/TdouView",
    requires: ["common/widget/Tdou/TdouBuilder", "common/widget/Tdou/TdouData", "common/widget/Tdou/TdouCounter", "common/widget/Tdou/TdouViewUtil", "common/widget/LoginDialog", "common/widget/Tdou/TdouViewCheck", "common/widget/umoneyQuery"],
    sub: {
        initial: function() {
            this.builder = this.requireInstance("common/widget/Tdou/TdouBuilder"),
            this.dataProxy = this.requireInstance("common/widget/Tdou/TdouData"),
            this.counter = this.requireInstance("common/widget/Tdou/TdouCounter"),
            this.viewUtil = this.requireInstance("common/widget/Tdou/TdouViewUtil"),
            this.checkTdou = this.requireInstance("common/widget/Tdou/TdouViewCheck"),
            this.openTypeList = this.requireInstance("common/widget/Tdou/TdouOpenType", {
                type: "tdou"
            })
        },
        createMain: function(e, o, t, i) {
            var n = this;
            n.consumption_path = e,
            n.desc = o,
            n.current_need_tdou = t,
            n.is_direct_cashier = i;
        ...
        builderMainUI: function(e) {
            ...
            if (e && 0 === e.no) {
                var t = e.data,
                i = o.builder.builderGetTdouMain(t);
                o.renderMain(i),
                o.bindMainUIEvents(),
                o.dataProxy.isLogin() || $(".j_tdou_body_title").hide(),
                o.setDefaultSlected(),
                o.addUmoney()
            } else e && 11e4 === e.no && this.viewUtil.OpenLoginDialog()
        },
        renderMain: function(e) {
            var o = "tdou_pay_icon_dialog",
            t = {
                modal: !0,
                showTitle: !1,
                fixed: !0,
            ...
            t.html = e,
            this._dialog = new $.dialog(t),
            this._dialog.element[0].id = o,
            this._dialog.show()
        },
        ...
        bindMainUIEvents: function() {
            var e = this;
            e.bindCounterEvent(),
            $(".j_header_close").on("click",
            function() {
                e.trigger("after_buy_icon"),
                e.closeMain()
            }),
            $(".j_tdou_give_btn_big").on("click",
            function() {
                e.trigger("after_buy_icon"),
                e.closeMain()
            }),
            $(".j_tdou_get_item").on("click",
            function() {
                var o = $(this);
                e.selectIconItem(o)
            }).on("mouseenter",
            ...
            $(".j_tdou_buy_btn_big").on("click",
            function() {
                var o = $(".goods_wrap_selected");
                if (0 !== o.length) {
                    var t = $(".j_tdou_calc_input").val(),
                    i = o[0].id;
                    e.wrap = $("#tdou_pay_icon_dialog"),
                    e.viewUtil.displayLoading(e.wrap),
                    e.newWin = window.open("about:blank");
                    var n = $.tb.location.getHref();
                    e.dataProxy.payIcon(i, t, e.buyIcon, e, n, e.consumption_path)
                }
            }),
            this.buildStatsEvent()
        },
        buildStatsEvent: function() {
            $(".good_price_joinvip").find("a").on("click",
            function() {
                $.stats.track("T\u8C46\u94B1\u5305", "\u4F1A\u5458\u5065\u5EB7\u7EDF\u8BA1", "", "click", {
        ...
        bindCounterEvent: function() {
            ...
            $(".tdou_calc_count_wrap").each(function() {
                e.counter.bindEvents($(this).find(".j_tdou_calc_count")),
                e.counter.onValueChange.push({
                    action: e.onCounterValueChange,
                    context: e
                })
            })
        },
        closeMain: function() {
            this._dialog.close(),
            this.dataProxy.clearCache()
        },
        selectIconItem: function(e) {
            if (e) {
                $(".j_tdou_get_item").removeClass("goods_wrap_selected"),
                e.addClass("goods_wrap_selected");
                var o = this,
                t = e.tbattr("id");
                $(".j_tdou_counter_replace").html(o.counter.builderUI(t));
                var i = $("#tdou_counter_" + t);
                o.counter.bindEvents(i),
                o.counter.onValueChange.push({
                    action: o.onCounterValueChange,
                    context: o
                }),
                o.onCounterValueChange(1, t)
            }
        },
        onCounterValueChange: function(e, o) {
            var t = this.dataProxy.getPriceInfo(e, o),
            i = this.dataProxy.getMemberLevel();
            $(".j_goods_member_num").html(i > 1 ? t.member_price: t.non_member_price),
            $(".j_goods_tmall_price_num").html(t.tbmall_price)
        },
        buyIcon: function(e) {
            var o = this;
            o.viewUtil.hideLoading(),
            o.wrap = $("#tdou_pay_icon_dialog"),
            e && 0 === e.no ? (o.checkTdou.showTdouCheckView(o.wrap, o.updateTdou, o), o.newWin.location.href = e.data) : e && 11e4 === e.no ? (o.closeMain(), o.viewUtil.OpenLoginDialog(), o.newWin && o.newWin.close()) : (this.viewUtil.displayErrorInfo(o.wrap, ""), o.newWin && o.newWin.close())
        },
        updateTdou: function() {
            var e = this;
        ...
        onUpdateTdou: function(e) {
            var o = this;
            if (e && 0 === e.no) {
                var t = e.data.Parr_scores,
                i = $("#tdou_remain_num"),
                n = t ? t.scores_money + t.scores_other: 0,
                a = o.dataProxy.getUserTdou();
                if (i.val(n), n - a >= 1e4) {
                    o.wrap = $("#tdou_pay_icon_dialog");
                    var d = o.dataProxy.getUserName();
                    this.viewUtil.dispalySuccessedInfo(o.wrap, d,
                    function() {
                        o.trigger("after_buy_icon", t),
                        o.closeMain()
                    },
                    o)
                } else this.viewUtil.displayErrorInfo(o.wrap, "",
                function() {
                    o.trigger("after_buy_icon", t),
                    o.closeMain()
                },
        ...
        addUmoney: function() {
            var e = this;
            e.umoney = e.requireInstance("common/widget/umoneyQuery");
            var o = e.umoney.showUmoneyOnGotTdou();
            e._dialog.element.find(".j_tdou_umoney").append(o)
        }
    }
});;_.Module.define({
    path: "common/widget/Tdou/TdouViewAutoRedirect",
    requires: ["common/widget/Tdou/TdouBuilder", "common/widget/Tdou/TdouData", "common/widget/Tdou/TdouViewUtil", "common/widget/qianbaoPurchaseTdou"],
    sub: {
        _icon_id: "suiji",
        display_type: "get_icon",
        CASHIER: 1,
        QIANBAO: 2,
        PayMemberUrl: "/tbmall/getMyPayType",
        third_order_id: "",
        ...
        createMain: function(e) {
            var t = this;
            e = e || {},
            t.return_url = $.tb.location.getHref(),
            t.consumption_path = e.consumption_path,
            t.desc = e.title,
            t.current_need_tdou = e.need_tdou,
            t.goods_cost_tdou = e.goods_cost_tdou,
            t.pay_type = e.pay_type,
            t.tbs = e.tbs,
            t.third_order_id = e.third_order_id,
            t.pay_info = e.pay_info,
            e.is_dialog = this.openTypeList.getOpenType(e.consumption_path),
            "win" === e.is_dialog && (t.new_win = window.open("about:blank")),
            t.dataProxy.getIconInfo(t.onGetIconInfo, t, t.return_url)
        },
        onGetIconInfo: function(e) {
            var t = this;
            if (e && 0 === e.no) {
                if (!t.dataProxy.isLogin()) return this.viewUtil.OpenLoginDialog(),
                void 0;
                t.afterUpdateTdou()
            } else e && 11e4 === e.no && this.viewUtil.OpenLoginDialog()
        },
        afterUpdateTdou: function() {
            var e = this,
            t = e.current_need_tdou,
            o = e._icon_id,
            i = e.isQianbaoHitSmallFlow();
            if (i) e.pay_channel = 2,
            e.pay_type = 6,
            e.return_url = e.getPageUrl(),
            e.dataProxy.payIconWithMargin(o, t, e.buyIcon, e, e.return_url, e.consumption_path, e.goods_cost_tdou, e.pay_type, e.tbs, e.third_order_id, e.pay_channel);
            else {
                var a = 1;
                $.ajax({
                    type: "GET",
                    ...
                    data: {
                        terminal: "pc",
                        pay_type: "tdou",
                        id: e.consumption_path
                    },
                    success: function(i) {
                        0 == i.no && (a = Number(i.data.pay_type_id) || 2),
                        a == e.QIANBAO && (e.pay_channel = 2, e.pay_type = 6, e.return_url = e.getPageUrl()),
                        e.dataProxy.payIconWithMargin(o, t, e.buyIcon, e, e.return_url, e.consumption_path, e.goods_cost_tdou, e.pay_type, e.tbs, e.third_order_id, e.pay_channel)
                    }
                })
            }
        ...
        builderMainUI: function() {
            ...
            this.renderMain(e);
            var t = $(".j_tdou_get_icon_check");
            this.bindMainUIEvents(t),
            t.css({
                "z-index": "900"
            }),
            this.wrap = $("#tdou_pay_icon_check_dialog")
        },
        renderMain: function(e) {
            var t = {
                modal: !0,
                ...
                width: 538,
                height: 208,
                holderClassName: "tdou_pay_icon_check_dialog",
                draggable: !0
            };
            t.html = e,
            this._dialog = new $.dialog(t),
            this._dialog.element[0].id = "tdou_pay_icon_check_dialog",
            this._dialog.show()
        },
        bindMainUIEvents: function(e) {
            var t = this;
            e && e.delegate(".j_header_close", "click",
            function() {
                t.closeMain()
            }).delegate(".j_check_btn", "click",
            function() {
                "get_icon" == t.display_type ? t.updateTdou() : "third_app" == t.display_type && t.displayThirdApp()
            }).delegate(".j_btn_redo_check", "click",
            function() {
                t.closeMain()
            })
        },
        buildCashierIframe: function(e) {
            var t = this,
            o = t.pay_channel;
            if (!this.cashier) if (2 == o) {
                this.cashier = this.requireInstance("common/widget/qianbaoPurchaseTdou");
                var i = e,
                a = $.extend({
                    product: "tdou",
                    consumption_path: t.consumption_path,
                    goods_cost_tdou: t.goods_cost_tdou,
                    pay_type: t.pay_type,
                    goods_order_id: t.third_order_id,
                ...
                n = {
                    ...
                    pay_type: t.pay_type,
                    iconId: t._icon_id,
                    pageUrl: t.return_url || "",
                    margin: t.current_need_tdou,
                    goodsCost: t.goods_cost_tdou,
                    fr: t.consumption_path || 0,
                    third_order_id: t.third_order_id,
                    channel: t.pay_channel
                };
                this.cashier.showDialog(a, n)
            } else this.cashier = this.requireInstance("common/widget/Tdou/TdouViewCashier"),
            this.cashier.showDialog(e, this.pay_info)
        },
        closeMain: function() {
            this._dialog.close(),
            this.cashier = null,
        ...
        buyIcon: function(e) {
            var t = this;
            if (t.wrap = $("#tdou_pay_icon_check_dialog"), e && 0 === e.no) if (t.builderMainUI(), t.new_win) t.new_win.location.href = e.data || "";
            else {
                var o = t.requireInstance("common/widget/Tdou/TdouViewOperationBootstrap"),
                i = {
                    actionType: "OPEN_CASHIER"
                };
                o.triggerByScene(i, t.pay_info,
                function() {
                    t.buildCashierIframe(e.data || "")
                })
            } else e && 11e4 === e.no ? (t.closeMain(), t.viewUtil.OpenLoginDialog(), t.new_win && t.new_win.close()) : (this.viewUtil.displayErrorInfo(t.wrap, ""), t.new_win && t.new_win.close())
        },
        updateTdou: function() {
            var e = this;
            e.dataProxy.getTdou(e.onUpdateTdou, e)
        ...
        onUpdateTdou: function(e) {
            var t = this;
            if (e && 0 === e.no) {
                var o = e.data.Parr_scores,
                i = o ? o.scores_money + o.scores_other: 0,
                a = t.dataProxy.getUserTdou();
                if (i - a >= 1e4) {
                    t.wrap = $("#tdou_pay_icon_check_dialog");
                    var n = t.dataProxy.getUserName();
                    this.viewUtil.dispalySuccessedInfo(t.wrap, n,
                    function() {
                        t.closeMain()
                    },
                    t)
                } else this.viewUtil.displayErrorInfo(t.wrap, "",
                function() {
                    t.closeMain()
                },
                t)
        ...
        updateTdouAndUserName: function(e) {
            var t = this;
            t.dataProxy.getTdou(t.onUpdateTdouAndUserName, t, e)
        },
        onUpdateTdouAndUserName: function(e, t) {
            var o = this;
            if (e && 0 === e.no) {
                var i = e.data.mParr_props,
                a = e.data.Parr_scores;
                o.dataProxy.setParrProps(i),
                o.dataProxy.setParrScores(a),
                t && t.call(this)
            }
        },
        ...
        onDisplayThirdApp: function(e) {
            var t = this;
            if (e && 0 === e.no) {
                var o = e.data.user_info.Parr_scores,
                i = e.data.order_info,
                a = o ? o.scores_money + o.scores_other: 0,
                n = t.dataProxy.getCacheUserTotalTdou(),
                r = "",
                d = parseInt(i.status),
                s = !1;
                switch (s = d >= 1 ? !0 : a - n >= 1e4, parseInt(t.pay_type)) {
                case 6:
                    r = {
                        get_tdou: a - n >= 1e4 ? "\u83B7\u53D6T\u8C46\u6210\u529F": "\u83B7\u53D6T\u8C46\u5931\u8D25"
                    };
                    break;
                case 7:
                    r = {
                        get_tdou: a - n >= 0 ? "\u83B7\u53D6T\u8C46\u6210\u529F": "\u83B7\u53D6T\u8C46\u5931\u8D25",
                        is_member: t.dataProxy.isMemeber() ? "\u5F00\u901A\u8D34\u5427\u8D85\u7EA7\u4F1A\u5458\u6210\u529F": "\u5F00\u901A\u8D34\u5427\u8D85\u7EA7\u4F1A\u5458\u5931\u8D25"
                    };
                    break;
                case 8:
                    r = {
                        order_status: t.getOrderStatus(i.status),
                        get_tdou: s ? "\u83B7\u53D6T\u8C46\u6210\u529F": "\u83B7\u53D6T\u8C46\u5931\u8D25"
                    };
                    break;
                case 9:
                    r = {
                ...
                t.wrap = $("#tdou_pay_icon_check_dialog"),
                t.viewUtil.dispaly3rdOrderInfo(t.wrap, r,
                function() {
                    t.closeMain()
                },
                t)
            } else t.viewUtil.displayErrorInfo(t.wrap, "",
            function() {
                t.closeMain()
            })
        },
        getPageUrl: function() {
            var e = $.tb.location.getHref();
            return e = e.replace(/&customerId=.*|\?customerId=.*/g, "")
        },
        ...
        isQianbaoHitSmallFlow: function() {
            var e = this,
            t = PageData && PageData.user && PageData.user.user_id;
            return t ? "12" != e.consumption_path ? !1 : "1157380926" == t || "707573940" == t || "963463500" == t || "1093896819" == t || "1496" == t || "1134652730" == t || "982451133" == t ? !0 : (t = parseInt(t, 10), t % 3 === 1) : !1
        }
    }
});;_.Module.define({
    path: "common/widget/Tdou/TdouViewCheck",
    requires: ["common/widget/Tdou/TdouBuilder", "common/widget/Tdou/TdouData", "common/widget/Tdou/TdouViewUtil"],
    sub: {
        initial: function() {
            this.builder = this.use("common/widget/Tdou/TdouBuilder"),
            this.dataProxy = this.use("common/widget/Tdou/TdouData"),
            this.viewUtil = this.use("common/widget/Tdou/TdouViewUtil")
        },
        showTdouCheckView: function(o, i, e) {
            var t = this;
            t._wrap = o || $("body");
            var d = (t._wrap.height() - 208) / 2 + "px",
            n = (t._wrap.width() - 520) / 2 + "px",
            c = {
                top: d,
                left: n
            },
            u = t._wrap.find(".j_tdou_get_icon_check");
            if (0 == u.length) {
        ...
        hideTdouCheckView: function() {
            ...
            o.hide(),
            this.viewUtil.removeMask()
        },
        _bindEvents: function(o, i, e) {
            var t = this;
            o && o.on("click", ".j_header_close",
            function() {
                t.hideTdouCheckView()
            }).on("click", ".j_check_btn",
            function() {
                t.hideTdouCheckView(),
                "function" == typeof i && t._onCheckTdou(i, e)
            }).on("click", ".j_btn_redo_check",
            function() {
                t._onRedoBuyIcon()
            })
        },
        _onCheckTdou: function(o, i) {
            "function" == typeof o && "object" == typeof i && o.call(i)
        },
    ...
    path: "common/widget/Tdou/TdouViewUtil",
    requires: ["common/widget/Tdou/TdouBuilder", "common/widget/LoginDialog"],
    sub: {
        _wrap: null,
        initial: function() {
            this.builder = this.use("common/widget/Tdou/TdouBuilder")
        ...
        setMask: function(i) {
            ...
            this._wrap = i || $("body");
            var t = {
                height: e._wrap.height(),
                width: e._wrap.width()
            },
            o = this._wrap.find(".j_tdou_mask");
            if (0 == o.length) {
        ...
        displayLoading: function(i) {
            var e = this;
            this._wrap = i || $("body");
            var t = (e._wrap.height() - 70) / 2 + "px",
            o = (e._wrap.width() - 200) / 2 + "px",
            d = {
                top: t,
                left: o
            },
            a = this._wrap.find(".j_tdou_get_icon_loading");
            if (0 == a.length) {
        ...
        _displayInfo: function(i, e, t, o, d, a) {
            var n = this;
            n._wrap = i || $("body");
            var r = (n._wrap.height() - (d || 80)) / 2 + "px",
            l = (n._wrap.width() - (a || 400)) / 2 + "px",
            _ = {
                top: r,
                left: l
            },
        ...
        _hideInfo: function() {
            this._wrap.find(".j_tdou_get_icon_tip").remove(),
            this.removeMask()
        },
        displayErrorInfo: function(i, e, t, o) {
            var d = this,
            a = d.builder.builderError(e);
        ...
        dispalySuccessedInfo: function(i, e, t, o) {
            var d = this,
            a = d.builder.buildGetIconSuccessTip(e);
            d._displayInfo(i, a, t, o)
        },
        dispaly3rdOrderInfo: function(i, e, t, o) {
            var d = this,
            a = d.builder.build3rdOrderInfo(e);
        ...
        showIconTip: function(i, e, t) {
            ...
            if (this.$tip = d.find(".j_tdou_get_icon_info_tip"), 0 == this.$tip.length) {
                ...
                this.$tip = $(l),
                d.append(this.$tip)
            } else this.$tip.find(".j_icon_name").html(t.icon_name),
            this.$tip.find(".j_icon_expired").html(t.icon_expired),
            this.$tip.find(".j_icon_desc").html(t.icon_desc);
            this.$tip.css(r),
            this.$tip.show()
        },
        ...
        displayPaymentError: function(i) {
            ...
            if (! ($(".baidu_tb_tdou_payment_error_dialog").length > 0)) {
                var t = i || "\u652F\u4ED8\u5F02\u5E38\uFF1A\u5E94\u7528\u8FD8\u6CA1\u6709\u5F00\u542F\u652F\u4ED8\u529F\u80FD",
                o = this.builder.builderTdouPaymentError(t),
                d = {
                    modal: !0,
                    showTitle: !1,
                    fixed: !0,
                    width: 420,
                    height: 150,
                    holderClassName: "baidu_tb_tdou_payment_error_dialog",
                    draggable: !0,
                    html: o
                };
                e._pay_error_dialog = new $.dialog(d),
                e._pay_error_dialog.show();
                var a = function() {
                    e._pay_error_dialog && e._pay_error_dialog.close(),
                    e._pay_error_dialog = null
                };
                e._pay_error_dialog.element.delegate(".j_header_close", "click",
                function() {
                    a()
                }).delegate(".j_tdou_pay_error_btn_close", "click",
                function() {
                    a()
                })
            }
        ...
        displayPaymentResult: function(i, e, t) {
            ...
            if (! ($(".baidu_tb_tdou_payment_result_dialog").length > 0)) {
                ...
                var d = {
                    ...
                    width: 520,
                    height: 200,
                    holderClassName: "baidu_tb_tdou_payment_result_dialog",
                    draggable: !0,
                    html: i
                };
                o._pay_result_dialog = new $.dialog(d),
                o._pay_result_dialog.show();
                var a = function() {
                    o._pay_result_dialog && o._pay_result_dialog.close(),
                    o._pay_result_dialog = null
                };
                setTimeout(function() {
                    a(),
                    e && e.call(t)
                ...
                3e3),
                o._pay_result_dialog.element.delegate(".j_header_close", "click",
                function() {
                    a()
                }).delegate(".j_tdou_pay_result_btn_close", "click",
                function() {
                    a()
                })
            }
    ...
    requires: ["common/widget/Tdou/TdouBuilder", "common/widget/Tdou/TdouData", "common/widget/Tdou/TdouViewUtil", "common/widget/Tdou/TdouViewAutoRedirect", "common/widget/Tdou/TdouViewOperationBootstrap"],
    sub: {
        errors: {
            110000 : "\u7528\u6237\u672A\u767B\u9646",
            2320007 : "\u7CFB\u7EDF\u9519\u8BEF\uFF0C\u8BF7\u7A0D\u540E\u91CD\u8BD5",
        ...
        initial: function(e) {
            ...
            this.viewUtil = this.requireInstance("common/widget/Tdou/TdouViewUtil"),
            this.message = e,
            this.autoDirect = this.requireInstance("common/widget/Tdou/TdouViewAutoRedirect")
        },
        createMain: function(e) {
            var o = this;
        ...
        createUI: function(e, o, t) {
            ...
            if (s && (o.cpath.pay_cashier || void 0 == o.cpath.pay_cashier)) return i.pay(!1),
            void 0;
            if (!s && (o.cpath.gettdou_cashier || void 0 == o.cpath.gettdou_cashier)) return i.getTdou(!1),
            void 0;
        ...
        renderMain: function(e) {
            if (! ($(".baidu_tb_tdou_payment_dialog").length > 0)) {
                ...
                o.html = e,
                this._dialog = new $.dialog(o),
                this._dialog.element[0].id = "baidu_tb_tdou_payment_dialog",
                this._dialog.show()
            }
        },
        bindMainUIEvents: function() {
            var e = this,
            o = e._dialog.element;
            o.find(".j_tdou_pay_header_close").on("click",
            function() {
                e.closeMain(),
                e.sendMessage("closed", "");
            ...
            o.delegate(".j_tb_tdou_pay_btn", "click",
            function() {
                e.pay()
            }).delegate(".j_tb_tdou_get_tdou_btn", "click",
            function() {
                e.getTdou()
            }).delegate(".j_tdou_enable_member", "click",
            function() {
            ...
            }).delegate(".j_tdou_buy_confirm", "click",
            function() {
                $(this).tbattr("checked") ? e.confirmCount(30) : e.confirmCount(0)
            }).delegate(".j_tdou_buy_icon", "click",
            function() {
                e.getIcon()
            }).delegate(".j_tdou_open_super_member_link", "click",
            function() {
                e.closeMain()
            })
        },
        ...
        onPay: function(e, o) {
            ...
            if (0 === e.no) {
                ...
                t.viewUtil.displayPaymentSuccess(t.wrap, r,
                function() {
                    t.closeMain(),
                    t.sendMessage("paid", e)
                },
                t)
            } else t.viewUtil.displayPaymentFailed(t.wrap, $.tb.subByte(i.goods_info.goods_name, 24, ""),
            function() {
                t.closeMain(),
                t.sendMessage("paid", e)
            },
        ...
        getTdou: function(e) {
            ...
            t = !1,
            i = e;
            "undefined" == typeof e && (i = !0),
            i ? (t = $(".j_baidu_tb_tdou_pay_info_box .j_tdou_enable_member").tbattr("checked"), this.closeMain()) : t = !1;
        ...
        goCashier: function(e, o) {
            ...
            this.autoDirect.display_type = "third_app",
            this.autoDirect.third_order_id = e.third_order_id,
            this.autoDirect.createMain(i)
        },
        getIcon: function() {
            var e = this;
            e.closeMain();
            var o = e.dataProxy.getPayInfoCache();
            e.view = this.requireInstance("common/widget/Tdou/TdouView"),
            e.view.bind("after_buy_icon",
            function(t, i) {
                var r = o.goods_info,
                n = o.order_info,
                a = o.user_info;
                null != i && (a.Parr_scores = i),
                e.createUI(r, n, a)
            },
            e);
    ...
    path: "common/widget/Tdou/TdouViewCashier",
    requires: [],
    sub: {
        sub_iframe_name: "tdou_cashier_iframe",
        windowId: "window_iframe_app_" + (new Date).getMilliseconds(),
        _iframe_dialog: null,
        initial: function() {
            this.builder = this.requireInstance("common/widget/Tdou/TdouBuilder"),
        ...
        showDialog: function(e, a) {
            var i = this;
            i.pay_info = a,
            i._iframe_dialog && $(".tdou_pay_cashier_iframe_dialog").remove(),
            e && (e += "&embed=1");
            var t = {
                user_name: i.dataProxy.getUserName(),
                tdou_num: 0,
                member: i.dataProxy.getMemberIcon(),
                cashier_url: e
            },
            o = i.builder.buildCashierIframe(t),
            n = {
                modal: !0,
                showTitle: !1,
                fixed: !0,
                ...
                height: 610,
                hideOnclose: !1,
                holderClassName: "tdou_pay_cashier_iframe_dialog",
                draggable: !0,
                html: o
            };
            i._iframe_dialog = new $.dialog(n),
            i._iframe_dialog.show(),
            i.updateTdou(),
            i.wrap = i._iframe_dialog.element,
            PageData.tdou_dianquan_iframe_dialog = i._iframe_dialog,
            i.track("show"),
            i.bindEvent(),
            i.initMessager()
        },
        ...
        closeMain: function() {
            ...
            delete PageData.tdou_dianquan_iframe_dialog,
            this.track("\u5173\u95ED\u7A97\u53E3"),
            this.triggerActionOnClosed()
        },
        initMessager: function() {
            var e = this;
            if (!window.messenger) {
                e.MessageInstance = e.requireInstance("common/widget/messenger", [this.windowId, "tdou_pay"]);
                var a = window.document.getElementById(e.sub_iframe_name);
                e.MessageInstance.addTarget(a.contentWindow, e.sub_iframe_name);
                var i = ["http://db.baidu.com", "http://pay.baidu.com"];
                e.MessageInstance.registerOrigin(i),
        ...
        updateTdou: function() {
            ...
            e.dataProxy.getTdou(function(e) {
                if (e && 0 === e.no) {
                    var a = e.data.Parr_scores,
                    i = a ? a.scores_money + a.scores_other: 0;
                    $(".tdou_pay_cashier_iframe_dialog .j_tdou").html(i)
                }
            },
            this)
        },
        triggerActionOnClosed: function() {
            var e = this,
            a = e.requireInstance("common/widget/Tdou/TdouViewOperationBootstrap"),
            i = {
                actionType: "CLOSE_CASHIER"
            };
            a.triggerByScene(i, e.pay_info)
        },
        track: function(e) {
            $.stats.track("tdoupay", "cashierDialog", PageData.product, e || "click")
        }
    }
});;_.Module.define({
    path: "common/widget/TdouMessage",
    requires: ["common/widget/messenger", "common/widget/Tdou/TdouViewPay"],
    sub: {
        sub_iframe_name: "bd_tieba_app_iframe",
        iframe_uid: "tb_tdou_pay_0",
        initType: 0,
        windowId: "window_iframe_app_" + (new Date).getMilliseconds(),
        cross_domain_origin_list: [],
        initial: function(e) {
            var t = this;
            e = $.extend({},
            e),
            t.postMsg = e.post_msg;
            var i = e.iframe_name,
            n = e.origin_array;
            $.isArray(n) ? t.cross_domain_origin_list = t.cross_domain_origin_list.concat(n) : "string" == typeof n && n && t.cross_domain_origin_list.push(n),
            t.sub_iframe_name = i || t.sub_iframe_name,
            t.init()
        },
        init: function(e) {
            this.initMessager(),
            this.windowId = e || this.windowId
        },
        getCrossDomainWhiteUrl: function() {
            var e = PageUnit.load("tdou_cross_domain_white_list"),
            t = "";
        ...
        initMessager: function() {
            var e = this;
            if (!e.MessageInstance) {
                if (e.postMsg) e.MessageInstance = e.postMsg,
                e.initType = 1;
                else {
                    e.MessageInstance = this.use("common/widget/messenger", this.windowId, "tdou_pay");
                    var t = window.document.getElementById(e.sub_iframe_name);
                    e.MessageInstance.addTarget(t.contentWindow, e.sub_iframe_name)
                }
                ...
                i = i.concat(e.cross_domain_origin_list),
                e.MessageInstance.registerOrigin(i),
                e.MessageInstance.registerCommand({
                    encourage_tdou_pay: $.proxy(e.pay, this),
                    encourage_set_tieba_title: $.proxy(e.setTitle, this),
                    encourage_set_tieba_height: $.proxy(e.setHeight, this),
                    encourage_third_app_refresh: $.proxy(e.refresh, this),
                    encourage_third_app_redirect: $.proxy(e.redirect, this),
                    encourage_dianquan_readystatechange: $.proxy(e.onReadyStateChange, this),
                    encourage_dianquan_close: $.proxy(e.onClose, this)
                })
            }
        ...
        sendMessage: function(e) {
            ...
            if (t.MessageInstance) {
                var i = "";
                "object" == typeof e && (i = JSON.stringify(e)),
                t.MessageInstance.targets[t.sub_iframe_name].send(i)
            }
        },
        pay: function(e) {
            var t = this;
            ...
            this.requireInstanceAsync("common/widget/Tdou/TdouViewPay",
            function(e) {
                t.sendMessage(e)
            },
            function(t) {
        ...
        setTitle: function(e) {
            e.title && (window.document.title = decodeURIComponent(e.title))
        },
        setHeight: function(e) {
            var t = e.height;
            1 === this.initType ? $("#iframe_" + this.sub_iframe_name).height(t) : $("#" + this.sub_iframe_name).height(t)
        },
        refresh: function() {
            $.tb.location.reload()
        },
        redirect: function(e) {
            var t = e.url;
            t && (t.length >= 2083 || $.tb.location.setHref(t))
        },
        onReadyStateChange: function(e) {
            this.requireInstanceAsync("common/widget/Tdou/TdouViewCashier", [],
            function(t) {
    ...
    path: "common/widget/Tdou/TdouOpenType",
    sub: {
        openTypeList: {
            1001001e3: "dialog",
            2000118 : "dialog"
        ...
        initial: function(e) {
            this.normalType = e && "tdou" === e.type ? "win": "dialog"
        },
    ...
    path: "common/widget/Tdou",
    requires: ["common/widget/Tdou/TdouView", "common/widget/Tdou/TdouViewAutoRedirect"],
    sub: {
        initial: function() {
            this.view = this.requireInstance("common/widget/Tdou/TdouView"),
            this.autoDirect = this.requireInstance("common/widget/Tdou/TdouViewAutoRedirect")
        },
        factory: function(e, t) {
            ...
            switch (e) {
            case "get_icon":
                o = t.consumption_path,
                i = t.desc,
                d = t.current_need_tdou,
                this.view.createMain(o, i, d);
                break;
            case "auto_direct":
                var u = {
                    consumption_path: t.consumption_path,
                    title: t.desc,
                    need_tdou: t.current_need_tdou,
                    goods_cost_tdou: t.goods_cost_tdou || 0,
                    pay_type: t.pay_type,
                    tbs: t.tbs,
                    order_id: t.order_id,
                    is_dialog: t.is_iframe
                };
                this.autoDirect.createMain(u)
            }
        }
    }
});;_.Module.define({
    path: "common/widget/IframeBuilder",
    requires: ["common/widget/messenger"],
    sub: {
        _TIMEOUTTYPE: {
            UNDO: 0,
        ...
        _WHITELIST: ["http://www.xiu8.com", "http://tieba.baidu.com", "http://baidu.yy.tv", "http://baidu.huya.com"],
        _styleList: "",
        initial: function() {
        ...
        iframe: function(e) {
            ...
            o = 1 == a.replace,
            d = a.src,
            m = this.getStyleList(r, n),
            c = ['<iframe name="' + f + '"', ' id="' + i + '"', ' class="' + s + '"', ' src=""', ' style="' + m + '"', " frameborder=0", ' scrolling="no"', ' allowTransparency="true"></iframe>'].join(" "),
            _ = $(c);
            _.get(0).src = $.tb.unescapeHTML(d),
            o ? _.replaceAll(t) : t.append(_),
            this.initIframe(e)
        },
        initIframeData: function() {
            window.iframeData = window.iframeData || {},
            window.iframeData._cache = window.iframeData._cache || {},
            window.iframeData.getIframe = function(e) {
            ...
            window.iframeData.setIframe = function(e, a) {
                ...
                if (t[e] = t[e] || {},
                "object" != typeof a) throw "Iframe list id's type must be a object!";
                t[e] = $.extend(!0, t[e], a)
            },
            ...
            window.iframeData.setReady = function(e, a) {
                var t = window.iframeData.getIframe(e) || {},
                i = window.iframeData.getReady(e) || $.Callbacks();
                return "function" == typeof a ? (1 == t.success ? a() : (i.add(a), window.iframeData.setIframe(e, {
                    ready: i
                })), !0) : !1
            },
        ...
        initIframe: function(e) {
            ...
            i = t.iframe_id,
            r = t.project_id,
            n = parseInt(t.wait_time),
            s = t.origin_url;
            this.stats = "object" == typeof e.stat ? e.stat: {},
            console.log(e),
            window.iframeData = window.iframeData || {};
            ...
            if (f) {
                ...
                o || (o = this.requireInstance("common/widget/messenger", ["tb_Iframe_" + 1 * new Date, r]), o.addTarget(f.contentWindow, i), s && "string" == typeof s && o.registerOrigin([s]), o.registerCommand({
                    loadready: function(e) {
                        return a.onLoadReady(e, i, f),
                        {
                            no: 0,
                            msg: "success"
                        }
                ...
                o.targets[i].send($.json.encode({
                    command: "loadready_ask",
                    data: {
                        no: 0,
                        msg: "success"
                    }
        ...
        doRefresh: function() {
            var e = this,
            a = this.conf || {},
            t = $(window.iframeData.getDom(a.iframe_id)),
            i = this.getStyleList(),
            r = 200,
            n = ["<div ", ' class="iframe_refresh_dialog"', ' id="iframe_refresh_' + a.iframe_id + '"', ' style="' + i + '"', " >", '<div class="iframe_refresh_alert" style="margin-top:' + r + 'px">', '<div class="iframe_refresh_animate"></div>', '<div class="iframe_refresh_alert_title">\u7EB3\u5C3C\uFF01\u5E94\u7528\u88AB\u866B\u6D1E\u5403\u6389\u5566\uFF0C\u70B9\u51FB\u5237\u65B0\u7B49\u7B49\u770B~</div>', '<div class="iframe_refresh_operate"><a href="#" class="iframe_refresh_btn j_iframe_refresh_btn">\u70B9\u51FB\u5237\u65B0</a></div>', "</div>", "</div>"].join(" "),
            s = $(n);
            s.replaceAll(t),
            s.find(".j_iframe_refresh_btn").click(function(a) {
                a.preventDefault(),
                e.iframe($.extend(e.conf, {
                    wrap: s,
                    replace: !0
                }))
            }).mouseenter(function() {
        ...
        doRefresh2: function() {
            ...
            r = Math.max(i.top, 0),
            n = r + 200,
            s = ['<div class="iframe_refresh_alert" style="z-index:9999;position:absolute;left:50%;margin-left:-150px;top:' + n + 'px">', '<div class="iframe_refresh_animate"></div>', '<div class="iframe_refresh_alert_title">\u7EB3\u5C3C\uFF01\u5E94\u7528\u88AB\u866B\u6D1E\u5403\u6389\u5566\uFF0C\u70B9\u51FB\u5237\u65B0\u7B49\u7B49\u770B~</div>', '<div class="iframe_refresh_operate"><a href="#" class="iframe_refresh_btn j_iframe_refresh_btn">\u70B9\u51FB\u5237\u65B0</a></div>', "</div>"].join(" "),
            f = $(s);
            f.appendTo("body"),
            f.find(".j_iframe_refresh_btn").click(function(a) {
                a.preventDefault(),
                e.iframe($.extend(e.conf, {
                    wrap: t,
                    replace: !0
        ...
        doHide: function() {
            var e = this.conf || {},
            a = $(window.iframeData.getDom(e.iframe_id));
            a.remove()
        },
        getStyleList: function(e, a) {
            var t = this.conf || {};
            return e = e || parseInt(t.width),
            a = a || parseInt(t.height),
            this._styleList = this._styleList || "width:100%;margin:0 auto;" + (a ? "height:" + a + "px;": "") + (e ? "width:" + e + "px;": "") + "display:block;",
            this._styleList
        },
        isWhiteList: function(e) {
            return !! _.filter(this._WHITELIST || [],
            function(a) {
        ...
        onTimeoutHandler: function() {
            var e = this,
            a = this._TIMEOUTTYPE[this.conf.timeout_type],
            t = window.iframeData.getIframe(this.conf.iframe_id);
            if (!t.success) {
                if (this.sendStat(1, 0), 0 === a) return;
                1 === a && e.stats && [2000046, 2100001, 2000086].indexOf(parseInt(e.stats.scene_id)) >= 0 && e.doRefresh()
            }
        },
        _isLoadReady: 0,
        onLoadReady: function(e, a, t) {
            if (1 !== this._isLoadReady) {
                var i = this._TIMEOUTTYPE[this.conf.timeout_type];
                this.end_time = 1 * new Date;
                var r = this.end_time - this.start_time;
                0 == e.no && (this._isLoadReady = 1, window.iframeData.setIframe(a, {
                    success: 1,
                    loadInfo: e.data
                }), 3 === i && $(t).show(), window.iframeData.fireReady(a)),
                this.sendStat(e.no, r)
            }
        },
        sendStat: function(e, a) {
            ...
            i = {
                ...
                app_unique_id: "",
                scene_id: "",
                forum_id: PageData.forum ? PageData.forum.forum_id: "",
                from: PageData.page,
                host_url: $.tb.location.getHref(),
                task: "",
                locate: "",
                iframe_url: t.conf.src,
                is_load_suc: Number(0 === e),
                ready_time: a
            },
            r = $.extend(i, this.stats);
            r.task && $.ajax({
                url: "/appmonitor/log/stable",
                type: "post",
                data: r
            })
        }
    ...
    path: "common/widget/Tdou/TdouViewOperationBootstrap",
    requires: ["common/widget/Tdou/TdouBuilder", "common/widget/umoney", "common/widget/Tdou/TdouData"],
    sub: {
        $root: null,
        callbackOnClosed: null,
        initial: function() {
            var e = this;
            e.builder = e.requireInstance("common/widget/Tdou/TdouBuilder"),
            e.umoney = e.requireInstance("common/widget/umoney"),
            e.umoney.bind("closeDialogEvent", e.closeMain, e),
            e.dataProxy = e.requireInstance("common/widget/Tdou/TdouData")
        },
        triggerByScene: function(e, o, i) {
            var n = this;
            if (n.scene_info = e || {},
            n.callbackOnClosed = i, !o) return n.invokeCallbackOnClosed(),
            void 0;
            if ("OPEN_CASHIER" === e.actionType) {
                var a = o.order_info.scene_id || "";
                n.dataProxy.getConsumerInfo({
                    scene_id: a
                },
                function(e) {
                    $.extend(o.user_info, e),
                    n.createMain(o)
                },
                n)
            } else("CLOSE_CASHIER" === e.actionType || "CLOSE_PAYMENT" === e.actionType) && n.createMain(o)
        },
        createMain: function(e) {
            var o = this;
            if (e) {
                o.goods_info = e.goods_info,
                o.order_info = e.order_info,
                o.user_info = e.user_info,
                o.extra_options = e.extra_options;
                var i = o.createOperationUI();
                if (!i) return o.invokeCallbackOnClosed(),
                void 0;
                var n = o.builder.buildPayTdouMain_operation_panel(o.goods_info);
                o.renderMain(n),
                o.bindEvents(),
                o.$root.find(".j_payment_place_holder").append(i)
            }
        },
        createOperationUI: function() {
            var e = this,
            o = {
                isRecharge: e.user_info.isRecharge,
                isConsumption: e.user_info.isConsumption,
                isMember: e.isMember(),
                isGoodsFreeForMember: e.goods_info.free_vip_level,
                actionType: e.scene_info.actionType
            },
            i = e.umoney.getMainUIDom(o);
            return i
        },
        renderMain: function(e) {
            var o = "baidu_tb_tdou_operation_boot";
            if (! ($("." + o).length > 0)) {
                var i = {
                    modal: !0,
                    showTitle: !1,
                ...
                this._dialog = new $.dialog(i),
                this._dialog.show(),
                this.$root = this._dialog.element
            }
        },
        bindEvents: function() {
            var e = this;
            e.$root.on("click", ".j_tdou_pay_header_close",
            function() {
                e.closeMain()
            })
        },
        closeMain: function() {
            var e = this;
            e.$root.find(".j_tdou_pay_header_close").off("click"),
            e._dialog && e._dialog.close(),
            e.dialog = null,
            e.invokeCallbackOnClosed()
        },
        invokeCallbackOnClosed: function() {
            var e = this,
            o = e.callbackOnClosed;
            $.isFunction(o) && o()
        },
        isMember: function() {
            var e = this,
            o = e.user_info.Parr_props;
            e.dataProxy.setParrProps(o);
            var i = e.dataProxy.getMemberLevel();
            return 2 == i
        }
    }
});;_.Module.define({
    path: "common/widget/umoney",
    requires: [],
    sub: {
        $root: null,
        actionType: {
            closeCashier: "CLOSE_CASHIER",
            openCashier: "OPEN_CASHIER",
            closePayment: "CLOSE_PAYMENT",
            openPayment: "OPEN_PAYMENT"
        },
        initial: function() {},
        getMainUIDom: function(e) {
            if (e) {
                var t = e.isMember;
                if (!t) {
                    var n = e.isGoodsFreeForMember,
                    a = e.isRecharge,
                    o = e.isConsumption,
                    i = this,
                    r = "",
                    s = 0;
                    switch (e.actionType) {
                    case i.actionType.closeCashier:
                        s = i.getCountOneDay(i.actionType.closeCashier),
                        n && 1 == s && (r = i.geTtplWhenClosePay());
                        break;
                    case i.actionType.openCashier:
                        s = i.getCountOneDay(i.actionType.openCashier),
                        n || (a || 1 != s) && (o || 2 != s) || (r = i.geTtplWhenOpenCashier());
                        break;
                    case i.actionType.closePayment:
                        s = i.getCountOneDay(i.actionType.closePayment),
                        n && 2 == s && (r = i.geTtplWhenClosePay());
                        break;
                    case i.actionType.openPayment:
                    }
                    return r && (i.$root = $(r), i.bindEvents(), i.track("show")),
                    i.$root
                }
            }
        },
        bindEvents: function() {
            var e = this;
            e.$root.on("click", ".try-use-btn",
            function() {
                e.track("try-btn"),
                e.trigger("closeDialogEvent")
            }).on("click", ".dont-use-btn",
            function() {
                e.track("dont-btn"),
                e.trigger("closeDialogEvent")
            })
        },
        geTtplWhenOpenCashier: function() {
            var e = '<div class="umoney-wrap "><div class="text">\u6B64\u5546\u54C1\u53EF\u901A\u8FC7\u767E\u5EA6\u6709\u94B1\u63D0\u4F9B\u7684<div>\u2014\u2014\u5148\u4F7F\u7528\u540E\u4ED8\u6B3E\uFF01\u670D\u52A1\u83B7\u53D6</div></div><div class="btn-wrap open-cashier-btn-wrap"><button class="btn-default  btn-larger dont-use-btn">\u4E0D\u9700\u8981\u6B64\u670D\u52A1</button><a target="_blank" href="/f?ie=utf-8&kw=\u767E\u5EA6\u6709\u94B1\u6D88\u8D39\u91D1\u878D" class="btn-attention  btn-larger try-use-btn">\u4F53\u9A8C\u5C1D\u8BD5</a></div></div>';
            return e
        },
        geTtplWhenClosePay: function() {
            var e = '<div class="umoney-wrap"><div class="text">\u6B64\u5546\u54C1\u53EF\u901A\u8FC7\u767E\u5EA6\u6709\u94B1\u63D0\u4F9B\u7684<div>\u2014\u2014\u5148\u4F7F\u7528\u540E\u4ED8\u6B3E\uFF01\u670D\u52A1\u83B7\u53D6</div></div><div class="btn-wrap  close-payment-btn-wrap"><a  target="_blank" href="/f?ie=utf-8&kw=\u767E\u5EA6\u6709\u94B1\u6D88\u8D39\u91D1\u878D" class="btn-attention  btn-larger try-use-btn">\u4F53\u9A8C\u5C1D\u8BD5</a></div></div>';
            return e
        },
        getCountOneDay: function(e) {
            if (e) {
                var t = "TB-UMONEY-COUNTER-" + e,
                n = $.tb.Storage.get(t),
                a = new Date,
                o = new Date(a.getFullYear(), a.getMonth(), a.getDate(), 23, 59, 59);
                return n ? (n = parseInt(n), n++) : n = 1,
                $.tb.Storage.set(t, n, o),
                n
            }
        },
        track: function(e) {
            $.stats.track(e, "umoney-payment", PageData.product, "click")
        }
    }
});_.Module.define({
    path: "ueglibs/widget/Ban",
    sub: {
        initial: function(e, a, r, t, i, n) {
            var o, s, f, p, l = PageData.user.forbidden;
            if (l) o = l.days_to_free,
            s = l.opgroup,
            f = l.isForbid,
            p = l.block_reason;
            else {
            ...
            var u = this,
            e = void 0 !== e ? e: PageData.product,
            a = void 0 !== a ? a: PageData.forum.forum_id,
            r = void 0 !== r ? r: o,
            t = void 0 !== t ? t: s,
            i = void 0 !== i ? i: f,
            n = void 0 !== n ? n: p,
            n = n && "bawu" === t ? "<span>\u5C01\u7981\u7406\u7531\uFF1A" + n + "</span>": "",
            c = "bawu" === t ? "\uFF1B\u5982\u679C\u5427\u52A1\u4E0D\u5904\u7406\uFF0C\u5C31\u53EF\u4EE5\u81EA\u52A8\u89E3\u5C01\u54E6\uFF5E": "";
            u.renderInfo = {
                product: e,
                ban: i,
                fid: a,
                ...
                by: t,
                op: "bawu" !== t ? "\u7CFB\u7EDF": "\u672C\u5427\u5427\u52A1",
                page: "bawu" !== t ? "system": "bawu",
                br: n,
                notice: c
            },
            $("body").off("click.ueg.pmclink").on("click.ueg.pmclink", ".ueg_pmc-link",
            function() {
                var e = $(this),
                a = e.data("fr"),
                r = e.data("site");
            ...
            for (var t, a = a.split("."); a.length > 1;) t = a.shift(),
            e = e[t] = e[t] || {};
            if (t = a.shift(), void 0 === t) throw "Please make sure you has one namespace like `scope.name.value` !";
            return void 0 !== r && (e[t] = r),
            e[t]
        },
        _tplRenders: {
            richPoster: function(e) {
                if ("system" == e.page) var a = e.ban ? ["\u60A8\u53EF\u80FD\u5B58\u5728\u8FDD\u89C4\u64CD\u4F5C\uFF0C\u5DF2\u88AB#{op}\u5C01\u7981\uFF0C\u53BB", '<a data-site="#{site}" ', 'data-fr="#{fr}" ', 'href="/pmc/#{page}?fid=#{fid}&fr=#{site}_#{fr}" ', 'class="ueg_pmc-link ueg_track-#{site}" ', 'target="_blank">\u7533\u8BF7\u6062\u590D</a>', "#{notice}#{br}"].join("") : "";
                else var a = e.ban ? ["\u60A8\u5DF2\u88AB#{op}\u5C01\u7981\uFF0C#{br}", '\u60A8\u53EF\u4EE5\u53BB<a data-site="#{site}" ', 'data-fr="#{fr}" ', 'href="/pmc/#{page}?fid=#{fid}&fr=#{site}_#{fr}" ', 'class="ueg_pmc-link ueg_track-#{site}" ', 'target="_blank">\u7533\u8BF7\u6062\u590D</a>'].join("") : "";
                return $.tb.format(a, e)
            },
            simplePoster: function(e) {
                if ("system" == e.page) var a = e.ban ? ["\u60A8\u53EF\u80FD\u5B58\u5728\u8FDD\u89C4\u64CD\u4F5C\uFF0C\u5DF2\u88AB#{op}\u5C01\u7981\uFF0C\u53BB", '<a data-site="#{site}" ', 'data-fr="#{fr}" ', 'href="/pmc/#{page}?fid=#{fid}&fr=#{site}_#{fr}" ', 'class="ueg_pmc-link ueg_track-#{site}" ', 'target="_blank">\u7533\u8BF7\u6062\u590D</a>'].join("") : "";
                else var a = e.ban ? ["\u60A8\u5DF2\u88AB#{op}\u5C01\u7981\uFF0C#{br}", '\u60A8\u53EF\u4EE5\u53BB<a data-site="#{site}" ', 'data-fr="#{fr}" ', 'href="/pmc/#{page}?fid=#{fid}&fr=#{site}_#{fr}" ', 'class="ueg_pmc-link ueg_track-#{site}" ', 'target="_blank">\u7533\u8BF7\u6062\u590D</a>'].join("") : "";
                return $.tb.format(a, e)
            },
            balvAside: function(e) {
                var a = ['<div style="width:205px;text-align:left;margin:6px 0px 6px 10px;">', "<div>\u4F60\u5DF2\u88AB\u7CFB\u7EDF\u6C38\u4E45\u5C01\u7981\uFF0C<br/>\u5C01\u7981\u671F\u95F4\u4E0D\u52A0\u7ECF\u9A8C\uFF0C\u5934\u8854\u548C\u6743\u9650\u6536\u56DE\u3002</div>", '<div style="text-align:right;margin-right:5px;">', '<a data-site="#{site}" ', 'data-fr="#{fr}" ', 'href="/pmc/index?fr=#{site}_#{fr}" ', 'class="ueg_pmc-link ueg_track-#{site}" ', 'target="_blank">\u67E5\u770B\u8BE6\u7EC6\u4FE1\u606F</a>', "</div>", "</div>"].join(""),
                r = ['<div style="width:205px;text-align:left;margin:6px 0px 6px 10px;">', '<div style="width:205px;">', "<span>\u4F60\u5DF2\u88AB#{op}\u5C01\u7981\uFF0C#{br}</span>", "<span>\u5C01\u7981\u671F\u95F4\u4E0D\u52A0\u7ECF\u9A8C\uFF0C\u5934\u8854\u548C\u6743\u9650\u6536\u56DE\u3002</span>", "</div>", '<div style="text-align:right;margin-right:5px;">', '\u53BB<a data-site="#{site}" ', 'data-fr="#{fr}" ', 'href="/pmc/#{page}?fid=#{fid}&fr=#{site}_#{fr}" ', 'class="ueg_pmc-link ueg_track-#{site} j_appealLink"', 'target="_blank">\u7533\u8BF7\u6062\u590D</a>', "</div>", "</div>"].join(""),
                t = e.ban ? e.day > 0 && e.day < 360 ? r: a: "";
        ...
        _supports: {
            frs: {
                richPoster: "richPoster",
                simplePoster: "simplePoster",
                balvAside: "balvAside",
                balvLike: "balvLike",
                oldPosterDialog: "oldPosterDialog",
                voteDialog: "voteDialog",
                forumManagerApply: "forumManagerApply"
            },
            pb: {
                richPoster: "richPoster",
                simplePoster: "simplePoster",
        ...
        assign: function(e, a, r, t) {
            var i = this,
            n = (i._supports, i._tplRenders);
            if (!t && "function" == typeof r) {
                if (t = r, r = t.name, !r) return i.$error("Unknown render handler with an anonymous function"),
                !1;
                if (n[r]) return i.$error("There exsits one render, place choice one another name"),
                !1;
                n[r] = t
            }
            e = support[e] = support[e] || {},
            e[a] = r
        },
        $error: function() {
            "tieba.baidu.com" !== $.tb.location.getHost() && (arguments[0] = "Console$>Error: " + (arguments[0] || ""), (console && console.error ||
            function() {}).apply(console, arguments))
        },
        render: function(e) {
            var a, r = this,
            t = r.renderInfo.product,
            i = r._supports,
            n = r._tplRenders,
            o = (i[t] || {})[e],
            s = $.tb.location.getSearchValue().fr || "";
